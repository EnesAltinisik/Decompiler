...
.method private zzD(Landroid/content/Intent;)V
    .locals 2
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzT(Landroid/os/Bundle;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0, p1}, Lcom/google/firebase/messaging/b;->b(Landroid/content/Context;Landroid/content/Intent;)V
...
.method private zzE(Landroid/content/Intent;)Ljava/lang/String;
    .locals 1
...
.method private zzn(Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/b;->a(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :pswitch_3
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzE(Landroid/content/Intent;)Ljava/lang/String;
...
.method private zzo(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lcom/google/firebase/messaging/a;->a(Landroid/os/Bundle;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p0}, Lcom/google/firebase/messaging/a;->b(Landroid/content/Context;)Z
    ...
    invoke-virtual {v1, v0}, Lcom/google/firebase/messaging/a;->b(Landroid/os/Bundle;)V
    ...
    invoke-static {v1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzT(Landroid/os/Bundle;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p0, p1}, Lcom/google/firebase/messaging/b;->d(Landroid/content/Context;Landroid/content/Intent;)V
...
.method protected zzA(Landroid/content/Intent;)I
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzD(Landroid/content/Intent;)V

    invoke-virtual {p0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->zzBL()V
...
.method public zzm(Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Lcom/google/firebase/messaging/b;->c(Landroid/content/Context;Landroid/content/Intent;)V
...
.method protected zzz(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-static {}, Lcom/google/firebase/iid/FirebaseInstanceIdInternalReceiver;->zzUr()Landroid/content/Intent;
