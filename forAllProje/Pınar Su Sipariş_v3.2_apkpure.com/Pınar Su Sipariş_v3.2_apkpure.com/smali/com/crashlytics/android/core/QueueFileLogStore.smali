...
# instance fields
.field private logFile:La/a/a/a/a/b/q;
...
.method private doWriteToLog(JLjava/lang/String;)V
    ...
    .prologue
    .line 114
    iget-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:La/a/a/a/a/b/q;
    ...
    .line 150
    iget-object v1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:La/a/a/a/a/b/q;

    invoke-virtual {v1, v0}, La/a/a/a/a/b/q;->a([B)V

    .line 153
    :goto_2
    iget-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:La/a/a/a/a/b/q;

    invoke-virtual {v0}, La/a/a/a/a/b/q;->b()Z
    ...
    invoke-virtual {v0}, La/a/a/a/a/b/q;->a()I
    ...
    invoke-virtual {v0}, La/a/a/a/a/b/q;->c()V
    :try_end_0
...
.method private openLogFile()V
    ...
    .line 105
    :try_start_0
    new-instance v0, La/a/a/a/a/b/q;

    iget-object v1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->workingFile:Ljava/io/File;

    invoke-direct {v0, v1}, La/a/a/a/a/b/q;-><init>(Ljava/io/File;)V

    iput-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:La/a/a/a/a/b/q;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getLogAsByteString()Lcom/crashlytics/android/core/ByteString;
    ...
    invoke-virtual {v0, v3}, La/a/a/a/a/b/q;->a(La/a/a/a/a/b/q$c;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
