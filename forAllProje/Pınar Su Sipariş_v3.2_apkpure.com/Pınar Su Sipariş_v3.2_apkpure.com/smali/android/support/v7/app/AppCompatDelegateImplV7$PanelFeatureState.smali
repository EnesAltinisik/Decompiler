...
.field listMenuPresenter:Landroid/support/v7/view/menu/e;

.field listPresenterContext:Landroid/content/Context;

.field menu:Landroid/support/v7/view/menu/f;
...
.method applyFrozenState()V
    ...
    .prologue
    .line 2001
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->menu:Landroid/support/v7/view/menu/f;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/f;->b(Landroid/os/Bundle;)V
...
.method public clearMenuPresenters()V
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/e;
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/e;

    .line 1916
    return-void
.end method

.method getListMenuView(Landroid/support/v7/view/menu/l$a;)Landroid/support/v7/view/menu/m;
    .locals 3
    ...
    .line 1965
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/e;
...
.method public hasPanelItems()Z
    ...
    .line 1905
    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/e;
...
.method onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1982
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->menu:Landroid/support/v7/view/menu/f;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/f;->a(Landroid/os/Bundle;)V
...
.method setMenu(Landroid/support/v7/view/menu/f;)V
    .locals 2
    ...
    .line 1956
    :cond_2
    iput-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->menu:Landroid/support/v7/view/menu/f;
