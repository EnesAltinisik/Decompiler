...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 150
    iget-object v1, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/ax;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/ax;
    ...
    .line 154
    invoke-virtual {v1}, Landroid/support/v7/widget/ax;->a()V

    .line 156
    iget-object v2, p0, Landroid/support/v7/widget/g;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/view/ah;->z(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    .line 158
    iput-boolean v0, v1, Landroid/support/v7/widget/ax;->d:Z

    .line 159
    iput-object v2, v1, Landroid/support/v7/widget/ax;->a:Landroid/content/res/ColorStateList;

    .line 161
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/g;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/view/ah;->A(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 163
    iput-boolean v0, v1, Landroid/support/v7/widget/ax;->c:Z

    .line 164
    iput-object v2, v1, Landroid/support/v7/widget/ax;->b:Landroid/graphics/PorterDuff$Mode;

    .line 167
    :cond_2
    iget-boolean v2, v1, Landroid/support/v7/widget/ax;->d:Z

    if-nez v2, :cond_3

    iget-boolean v2, v1, Landroid/support/v7/widget/ax;->c:Z
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ax;[I)V
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 93
    iget-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/ax;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/ax;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/ax;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/ax;->c:Z
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 133
    iget-object v0, p0, Landroid/support/v7/widget/g;->c:Landroid/support/v7/widget/ax;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->c:Landroid/support/v7/widget/ax;
...
.method c()V
    ...
    .line 121
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/ax;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ax;[I)V

    goto :goto_0

    .line 124
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/g;->c:Landroid/support/v7/widget/ax;
