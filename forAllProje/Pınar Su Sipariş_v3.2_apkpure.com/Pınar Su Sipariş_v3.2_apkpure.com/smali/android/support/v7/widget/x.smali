...
.field private g:Landroid/support/v7/widget/aj$b;

.field private h:Landroid/widget/SpinnerAdapter;

.field private i:Z

.field private j:Landroid/support/v7/widget/x$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->l:Landroid/graphics/Rect;

    .line 198
    sget-object v0, Landroid/support/v7/a/a$k;->Spinner:[I

    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/az;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/az;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->d:Landroid/support/v7/widget/l;

    .line 202
    new-instance v0, Landroid/support/v7/widget/g;

    iget-object v2, p0, Landroid/support/v7/widget/x;->d:Landroid/support/v7/widget/l;

    invoke-direct {v0, p0, v2}, Landroid/support/v7/widget/g;-><init>(Landroid/view/View;Landroid/support/v7/widget/l;)V
    ...
    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/az;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/az;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/az;->f(II)I

    move-result v5

    iput v5, p0, Landroid/support/v7/widget/x;->k:I

    .line 247
    sget v5, Landroid/support/v7/a/a$k;->Spinner_android_popupBackground:I

    invoke-virtual {v2, v5}, Landroid/support/v7/widget/az;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/az;->d(I)Ljava/lang/String;
    ...
    .line 252
    iput-object v0, p0, Landroid/support/v7/widget/x;->j:Landroid/support/v7/widget/x$b;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/aj$b;

    .line 270
    :cond_2
    sget v0, Landroid/support/v7/a/a$k;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/az;->e(I)[Ljava/lang/CharSequence;
    ...
    .line 278
    :cond_3
    invoke-virtual {v4}, Landroid/support/v7/widget/az;->a()V
    ...
    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/az;->g(II)I
...
.method static synthetic a(Landroid/support/v7/widget/x;Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    .locals 1

    .prologue
    .line 64
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/x;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method private a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    .line 572
    iget-object v0, p0, Landroid/support/v7/widget/x;->l:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/x;->l:Landroid/graphics/Rect;
...
.method static synthetic a(Landroid/support/v7/widget/x;)Landroid/support/v7/widget/x$b;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/widget/x;->j:Landroid/support/v7/widget/x$b;
...
.method public getDropDownHorizontalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/x$b;->f()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/x$b;->d()Landroid/graphics/drawable/Drawable;
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/x$b;->i()V
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v7/widget/x;->a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 410
    iget-object v0, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/aj$b;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/aj$b;

    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/aj$b;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 395
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/x;->j:Landroid/support/v7/widget/x$b;
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/x$b;->b(I)V
...
.method public setPopupBackgroundResource(I)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/b/b;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
