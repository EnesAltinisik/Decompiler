...
# interfaces
.implements Landroid/support/v4/b/l$a;
.implements Landroid/support/v4/b/l$b;
...
.field mLoader:Landroid/support/v4/b/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# virtual methods
.method callOnLoadFinished(Landroid/support/v4/b/l;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/b/l;->dataToString(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoadFinished(Landroid/support/v4/b/l;Ljava/lang/Object;)V
    :try_end_0
...
.method cancel()V
    ...
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/b/l;
    ...
    invoke-virtual {v0}, Landroid/support/v4/b/l;->cancelLoad()Z
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->onLoadCanceled(Landroid/support/v4/b/l;)V
...
.method destroy()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/b/l;
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/b/l;

    invoke-interface {v0, v3}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoaderReset(Landroid/support/v4/b/l;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/b/l;->unregisterListener(Landroid/support/v4/b/l$b;)V

    .line 371
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/b/l;

    invoke-virtual {v0, p0}, Landroid/support/v4/b/l;->unregisterOnLoadCanceledListener(Landroid/support/v4/b/l$a;)V

    .line 373
    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/b/l;

    invoke-virtual {v0}, Landroid/support/v4/b/l;->reset()V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Landroid/support/v4/b/l;->dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method finishRetain()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/b/l;Ljava/lang/Object;)V
...
.method public onLoadCanceled(Landroid/support/v4/b/l;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/h/k;
    ...
    iget-object v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Landroid/support/v4/h/k;
...
.method public onLoadComplete(Landroid/support/v4/b/l;Ljava/lang/Object;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 444
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/b/l;Ljava/lang/Object;)V

    .line 454
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->this$0:Landroid/support/v4/app/LoaderManagerImpl;

    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Landroid/support/v4/h/k;
...
.method start()V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Landroid/support/v4/b/l;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/b/l;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/b/l;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/b/l;->registerListener(ILandroid/support/v4/b/l$b;)V

    .line 270
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/b/l;

    invoke-virtual {v0, p0}, Landroid/support/v4/b/l;->registerOnLoadCanceledListener(Landroid/support/v4/b/l$a;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/b/l;->startLoading()V
...
.method stop()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/b/l;->stopLoading()V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/h/c;->a(Ljava/lang/Object;Ljava/lang/StringBuilder;)V
