...
public final class RealConnection implements Connection {
    ...
    private void connectSocket(int i, int i2, int i3, ConnectionSpecSelector connectionSpecSelector) throws IOException {
        ...
        try {
            ...
            if (this.protocol == Protocol.SPDY_3 || this.protocol == Protocol.HTTP_2) {
                ...
                FramedConnection build = new Builder(true).socket(this.socket, this.route.address().url().host(), this.source, this.sink).protocol(this.protocol).build();
    ...
    private void createTunnel(int i, int i2) throws IOException {
        ...
        do {
            ...
            Util.skipAll(newFixedLengthSource, Strategy.TTL_SECONDS_INFINITE, TimeUnit.MILLISECONDS);
    ...
    private Request createTunnelRequest() throws IOException {
        return new Request.Builder().url(this.route.address().url()).header("Host", Util.hostHeader(this.route.address().url())).header("Proxy-Connection", "Keep-Alive").header(a.HEADER_USER_AGENT, Version.userAgent()).build();
    }
