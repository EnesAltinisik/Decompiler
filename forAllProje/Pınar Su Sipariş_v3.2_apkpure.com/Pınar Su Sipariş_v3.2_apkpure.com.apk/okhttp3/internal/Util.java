...
public final class Util {
    ...
    public static boolean skipAll(b.s r12, int r13, java.util.concurrent.TimeUnit r14) throws java.io.IOException {
...
*/
    ...
    L_0x001c:
        ...
        r4 = new b.c;	 Catch:{ InterruptedIOException -> 0x0042, all -> 0x0073 }
    ...
    L_0x003e:
        r4.t();	 Catch:{ InterruptedIOException -> 0x0042, all -> 0x0073 }
        goto L_0x0032;
    L_0x0042:
        r4 = move-exception;
        r4 = 0;
    ...
    L_0x0080:
        ...
        goto L_0x007f;
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.Util.skipAll(b.s, int, java.util.concurrent.TimeUnit):boolean");
    }
    ...
    public static String md5Hex(String str) {
        Object e;
        try {
            return f.a(MessageDigest.getInstance(Constants.MD5).digest(str.getBytes(Constants.ENCODING))).d();
    ...
    public static String shaBase64(String str) {
        Object e;
        try {
            return f.a(MessageDigest.getInstance(Constants.SHA1).digest(str.getBytes(Constants.ENCODING))).b();
        } catch (NoSuchAlgorithmException e2) {
            e = e2;
            throw new AssertionError(e);
        } catch (UnsupportedEncodingException e3) {
    ...
    public static f sha1(f fVar) {
        try {
            return f.a(MessageDigest.getInstance(Constants.SHA1).digest(fVar.g()));
