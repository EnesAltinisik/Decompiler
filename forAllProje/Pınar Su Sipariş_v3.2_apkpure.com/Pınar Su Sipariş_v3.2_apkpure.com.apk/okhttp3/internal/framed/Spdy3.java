    ...
    static final class Reader implements FrameReader {
        ...
        public boolean nextFrame(Handler handler) throws IOException {
            ...
            try {
                ...
                k2 &= 16777215;
                int i2;
                if ((zzamj.UNSET_ENUM_VALUE & k) != 0) {
                    int i3 = (2147418112 & k) >>> 16;
                    i2 = GameRequest.TYPE_ALL & k;
                    if (i3 != 3) {
                    ...
                    switch (i2) {
                        ...
                        case 9:
                            ...
                            return true;
                        default:
                            this.source.h((long) k2);
                            return true;
                    }
                }
                i2 = Strategy.TTL_SECONDS_INFINITE & k;
                if ((i & 1) != 0) {
                    z = true;
                }
        ...
        private void readSynStream(Handler handler, int i, int i2) throws IOException {
            ...
            boolean z2 = true;
            int k = this.source.k();
            int i3 = k & Strategy.TTL_SECONDS_INFINITE;
            int k2 = this.source.k() & Strategy.TTL_SECONDS_INFINITE;
            this.source.j();
        ...
        private void readRstStream(Handler handler, int i, int i2) throws IOException {
            ...
            int k = this.source.k() & Strategy.TTL_SECONDS_INFINITE;
            ErrorCode fromSpdy3Rst = ErrorCode.fromSpdy3Rst(this.source.k());
        ...
        private void readHeaders(Handler handler, int i, int i2) throws IOException {
            handler.headers(false, false, this.source.k() & Strategy.TTL_SECONDS_INFINITE, -1, this.headerBlockReader.readNameValueBlock(i2 - 4), HeadersMode.SPDY_HEADERS);
        }
        ...
        private void readWindowUpdate(Handler handler, int i, int i2) throws IOException {
            ...
            int k = this.source.k() & Strategy.TTL_SECONDS_INFINITE;
            long k2 = (long) (this.source.k() & Strategy.TTL_SECONDS_INFINITE);
            if (k2 == 0) {
        ...
        private void readGoAway(Handler handler, int i, int i2) throws IOException {
            ...
            int k = this.source.k() & Strategy.TTL_SECONDS_INFINITE;
            ErrorCode fromSpdyGoAway = ErrorCode.fromSpdyGoAway(this.source.k());
            if (fromSpdyGoAway == null) {
                throw ioException("TYPE_GOAWAY unexpected error code: %d", Integer.valueOf(r1));
            } else {
                handler.goAway(k, fromSpdyGoAway, f.b);
            }
        }
    ...
    static final class Writer implements FrameWriter {
        ...
        public synchronized void synStream(boolean z, boolean z2, int i, int i2, List<Header> list) throws IOException {
            ...
            synchronized (this) {
                ...
                this.sink.f(((i3 & 255) << 24) | (a & 16777215));
                this.sink.f(i & Strategy.TTL_SECONDS_INFINITE);
                this.sink.f(i2 & Strategy.TTL_SECONDS_INFINITE);
                this.sink.g(0);
        ...
        public synchronized void synReply(boolean z, int i, List<Header> list) throws IOException {
            ...
            this.sink.f(((i2 & 255) << 24) | (a & 16777215));
        ...
        void sendDataFrame(int i, int i2, c cVar, int i3) throws IOException {
            if (this.closed) {
                ...
                this.sink.f(Strategy.TTL_SECONDS_INFINITE & i);
                this.sink.f(((i2 & 255) << 24) | (16777215 & i3));
                if (i3 > 0) {
        ...
        public synchronized void settings(Settings settings) throws IOException {
            ...
            this.sink.f((i & 16777215) | 0);
            this.sink.f(size);
            for (size = 0; size <= 10; size++) {
                if (settings.isSet(size)) {
                    this.sink.f(((settings.flags(size) & 255) << 24) | (size & 16777215));
