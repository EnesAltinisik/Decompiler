        ...
        public Entry(s sVar) throws IOException {
            ...
            try {
                ...
                for (int i2 = 0; i2 < access$1000; i2++) {
                    builder.addLenient(a.r());
                }
                this.varyHeaders = builder.build();
                StatusLine parse = StatusLine.parse(a.r());
                ...
                if (isHttps()) {
                    ...
                    CipherSuite forJavaName = CipherSuite.forJavaName(a.r());
        ...
        return new Iterator<String>() {
            ...
            public boolean hasNext() {
                ...
                while (this.delegate.hasNext()) {
                    ...
                    try {
                        this.nextUrl = m.a(snapshot.getSource(0)).r();
                        snapshot.close();
                        return true;
                    } catch (IOException e) {
                        snapshot.close();
