...
public final class ConnectionPool {
    ...
    private static final Executor executor = new ThreadPoolExecutor(0, Strategy.TTL_SECONDS_INFINITE, 60, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory("OkHttp ConnectionPool", true));
