...
public final class CacheControl {
    public static final CacheControl FORCE_CACHE = new Builder().onlyIfCached().maxStale(Strategy.TTL_SECONDS_INFINITE, TimeUnit.SECONDS).build();
    ...
    public static final class Builder {
        ...
        public Builder maxAge(int i, TimeUnit timeUnit) {
            ...
            this.maxAgeSeconds = toSeconds > 2147483647L ? Strategy.TTL_SECONDS_INFINITE : (int) toSeconds;
            return this;
        }
        ...
        public Builder maxStale(int i, TimeUnit timeUnit) {
            ...
            long toSeconds = timeUnit.toSeconds((long) i);
            this.maxStaleSeconds = toSeconds > 2147483647L ? Strategy.TTL_SECONDS_INFINITE : (int) toSeconds;
            return this;
        }
        ...
        public Builder minFresh(int i, TimeUnit timeUnit) {
            ...
            long toSeconds = timeUnit.toSeconds((long) i);
            this.minFreshSeconds = toSeconds > 2147483647L ? Strategy.TTL_SECONDS_INFINITE : (int) toSeconds;
            return this;
        }
        ...
        while (i5 < size) {
            ...
            while (i6 < value.length()) {
                ...
                if ("no-cache".equalsIgnoreCase(trim)) {
                    ...
                    i3 = HeaderParser.parseSeconds(str2, Strategy.TTL_SECONDS_INFINITE);
