...
public final class c implements d, e, Cloneable {
    ...
    public /* synthetic */ d v() throws IOException {
        return d();
    }
        ...
        do {
            ...
            while (i4 < i3) {
                ...
                if ((-1152921504606846976L & j) != 0) {
                    throw new NumberFormatException("Number too large: " + new c().j(j).b((int) b).q());
                }
                i++;
                i4++;
                j = ((long) i2) | (j << 4);
    ...
    public String r() throws EOFException {
        ...
        throw new EOFException("\\n not found: size=" + a() + " content=" + cVar.p().d() + "...");
    }
    ...
    public String toString() {
        ...
        if (this.b <= 16) {
            f p = u().p();
            return String.format("Buffer[size=%s data=%s]", new Object[]{Long.valueOf(this.b), p.d()});
        }
        try {
            ...
            return String.format("Buffer[size=%s md5=%s]", new Object[]{Long.valueOf(this.b), f.a(instance.digest()).d()});
