...
public class AdjustEvent {
    ...
    public void addCallbackParameter(String str, String str2) {
        if (isValidParameter(str, "key", "Callback") && isValidParameter(str2, Param.VALUE, "Callback")) {
    ...
    public void addPartnerParameter(String str, String str2) {
        if (isValidParameter(str, "key", "Partner") && isValidParameter(str2, Param.VALUE, "Partner")) {
