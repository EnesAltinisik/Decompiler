...
class SessionProtobufHelper {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, String str, int i, String str2, int i2, long j, long j2, boolean z, Map<a, String> map, int i3, String str3, String str4) throws Exception {
        ByteString copyFromUtf8 = ByteString.copyFromUtf8(str);
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, Throwable th, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, float f, int i2, boolean z, long j2, long j3) throws Exception {
        ...
        codedOutputStream.writeRawVarint32(getSessionEventSize(j, str, th, thread, stackTraceElementArr, threadArr, list, 8, map, runningAppProcessInfo, i, copyFromUtf8, byteString, f, i2, z, j2, j3, byteStringForLog));
        codedOutputStream.writeUInt64(1, j);
        codedOutputStream.writeBytes(2, ByteString.copyFromUtf8(str));
        writeSessionEventApp(codedOutputStream, th, thread, stackTraceElementArr, threadArr, list, 8, copyFromUtf8, byteString, map, runningAppProcessInfo, i);
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, ByteString byteString2, int i2, long j, long j2, boolean z, Map<a, String> map, int i3, ByteString byteString3, ByteString byteString4) {
        int i4;
        int i5;
        ...
        if (map != null) {
            i5 = i4;
            for (Entry entry : map.entrySet()) {
                i4 = getDeviceIdentifierSize((a) entry.getKey(), (String) entry.getValue());
    ...
    private static int getEventAppExecutionSize(Throwable th, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, ByteString byteString, ByteString byteString2) {
        ...
        threadSize = getEventAppExecutionExceptionSize(th, 1, i);
    ...
    private static int getEventAppExecutionExceptionSize(Throwable th, int i, int i2) {
        ...
        int i4 = 0;
        while (i4 < length) {
            int frameSize = getFrameSize(stackTrace[i4], true);
            i4++;
        ...
        if (i < i2) {
            i3 = getEventAppExecutionExceptionSize(cause, i + 1, i2);
