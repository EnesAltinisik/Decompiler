...
public class zzb implements Creator<GetAccountInfoUser> {
    static void zza(GetAccountInfoUser getAccountInfoUser, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 7, getAccountInfoUser.zzOE(), i, false);
    ...
    public GetAccountInfoUser zzjm(Parcel parcel) {
        boolean z = false;
        String str = null;
    ...
    public GetAccountInfoUser[] zzno(int i) {
