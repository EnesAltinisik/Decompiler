...
public class VerifyAssertionRequest extends AbstractSafeParcelable {
    ...
    public VerifyAssertionRequest(String str, String str2, String str3, String str4, String str5) {
        ...
        if (!TextUtils.isEmpty(this.zzabK)) {
            stringBuilder.append("id_token").append("=").append(this.zzabK).append("&");
        }
        if (!TextUtils.isEmpty(this.zzbmS)) {
            stringBuilder.append("access_token").append("=").append(this.zzbmS).append("&");
        }
        if (!TextUtils.isEmpty(this.zzacn)) {
            stringBuilder.append("identifier").append("=").append(this.zzacn).append("&");
        }
        if (!TextUtils.isEmpty(this.zzbGc)) {
            stringBuilder.append("oauth_token_secret").append("=").append(this.zzbGc).append("&");
        }
        stringBuilder.append("providerId").append("=").append(this.zzbFO);
        this.zzCf = stringBuilder.toString();
    }
