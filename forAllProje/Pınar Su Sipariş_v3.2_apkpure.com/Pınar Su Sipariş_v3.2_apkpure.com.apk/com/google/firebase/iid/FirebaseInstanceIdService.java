...
public class FirebaseInstanceIdService extends zzb {
    ...
    private void zzd(Intent intent, String str) {
        ...
        if (!zzby) {
            ...
            if (zzbSI == null) {
                zzbSI = new BroadcastReceiver(this) {
    ...
    private void zznG(int i) {
        ((AlarmManager) getSystemService("alarm")).set(3, SystemClock.elapsedRealtime() + ((long) (i * 1000)), PendingIntent.getBroadcast(this, 0, zznF(i * 2), DriveFile.MODE_READ_ONLY));
    }
