...
public class FirebaseApp {
    ...
    static final Map<String, FirebaseApp> zzaTZ = new a();
    ...
    public interface zza {
        void zzb(zzaja com_google_android_gms_internal_zzaja, FirebaseUser firebaseUser);
    }
    ...
    public void zza(zzaja com_google_android_gms_internal_zzaja) {
    ...
    public void zza(zza com_google_firebase_FirebaseApp_zza) {
        zzNT();
