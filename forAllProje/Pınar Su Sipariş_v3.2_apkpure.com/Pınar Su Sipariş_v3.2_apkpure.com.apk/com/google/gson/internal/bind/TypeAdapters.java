...
public final class TypeAdapters {
    public static final TypeAdapter<AtomicBoolean> ATOMIC_BOOLEAN = new TypeAdapter<AtomicBoolean>() {
        ...
        public /* synthetic */ void write(JsonWriter jsonWriter, Object obj) throws IOException {
            a(jsonWriter, (AtomicBoolean) obj);
        }
    ...
    public static final TypeAdapter<AtomicInteger> ATOMIC_INTEGER = new TypeAdapter<AtomicInteger>() {
        ...
        public /* synthetic */ void write(JsonWriter jsonWriter, Object obj) throws IOException {
            a(jsonWriter, (AtomicInteger) obj);
        }
    ...
    public static final TypeAdapter<AtomicIntegerArray> ATOMIC_INTEGER_ARRAY = new TypeAdapter<AtomicIntegerArray>() {
        ...
        public /* synthetic */ void write(JsonWriter jsonWriter, Object obj) throws IOException {
            a(jsonWriter, (AtomicIntegerArray) obj);
        }
    ...
    public static final TypeAdapter<JsonElement> JSON_ELEMENT = new TypeAdapter<JsonElement>() {
        ...
        public JsonElement a(JsonReader jsonReader) throws IOException {
            ...
            switch (jsonReader.peek()) {
                ...
                case BEGIN_OBJECT:
                    ...
                    jsonReader.beginObject();
                    while (jsonReader.hasNext()) {
                        jsonArray.add(jsonReader.nextName(), a(jsonReader));
                    }
                    jsonReader.endObject();
                    return jsonArray;
                default:
        ...
        public void a(JsonWriter jsonWriter, JsonElement jsonElement) throws IOException {
            if (jsonElement == null || jsonElement.isJsonNull()) {
                ...
                while (it.hasNext()) {
                    a(jsonWriter, (JsonElement) it.next());
                }
                jsonWriter.endArray();
                ...
                for (Entry entry : jsonElement.getAsJsonObject().entrySet()) {
                    ...
                    a(jsonWriter, (JsonElement) entry.getValue());
                }
                jsonWriter.endObject();
            } else {
    ...
    public static final TypeAdapter<StringBuilder> STRING_BUILDER = new TypeAdapter<StringBuilder>() {
        ...
        public void a(JsonWriter jsonWriter, StringBuilder stringBuilder) throws IOException {
