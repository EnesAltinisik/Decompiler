...
public final class C$Gson$Types {
    ...
    private static final class b implements Serializable, ParameterizedType {
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            while (i < this.c.length) {
                ...
                C$Gson$Types.checkNotPrimitive(this.c[i]);
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.c) ^ this.b.hashCode()) ^ C$Gson$Types.hashCodeOrZero(this.a);
        }

        public String toString() {
            StringBuilder stringBuilder = new StringBuilder((this.c.length + 1) * 30);
            stringBuilder.append(C$Gson$Types.typeToString(this.b));
            if (this.c.length == 0) {
                return stringBuilder.toString();
            }
            stringBuilder.append("<").append(C$Gson$Types.typeToString(this.c[0]));
            for (int i = 1; i < this.c.length; i++) {
                stringBuilder.append(", ").append(C$Gson$Types.typeToString(this.c[i]));
            }
    ...
    public static Type canonicalize(Type type) {
        if (type instanceof Class) {
            ...
            if (cls.isArray()) {
                aVar = new a(C$Gson$Types.canonicalize(cls.getComponentType()));
            } else {
                Object obj = cls;
            }
            return aVar;
