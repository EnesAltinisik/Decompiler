...
public interface zzaz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaz {
        ...
        private static class a implements zzaz {
            private IBinder a;
        ...
        public static zzaz zzei(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.tagmanager.IMeasurementInterceptor");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaz)) ? new a(iBinder) : (zzaz) queryLocalInterface;
        }
