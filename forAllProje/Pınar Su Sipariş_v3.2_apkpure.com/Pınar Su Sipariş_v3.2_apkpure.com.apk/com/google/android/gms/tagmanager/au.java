...
import com.google.android.gms.tagmanager.zzde.zza;
...
class au implements t {
    ...
    class a implements zza {
        ...
        public void zzb(q qVar) {
            this.a.a(qVar.a());
            zzbn.v("Permanent failure dispatching hitId: " + qVar.a());
        }

        public void zzc(q qVar) {
            long b = qVar.b();
            if (b == 0) {
                this.a.a(qVar.a(), this.a.h.currentTimeMillis());
            } else if (b + 14400000 < this.a.h.currentTimeMillis()) {
                this.a.a(qVar.a());
                zzbn.v("Giving up on failed hitId: " + qVar.a());
            }
        }
    }
    ...
    class b extends SQLiteOpenHelper {
        ...
        b(au auVar, Context context, String str) {
            this.a = auVar;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        zzbn.zzaW(valueOf.length() == 0 ? new String(str2) : str2.concat(valueOf));
                        if (cursor != null) {
                            cursor.close();
                        }
                        return false;
        ...
        public SQLiteDatabase getWritableDatabase() {
            if (!this.b || this.c + 3600000 <= this.a.h.currentTimeMillis()) {
    ...
    au(u uVar, Context context) {
        this(uVar, context, "gtm_urls.db", 2000);
    }

    au(u uVar, Context context, String str, int i) {
        this.e = context.getApplicationContext();
        this.f = str;
        this.d = uVar;
        this.h = zzh.zzuW();
        this.b = new b(this, this.e, this.f);
        this.c = new zzde(this.e, new a(this));
        this.g = 0;
        this.i = i;
    }
    ...
    private void f() {
        ...
        if (c > 0) {
            List a = a(c);
            zzbn.v("Store full, deleting " + a.size() + " hits to make room.");
    ...
    int b() {
        ...
        SQLiteDatabase a = a("Error opening database for deleteStaleHits.");
        if (a == null) {
            return 0;
        }
        int delete = a.delete("gtm_hits", "HIT_TIME < ?", new String[]{Long.toString(this.h.currentTimeMillis() - 2592000000L)});
        u uVar = this.d;
        if (c() != 0) {
            z = false;
        }
    ...
    public java.util.List<com.google.android.gms.tagmanager.q> b(int r17) {
        /*
        r16 = this;
    ...
    L_0x004b:
        r3 = new com.google.android.gms.tagmanager.q;	 Catch:{ SQLiteException -> 0x017e, all -> 0x0174 }
        r4 = 0;
    ...
    L_0x00ac:
        ...
        r2 = (com.google.android.gms.tagmanager.q) r2;	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
        r5 = 1;
    ...
    L_0x00e2:
        com.google.android.gms.tagmanager.zzbn.zzaW(r3);	 Catch:{ all -> 0x00f2 }
    ...
    L_0x00fa:
        ...
        com.google.android.gms.tagmanager.zzbn.zzaW(r2);	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
        goto L_0x00ba;
    L_0x0118:
        r2 = move-exception;
        r13 = r3;
    ...
    L_0x012e:
        com.google.android.gms.tagmanager.zzbn.zzaW(r2);	 Catch:{ all -> 0x0161 }
    ...
    L_0x0141:
        ...
        r2 = (com.google.android.gms.tagmanager.q) r2;	 Catch:{ all -> 0x0161 }
    ...
    L_0x0184:
        ...
        goto L_0x009e;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.au.b(int):java.util.List<com.google.android.gms.tagmanager.q>");
    }
    ...
    int c() {
        ...
        if (a != null) {
            try {
                ...
                zzbn.zzaW("Error getting numStoredHits");
                if (cursor != null) {
                    cursor.close();
                }
            } catch (Throwable th) {
    ...
    int d() {
        ...
        try {
            ...
            try {
                ...
                cursor = query;
                try {
                    zzbn.zzaW("Error getting num untried hits");
                    if (cursor == null) {
                        count = 0;
                    } else {
                        cursor.close();
