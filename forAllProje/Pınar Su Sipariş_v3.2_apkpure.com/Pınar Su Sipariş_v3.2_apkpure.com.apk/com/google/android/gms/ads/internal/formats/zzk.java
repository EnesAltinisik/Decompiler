...
public class zzk extends zza implements OnClickListener, OnTouchListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public zzk(FrameLayout frameLayout, FrameLayout frameLayout2) {
        ...
        zzu.zzcE().zza(this.zzBo, (OnGlobalLayoutListener) this);
        zzu.zzcE().zza(this.zzBo, (OnScrollChangedListener) this);
    ...
    L_0x008c:
        com.google.android.gms.ads.internal.util.client.zzb.zzaW(r0);	 Catch:{ all -> 0x0090 }
        goto L_0x0018;
    L_0x0090:
        r0 = move-exception;
        monitor-exit(r6);	 Catch:{ all -> 0x0090 }
    ...
    a zzc(zzi com_google_android_gms_ads_internal_formats_zzi) {
    ...
    public void zze(zzd com_google_android_gms_dynamic_zzd) {
        synchronized (this.zzpp) {
            ...
            if (zzx instanceof zzi) {
                final zzi com_google_android_gms_ads_internal_formats_zzi = (zzi) zzx;
                if ((this.zzAL instanceof zzg) && ((zzg) this.zzAL).zzeS()) {
                    ((zzg) this.zzAL).zzc(com_google_android_gms_ads_internal_formats_zzi);
                } else {
                    this.zzAL = com_google_android_gms_ads_internal_formats_zzi;
                    if (this.zzAL instanceof zzg) {
                        ((zzg) this.zzAL).zzc(null);
                    }
                }
                this.zzpC.removeAllViews();
                this.zzBq = zzc(com_google_android_gms_ads_internal_formats_zzi);
                if (this.zzBq != null) {
                    this.zzBp.put("1007", new WeakReference(this.zzBq.a()));
                ...
                zzka.zzQu.post(new Runnable(this) {
                    ...
                    public void run() {
                        zzla zzeU = com_google_android_gms_ads_internal_formats_zzi.zzeU();
                        if (zzeU != null && this.b.zzpC != null) {
                            this.b.zzpC.addView(zzeU.getView());
                        }
                    }
                });
                com_google_android_gms_ads_internal_formats_zzi.zzg(this.zzBo);
                zzi(this.zzBo);
                return;
            }
            zzb.zzaW("Not an instance of native engine. This is most likely a transient error");
        }
    }
    ...
    Point zzj(View view) {
        if (this.zzBq == null || !this.zzBq.a().equals(view)) {
