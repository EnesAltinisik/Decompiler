...
@zzig
public class zzh {
    private static final String zzJC = String.format(Locale.US, "CREATE TABLE IF NOT EXISTS %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, %s TEXT NOT NULL, %s TEXT NOT NULL, %s INTEGER)", new Object[]{"InAppPurchase", "purchase_id", Param.PRODUCT_ID, "developer_payload", "record_time"});
    private static zzh zzJE;
    private static final Object zzpp = new Object();
    private final zza zzJD;

    public class zza extends SQLiteOpenHelper {
        final /* synthetic */ zzh zzJF;

        public zza(zzh com_google_android_gms_ads_internal_purchase_zzh, Context context, String str) {
            this.zzJF = com_google_android_gms_ads_internal_purchase_zzh;
            super(context, str, null, 4);
        }

        public void onCreate(SQLiteDatabase sQLiteDatabase) {
            sQLiteDatabase.execSQL(zzh.zzJC);
        }

        public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
            zzb.zzaV("Database updated from version " + i + " to version " + i2);
    ...
    zzh(Context context) {
        this.zzJD = new zza(this, context, "google_inapp_purchase.db");
    }

    public static zzh zzr(Context context) {
        zzh com_google_android_gms_ads_internal_purchase_zzh;
        synchronized (zzpp) {
            if (zzJE == null) {
                zzJE = new zzh(context);
            }
            com_google_android_gms_ads_internal_purchase_zzh = zzJE;
        }
    ...
    public SQLiteDatabase getWritableDatabase() {
        try {
            return this.zzJD.getWritableDatabase();
        } catch (SQLiteException e) {
            zzb.zzaW("Error opening writable conversion tracking database");
            return null;
        }
    }
    ...
    public void zza(zzf com_google_android_gms_ads_internal_purchase_zzf) {
        if (com_google_android_gms_ads_internal_purchase_zzf != null) {
            synchronized (zzpp) {
                ...
                writableDatabase.delete("InAppPurchase", String.format(Locale.US, "%s = %d", new Object[]{"purchase_id", Long.valueOf(com_google_android_gms_ads_internal_purchase_zzf.zzJx)}), null);
            }
        }
    }
    ...
    L_0x0011:
        ...
        r3 = "product_id";
        r4 = r7.zzJz;	 Catch:{ all -> 0x000e }
        r2.put(r3, r4);	 Catch:{ all -> 0x000e }
        r3 = "developer_payload";
        r4 = r7.zzJy;	 Catch:{ all -> 0x000e }
        r2.put(r3, r4);	 Catch:{ all -> 0x000e }
        r3 = "record_time";
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        zzb.zzaW(valueOf.length() == 0 ? new String(str) : str.concat(valueOf));
                        if (query != null) {
                            query.close();
                        }
                        return linkedList;
