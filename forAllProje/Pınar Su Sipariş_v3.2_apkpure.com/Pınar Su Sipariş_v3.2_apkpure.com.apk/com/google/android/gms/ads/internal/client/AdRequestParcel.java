...
public final class AdRequestParcel extends AbstractSafeParcelable {
    ...
    public int hashCode() {
        return zzz.hashCode(Integer.valueOf(this.versionCode), Long.valueOf(this.zzuN), this.extras, Integer.valueOf(this.zzuO), this.zzuP, Boolean.valueOf(this.zzuQ), Integer.valueOf(this.zzuR), Boolean.valueOf(this.zzuS), this.zzuT, this.zzuU, this.zzuV, this.zzuW, this.zzuX, this.zzuY, this.zzuZ, this.zzva, this.zzvb, Boolean.valueOf(this.zzvc));
    }
