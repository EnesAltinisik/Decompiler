...
public interface zzaa extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaa {
        ...
        private static class a implements zzaa {
            private IBinder a;
        ...
        public static zzaa zzs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzaa)) ? new a(iBinder) : (zzaa) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(com.google.android.gms.dynamic.zzd.zza.zzbz(parcel.readStrongBinder()), parcel.readInt());
