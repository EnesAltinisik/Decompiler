...
public final class zzk {
    ...
    public zzk(Context context, AttributeSet attributeSet) {
        ...
        if (obj2 != null && r1 == null) {
            this.zzvz = zzE(string);
        } else if (obj2 == null && r1 != null) {
            this.zzvz = zzE(string2);
        } else if (obj2 != null) {
            throw new IllegalArgumentException("Either XML attribute \"adSize\" or XML attribute \"supportedAdSizes\" should be specified, but not both.");
        } else {
            throw new IllegalArgumentException("Required XML attribute \"adSize\" was missing.");
        }
        this.zzqO = obtainAttributes.getString(R.styleable.AdsAttrs_adUnitId);
    ...
    public AdSize[] zzk(boolean z) {
        if (z || this.zzvz.length == 1) {
            return this.zzvz;
        }
