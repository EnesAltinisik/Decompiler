...
public final class GameManagerClient {
    ...
    public GameManagerClient(zzmy com_google_android_gms_internal_zzmy) {
        this.zzaha = com_google_android_gms_internal_zzmy;
    }
    ...
    public static PendingResult<GameManagerInstanceResult> getInstanceFor(GoogleApiClient googleApiClient, String str) throws IllegalArgumentException {
        return zza(new zzmy(googleApiClient, str, Cast.CastApi));
    }

    static PendingResult<GameManagerInstanceResult> zza(zzmy com_google_android_gms_internal_zzmy) throws IllegalArgumentException {
        return com_google_android_gms_internal_zzmy.zza(new GameManagerClient(com_google_android_gms_internal_zzmy));
    }

    private PendingResult<GameManagerResult> zza(String str, int i, JSONObject jSONObject) throws IllegalStateException {
        return this.zzaha.zza(str, i, jSONObject);
    }
    ...
    public PendingResult<GameManagerResult> sendGameRequest(String str, JSONObject jSONObject) throws IllegalStateException {
        return this.zzaha.sendGameRequest(str, jSONObject);
    }
    ...
    public void setListener(Listener listener) {
        this.zzaha.setListener(listener);
    }

    public void setSessionLabel(String str) {
        this.zzaha.setSessionLabel(str);
    }
}
