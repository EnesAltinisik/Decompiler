...
public class GcmNetworkManager {
    ...
    private static GcmNetworkManager zzaSM;
    ...
    public static GcmNetworkManager getInstance(Context context) {
        ...
        synchronized (GcmNetworkManager.class) {
            if (zzaSM == null) {
                zzaSM = new GcmNetworkManager(context.getApplicationContext());
            }
            gcmNetworkManager = zzaSM;
        }
    ...
    private Intent zzBM() {
        ...
        if (zzaT < GoogleCloudMessaging.zzaSW) {
    ...
    private void zza(ComponentName componentName) {
        zzev(componentName.getClassName());
        Intent zzBM = zzBM();
        if (zzBM != null) {
            zzBM.putExtra("scheduler_action", "CANCEL_ALL");
            zzBM.putExtra("component", componentName);
            this.mContext.sendBroadcast(zzBM);
        }
    }
    ...
    private void zza(String str, ComponentName componentName) {
        ...
        Intent zzBM = zzBM();
        if (zzBM != null) {
            zzBM.putExtra("scheduler_action", "CANCEL_TASK");
            zzBM.putExtra("tag", str);
            zzBM.putExtra("component", componentName);
            this.mContext.sendBroadcast(zzBM);
        }
    }

    static void zzeu(String str) {
    ...
    public void schedule(Task task) {
        zzev(task.getServiceName());
        Intent zzBM = zzBM();
        if (zzBM != null) {
            Bundle extras = zzBM.getExtras();
            extras.putString("scheduler_action", "SCHEDULE_TASK");
            task.toBundle(extras);
            zzBM.putExtras(extras);
            this.mContext.sendBroadcast(zzBM);
        }
    }
