...
public class zzh {
    ...
    zzh(zzx com_google_android_gms_measurement_internal_zzx, String str, String str2, String str3, long j, long j2, Bundle bundle) {
        ...
        if (this.zzbci != 0 && this.zzbci > this.zzajg) {
            com_google_android_gms_measurement_internal_zzx.zzFm().zzFG().log("Event created with reverse previous/current timestamps");
        }
        this.zzbcj = zza(com_google_android_gms_measurement_internal_zzx, bundle);
    }
    ...
    EventParams zza(zzx com_google_android_gms_measurement_internal_zzx, Bundle bundle) {
        ...
        while (it.hasNext()) {
            ...
            if (str == null) {
                com_google_android_gms_measurement_internal_zzx.zzFm().zzFE().log("Param name can't be null");
                it.remove();
            } else {
                Object zzl = com_google_android_gms_measurement_internal_zzx.zzFi().zzl(str, bundle2.get(str));
                if (zzl == null) {
                    com_google_android_gms_measurement_internal_zzx.zzFm().zzFG().zzj("Param value can't be null", str);
                    it.remove();
                } else {
                    com_google_android_gms_measurement_internal_zzx.zzFi().zza(bundle2, str, zzl);
                }
            }
        }
    ...
    zzh zza(zzx com_google_android_gms_measurement_internal_zzx, long j) {
        return new zzh(com_google_android_gms_measurement_internal_zzx, this.zzbch, this.zzPx, this.mName, this.zzajg, j, this.zzbcj);
    }
}
