...
public final class zzl {
    ...
    public static zza<Integer> zzbcG = zza.zzA("measurement.upload.max_public_events_per_day", 50000);
    public static zza<Integer> zzbcH = zza.zzA("measurement.upload.max_conversions_per_day", 500);
    ...
    public static zza<String> zzbcz = zza.zzT("measurement.config.url_scheme", Constants.SCHEME);
    ...
    public static final class zza<V> {
        ...
        private zza(String str, zzpg<V> com_google_android_gms_internal_zzpg_V, V v) {
