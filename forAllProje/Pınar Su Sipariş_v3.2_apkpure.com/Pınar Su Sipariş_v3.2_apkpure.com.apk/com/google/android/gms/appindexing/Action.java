...
public final class Action extends Thing {
    ...
    public static final class Builder extends com.google.android.gms.appindexing.Thing.Builder {
        ...
        public Action build() {
            zzaa.zzb(this.zzaay.get("object"), (Object) "setObject is required before calling build().");
            zzaa.zzb(this.zzaay.get("type"), (Object) "setType is required before calling build().");
            Bundle bundle = (Bundle) this.zzaay.getParcelable("object");
            zzaa.zzb(bundle.get("name"), (Object) "Must call setObject() with a valid name. Example: setObject(new Thing.Builder().setName(name).setUrl(url))");
            zzaa.zzb(bundle.get(PlusShare.KEY_CALL_TO_ACTION_URL), (Object) "Must call setObject() with a valid app URI. Example: setObject(new Thing.Builder().setName(name).setUrl(url))");
            return new Action(this.zzaay);
        }
