...
public interface zzdj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdj {

        private static class a implements zzdj {
            private IBinder a;
        ...
        public static zzdj zzy(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.INativeAdImage");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdj)) ? new a(iBinder) : (zzdj) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    parcel2.writeStrongBinder(zzeM != null ? zzeM.asBinder() : null);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeAdImage");
                    Uri uri = getUri();
    ...
    zzd zzeM() throws RemoteException;
}
