...
public interface zzmo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmo {
        ...
        private static class a implements zzmo {
            private IBinder a;
        ...
        public static zzmo zzax(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmo)) ? new a(iBinder) : (zzmo) queryLocalInterface;
        }
