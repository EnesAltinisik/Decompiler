...
public interface zzdp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdp {

        private static class a implements zzdp {
            private IBinder a;
        ...
        public static zzdp zzC(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdp)) ? new a(iBinder) : (zzdp) queryLocalInterface;
        }
