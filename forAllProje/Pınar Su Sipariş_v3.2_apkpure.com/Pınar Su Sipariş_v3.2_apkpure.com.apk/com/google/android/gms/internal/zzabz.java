...
public interface zzabz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzabz {

        private static class a implements zzabz {
            private IBinder a;
        ...
        public static zzabz zzet(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzabz)) ? new a(iBinder) : (zzabz) queryLocalInterface;
        }
