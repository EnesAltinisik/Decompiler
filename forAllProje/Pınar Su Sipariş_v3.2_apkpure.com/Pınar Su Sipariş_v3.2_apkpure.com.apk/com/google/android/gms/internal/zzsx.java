...
public interface zzsx extends IInterface {

    public static abstract class zza extends Binder implements zzsx {

        private static class a implements zzsx {
            private IBinder a;
        ...
        public static zzsx zzdN(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.panorama.internal.IPanoramaCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsx)) ? new a(iBinder) : (zzsx) queryLocalInterface;
        }
