...
public interface zzqj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqj {
        ...
        private static class a implements zzqj {
            private IBinder a;
            ...
            public int zzb(zzd com_google_android_gms_dynamic_zzd, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.dynamite.IDynamiteLoader");
        ...
        public static zzqj zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzqj)) ? new a(iBinder) : (zzqj) queryLocalInterface;
        }
    ...
    int zzb(zzd com_google_android_gms_dynamic_zzd, String str) throws RemoteException;
}
