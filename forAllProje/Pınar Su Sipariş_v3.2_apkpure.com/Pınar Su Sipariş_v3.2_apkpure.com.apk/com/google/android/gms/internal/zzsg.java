...
public interface zzsg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsg {
        ...
        private static class a implements zzsg {
            private IBinder a;
        ...
        public static zzsg asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.flags.IFlagProvider");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsg)) ? new a(iBinder) : (zzsg) queryLocalInterface;
        }
