...
public interface zzrq extends IInterface {

    public static abstract class zza extends Binder implements zzrq {

        private static class a implements zzrq {
            private IBinder a;
        ...
        public static zzrq zzca(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.ISyncInfoCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzrq)) ? new a(iBinder) : (zzrq) queryLocalInterface;
        }
