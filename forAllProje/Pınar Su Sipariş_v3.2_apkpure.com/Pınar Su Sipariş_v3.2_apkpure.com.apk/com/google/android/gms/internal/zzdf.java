...
public interface zzdf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdf {

        private static class a implements zzdf {
            private IBinder a;
            ...
            public String zzeE() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.customrenderedad.client.ICustomRenderedAd");
        ...
        public static zzdf zzw(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdf)) ? new a(iBinder) : (zzdf) queryLocalInterface;
        }
    ...
    String zzeE() throws RemoteException;
