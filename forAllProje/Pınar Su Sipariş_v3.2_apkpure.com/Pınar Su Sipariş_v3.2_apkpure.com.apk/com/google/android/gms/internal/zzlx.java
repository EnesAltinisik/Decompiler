...
public final class zzlx extends zzg<zzlx> {
    ...
    public void zza(zzlx com_google_android_gms_internal_zzlx) {
        if (!TextUtils.isEmpty(this.zzVG)) {
            com_google_android_gms_internal_zzlx.setScreenName(this.zzVG);
        }
        if (this.zzVH != 0) {
            com_google_android_gms_internal_zzlx.zzas(this.zzVH);
        }
        if (this.zzVI != 0) {
            com_google_android_gms_internal_zzlx.zzat(this.zzVI);
        }
        if (!TextUtils.isEmpty(this.zzVJ)) {
            com_google_android_gms_internal_zzlx.zzby(this.zzVJ);
        }
        if (!TextUtils.isEmpty(this.zzVK)) {
            com_google_android_gms_internal_zzlx.zzbz(this.zzVK);
        }
        if (this.zzVL) {
            com_google_android_gms_internal_zzlx.zzQ(this.zzVL);
        }
        if (this.zzVM) {
            com_google_android_gms_internal_zzlx.zzP(this.zzVM);
        }
    }
