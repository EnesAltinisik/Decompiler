...
public interface zzsl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsl {
        ...
        private static class a implements zzsl {
            private IBinder a;
        ...
        public static zzsl zzcj(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsl)) ? new a(iBinder) : (zzsl) queryLocalInterface;
        }
