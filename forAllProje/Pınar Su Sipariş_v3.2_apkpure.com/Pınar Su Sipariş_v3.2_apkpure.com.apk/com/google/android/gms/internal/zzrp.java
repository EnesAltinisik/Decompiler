...
public interface zzrp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzrp {
        ...
        private static class a implements zzrp {
            private IBinder a;
        ...
        public static zzrp zzbZ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IStatusCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzrp)) ? new a(iBinder) : (zzrp) queryLocalInterface;
        }
