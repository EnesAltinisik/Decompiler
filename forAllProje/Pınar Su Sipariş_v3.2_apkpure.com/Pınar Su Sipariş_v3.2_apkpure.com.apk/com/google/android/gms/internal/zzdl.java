...
public interface zzdl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdl {

        private static class a implements zzdl {
            private IBinder a;
        ...
        public static zzdl zzz(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdl)) ? new a(iBinder) : (zzdl) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zzc(parcel.readString(), com.google.android.gms.dynamic.zzd.zza.zzbz(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegate");
                    zzd zzP = zzP(parcel.readString());
                    parcel2.writeNoException();
    ...
    zzd zzP(String str) throws RemoteException;
