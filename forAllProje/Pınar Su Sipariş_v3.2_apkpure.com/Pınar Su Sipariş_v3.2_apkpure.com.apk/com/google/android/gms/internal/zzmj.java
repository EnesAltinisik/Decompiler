...
public interface zzmj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmj {
        ...
        private static class a implements zzmj {
            private IBinder a;
        ...
        public static zzmj zzap(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.appinvite.internal.IAppInviteCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmj)) ? new a(iBinder) : (zzmj) queryLocalInterface;
        }
