...
@zzig
public class zzde implements CustomRenderedAd {
    private final zzdf zzAk;

    public zzde(zzdf com_google_android_gms_internal_zzdf) {
        this.zzAk = com_google_android_gms_internal_zzdf;
    }
    ...
    public void onAdRendered(View view) {
        try {
            this.zzAk.zzi(view != null ? zze.zzD(view) : null);
        } catch (Throwable e) {
