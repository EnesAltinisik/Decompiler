...
public class zzt implements zzf {
    ...
    public zzt(zzy com_google_android_gms_internal_zzy) {
        this(com_google_android_gms_internal_zzy, new zzu(zzao));
    }

    public zzt(zzy com_google_android_gms_internal_zzy, zzu com_google_android_gms_internal_zzu) {
        this.zzap = com_google_android_gms_internal_zzy;
        this.zzaq = com_google_android_gms_internal_zzu;
    }
    ...
    private byte[] zza(HttpEntity httpEntity) throws IOException, zzp {
        zzaa com_google_android_gms_internal_zzaa = new zzaa(this.zzaq, (int) httpEntity.getContentLength());
        byte[] bArr = null;
        try {
