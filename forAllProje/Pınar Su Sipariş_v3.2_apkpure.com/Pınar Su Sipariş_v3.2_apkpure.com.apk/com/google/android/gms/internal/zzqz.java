...
public interface zzqz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqz {

        private static class a implements zzqz {
            private IBinder a;
        ...
        public static zzqz zzbJ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IDailyTotalCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzqz)) ? new a(iBinder) : (zzqz) queryLocalInterface;
        }
