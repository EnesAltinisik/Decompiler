...
public final class zzamb {
    ...
    private int zzbZT;
    private int zzbZU;
    private int zzbZV = Strategy.TTL_SECONDS_INFINITE;
    private int zzbZW;
    ...
    public byte[] readBytes() throws IOException {
        ...
        if (zzWL < 0) {
            ...
            Object obj = new byte[zzWL];
            System.arraycopy(this.buffer, this.zzbZT, obj, 0, zzWL);
    ...
    public byte[] zzD(int i, int i2) {
        ...
        System.arraycopy(this.buffer, this.zzbZQ + i, obj, 0, i2);
        return obj;
    }
    ...
    public int zzWQ() {
        if (this.zzbZV == Strategy.TTL_SECONDS_INFINITE) {
            return -1;
        }
    ...
    public void zza(zzamj com_google_android_gms_internal_zzamj) throws IOException {
        int zzWL = zzWL();
        ...
        zzWL = zznW(zzWL);
        this.zzbZW++;
        com_google_android_gms_internal_zzamj.mergeFrom(this);
        zznT(0);
        this.zzbZW--;
        zznX(zzWL);
    }

    public void zza(zzamj com_google_android_gms_internal_zzamj, int i) throws IOException {
        if (this.zzbZW >= this.zzbZX) {
            throw zzami.zzXd();
        }
        this.zzbZW++;
