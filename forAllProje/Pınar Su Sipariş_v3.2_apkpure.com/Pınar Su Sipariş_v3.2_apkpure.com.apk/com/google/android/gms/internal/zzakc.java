...
public final class zzakc extends zzakf implements Iterable<zzakf> {
    ...
    public double zzVB() {
        if (this.zzbyn.size() == 1) {
            return ((zzakf) this.zzbyn.get(0)).zzVB();
        }
        throw new IllegalStateException();
    }
    ...
    public long zzVC() {
        if (this.zzbyn.size() == 1) {
            return ((zzakf) this.zzbyn.get(0)).zzVC();
        }
        throw new IllegalStateException();
    }
    ...
    public int zzVD() {
        if (this.zzbyn.size() == 1) {
            return ((zzakf) this.zzbyn.get(0)).zzVD();
        }
        throw new IllegalStateException();
    }
    ...
    public void zzc(zzakf com_google_android_gms_internal_zzakf) {
        Object obj;
