...
public interface zzdm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzdm {

        private static class a implements zzdm {
            private IBinder a;
        ...
        public static zzdm zzA(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.INativeAdViewDelegateCreator");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzdm)) ? new a(iBinder) : (zzdm) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(com.google.android.gms.dynamic.zzd.zza.zzbz(parcel.readStrongBinder()), com.google.android.gms.dynamic.zzd.zza.zzbz(parcel.readStrongBinder()), com.google.android.gms.dynamic.zzd.zza.zzbz(parcel.readStrongBinder()), parcel.readInt());
