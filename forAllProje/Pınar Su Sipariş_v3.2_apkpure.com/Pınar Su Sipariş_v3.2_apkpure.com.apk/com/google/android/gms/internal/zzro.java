...
public interface zzro extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzro {
        ...
        private static class a implements zzro {
            private IBinder a;
        ...
        public static zzro zzbY(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.ISessionStopCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzro)) ? new a(iBinder) : (zzro) queryLocalInterface;
        }
