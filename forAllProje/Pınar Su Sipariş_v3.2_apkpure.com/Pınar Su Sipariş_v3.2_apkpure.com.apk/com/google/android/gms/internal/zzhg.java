...
public interface zzhg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhg {

        private static class a implements zzhg {
            private IBinder a;
        ...
        public static zzhg zzT(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhg)) ? new a(iBinder) : (zzhg) queryLocalInterface;
        }
