...
public class zzamp {
    ...
    public static String zzbH(Context context) {
        ...
        if (arrayList.isEmpty()) {
            ...
            zzcba = (String) arrayList.get(0);
        } else if (!TextUtils.isEmpty(obj) && !zzq(context, intent) && arrayList.contains(obj)) {
            zzcba = obj;
        } else if (arrayList.contains("com.android.chrome")) {
            zzcba = "com.android.chrome";
        } else if (arrayList.contains("com.chrome.beta")) {
            zzcba = "com.chrome.beta";
        } else if (arrayList.contains("com.chrome.dev")) {
            zzcba = "com.chrome.dev";
        } else if (arrayList.contains("com.google.android.apps.chrome")) {
            zzcba = "com.google.android.apps.chrome";
        }
        return zzcba;
    }
