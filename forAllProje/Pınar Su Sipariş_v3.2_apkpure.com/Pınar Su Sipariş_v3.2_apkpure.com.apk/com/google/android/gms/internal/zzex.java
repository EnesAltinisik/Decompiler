...
@zzig
public class zzex extends zzeu {
    private static final Set<String> zzCI = Collections.synchronizedSet(new HashSet());
    private static final DecimalFormat zzCJ = new DecimalFormat("#,###");
    private File zzCK;
    private boolean zzCL;

    public zzex(zzla com_google_android_gms_internal_zzla) {
        super(com_google_android_gms_internal_zzla);
        File cacheDir = this.mContext.getCacheDir();
        if (cacheDir == null) {
            zzb.zzaW("Context.getCacheDir() returned null");
            return;
        }
        this.zzCK = new File(cacheDir, "admobVideoStreams");
        String str;
        String valueOf;
        if (!this.zzCK.isDirectory() && !this.zzCK.mkdirs()) {
            str = "Could not create preload cache directory at ";
            valueOf = String.valueOf(this.zzCK.getAbsolutePath());
            zzb.zzaW(valueOf.length() != 0 ? str.concat(valueOf) : new String(str));
            this.zzCK = null;
        } else if (!this.zzCK.setReadable(true, false) || !this.zzCK.setExecutable(true, false)) {
    ...
    private File zzb(File file) {
        return new File(this.zzCK, String.valueOf(file.getName()).concat(".done"));
    }
    ...
    public boolean zzY(java.lang.String r27) {
        /*
        r26 = this;
        r0 = r26;
        r2 = r0.zzCK;
    ...
    L_0x0013:
        r3 = r26.zzff();
        r2 = com.google.android.gms.internal.zzcu.zzxn;
        r2 = r2.get();
    ...
    L_0x00bd:
        com.google.android.gms.ads.internal.util.client.zzb.zzaW(r2);	 Catch:{ all -> 0x00d2 }
    ...
    L_0x00e2:
        ...
        r2 = com.google.android.gms.internal.zzcu.zzxs;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
    ...
    L_0x0163:
        r6 = com.google.android.gms.ads.internal.zzu.zzcn();
        r7 = 1;
        r6.zzb(r2, r7);
    L_0x016b:
    ...
    L_0x01f2:
        com.google.android.gms.ads.internal.util.client.zzb.zzaW(r2);	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        ...
        r2 = zzCI;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
    ...
    L_0x0211:
        ...
        goto L_0x015f;
    L_0x0216:
        r2 = zzCJ;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        ...
        r2 = com.google.android.gms.internal.zzcu.zzxo;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = r2.get();	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = (java.lang.Integer) r2;	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
    ...
    L_0x0290:
        ...
        r2 = r2.append(r0);	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        r2 = r2.toString();	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        com.google.android.gms.ads.internal.util.client.zzb.zzaU(r2);	 Catch:{ IOException -> 0x0211, RuntimeException -> 0x028b }
        ...
        r18 = com.google.android.gms.ads.internal.zzu.zzco();	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r5 = 0;
        r20 = r18.currentTimeMillis();	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = com.google.android.gms.internal.zzcu.zzxr;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        ...
        r19 = new com.google.android.gms.internal.zzkk;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r0 = r19;
        r0.<init>(r2);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = com.google.android.gms.internal.zzcu.zzxq;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = r2.get();	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        r2 = (java.lang.Long) r2;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
    ...
    L_0x038f:
        r0 = r26;
        r2 = r0.zzCL;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
    ...
    L_0x03be:
        ...
        r2 = 3;
        r2 = com.google.android.gms.ads.internal.util.client.zzb.zzX(r2);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        if (r2 == 0) goto L_0x0404;
    L_0x03c8:
        r2 = zzCJ;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
        ...
        com.google.android.gms.ads.internal.util.client.zzb.zzaU(r2);	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
    L_0x0404:
        r2 = 1;
        r3 = 0;
        ...
        r2 = zzCI;	 Catch:{ IOException -> 0x03b8, RuntimeException -> 0x045d }
    ...
    L_0x045d:
        ...
        goto L_0x015f;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzex.zzY(java.lang.String):boolean");
    }

    public int zzff() {
        int i = 0;
        if (this.zzCK != null) {
            for (File name : this.zzCK.listFiles()) {
    ...
    public boolean zzfg() {
        ...
        File[] listFiles = this.zzCK.listFiles();
