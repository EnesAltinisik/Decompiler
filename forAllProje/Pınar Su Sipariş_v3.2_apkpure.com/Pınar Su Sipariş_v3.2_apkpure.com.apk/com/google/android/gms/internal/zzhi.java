...
public interface zzhi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhi {
        ...
        private static class a implements zzhi {
            private IBinder a;
        ...
        public static zzhi zzV(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhi)) ? new a(iBinder) : (zzhi) queryLocalInterface;
        }
