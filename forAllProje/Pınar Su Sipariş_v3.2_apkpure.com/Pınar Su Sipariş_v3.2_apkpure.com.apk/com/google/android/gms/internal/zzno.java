...
public interface zzno extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzno {
        ...
        private static class a implements zzno {
            private IBinder a;
            ...
            public void zza(zznn com_google_android_gms_internal_zznn, LogEventParcelable logEventParcelable) throws RemoteException {
                ...
                try {
                    ...
                    if (com_google_android_gms_internal_zznn != null) {
                        iBinder = com_google_android_gms_internal_zznn.asBinder();
                    }
        ...
        public static zzno zzaQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzno)) ? new a(iBinder) : (zzno) queryLocalInterface;
        }
    ...
    void zza(zznn com_google_android_gms_internal_zznn, LogEventParcelable logEventParcelable) throws RemoteException;
}
