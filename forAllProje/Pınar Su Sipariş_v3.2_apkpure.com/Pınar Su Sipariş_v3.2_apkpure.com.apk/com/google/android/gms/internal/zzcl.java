...
public class zzcl {
    ...
    public static class zza {
        ...
        public boolean equals(Object obj) {
            return (obj == null || !(obj instanceof zza)) ? false : ((zza) obj).value == this.value && ((zza) obj).zzuK == this.zzuK;
        }
    ...
    static void zza(int i, long j, String str, int i2, PriorityQueue<zza> priorityQueue) {
        zza com_google_android_gms_internal_zzcl_zza = new zza(j, str, i2);
        if ((priorityQueue.size() != i || (((zza) priorityQueue.peek()).zzuK <= com_google_android_gms_internal_zzcl_zza.zzuK && ((zza) priorityQueue.peek()).value <= com_google_android_gms_internal_zzcl_zza.value)) && !priorityQueue.contains(com_google_android_gms_internal_zzcl_zza)) {
            priorityQueue.add(com_google_android_gms_internal_zzcl_zza);
    ...
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zza> priorityQueue) {
        ...
        while (i4 < (strArr.length - i2) + 1) {
            long zza2 = zza(zzcj.zzC(strArr[i4 - 1]), zzcj.zzC(strArr[(i4 + i2) - 1]), zzb, zza, 16785407);
    ...
    private static long zzb(String[] strArr, int i, int i2) {
        long zzC = (((long) zzcj.zzC(strArr[i])) + 2147483647L) % 1073807359;
        for (int i3 = i + 1; i3 < i + i2; i3++) {
            zzC = (((zzC * 16785407) % 1073807359) + ((((long) zzcj.zzC(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return zzC;
    }
}
