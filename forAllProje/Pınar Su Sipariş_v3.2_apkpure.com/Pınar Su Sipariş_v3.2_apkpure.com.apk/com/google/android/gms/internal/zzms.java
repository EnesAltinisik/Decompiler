...
public interface zzms extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzms {
        ...
        private static class a implements zzms {
            private IBinder a;
        ...
        public static zzms zzaD(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.internal.IAuthCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzms)) ? new a(iBinder) : (zzms) queryLocalInterface;
        }
