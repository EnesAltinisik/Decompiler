...
public final class zzamc {
    ...
    public static int zzb(int i, zzamj com_google_android_gms_internal_zzamj) {
        return (zzof(i) * 2) + zzd(com_google_android_gms_internal_zzamj);
    }
    ...
    public static int zzc(int i, zzamj com_google_android_gms_internal_zzamj) {
        return zzof(i) + zze(com_google_android_gms_internal_zzamj);
    }

    public static int zzd(zzamj com_google_android_gms_internal_zzamj) {
        return com_google_android_gms_internal_zzamj.getSerializedSize();
    }
    ...
    public static int zze(zzamj com_google_android_gms_internal_zzamj) {
    ...
    public void zza(int i, zzamj com_google_android_gms_internal_zzamj) throws IOException {
        zzI(i, 2);
        zzc(com_google_android_gms_internal_zzamj);
    }
    ...
    public void zzb(zzamj com_google_android_gms_internal_zzamj) throws IOException {
        com_google_android_gms_internal_zzamj.writeTo(this);
    }
    ...
    public void zzc(zzamj com_google_android_gms_internal_zzamj) throws IOException {
        zzog(com_google_android_gms_internal_zzamj.getCachedSize());
        com_google_android_gms_internal_zzamj.writeTo(this);
    }
    ...
    public void zziY(String str) throws IOException {
        try {
            ...
            zza com_google_android_gms_internal_zzamc_zza = new zza(this.zzbZZ.position(), this.zzbZZ.limit());
            com_google_android_gms_internal_zzamc_zza.initCause(e);
            throw com_google_android_gms_internal_zzamc_zza;
        }
    }
