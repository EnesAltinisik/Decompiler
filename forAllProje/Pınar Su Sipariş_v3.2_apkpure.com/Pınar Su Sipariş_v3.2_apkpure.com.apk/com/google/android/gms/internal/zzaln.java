...
public final class zzaln extends zzaly {
    ...
    private void zzd(zzakf com_google_android_gms_internal_zzakf) {
        if (this.zzbXN != null) {
            if (!com_google_android_gms_internal_zzakf.zzVI() || zzWx()) {
                ((zzaki) zzWf()).zza(this.zzbXN, com_google_android_gms_internal_zzakf);
            }
            this.zzbXN = null;
        } else if (this.zzbXK.isEmpty()) {
            this.zzbXO = com_google_android_gms_internal_zzakf;
        } else {
            zzakf zzWf = zzWf();
            if (zzWf instanceof zzakc) {
                ((zzakc) zzWf).zzc(com_google_android_gms_internal_zzakf);
                return;
            }
    ...
    public zzaly zzWg() throws IOException {
        zzakf com_google_android_gms_internal_zzakc = new zzakc();
        zzd(com_google_android_gms_internal_zzakc);
        this.zzbXK.add(com_google_android_gms_internal_zzakc);
        return this;
    }
    ...
    public zzaly zzWi() throws IOException {
        zzakf com_google_android_gms_internal_zzaki = new zzaki();
        zzd(com_google_android_gms_internal_zzaki);
        this.zzbXK.add(com_google_android_gms_internal_zzaki);
        return this;
    }
