...
public interface zzrb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzrb {
        ...
        private static class a implements zzrb {
            private IBinder a;
        ...
        public static zzrb zzbL(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fitness.internal.IDataSourcesCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzrb)) ? new a(iBinder) : (zzrb) queryLocalInterface;
        }
