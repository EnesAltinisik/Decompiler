...
public final class zzakl extends zzakf {
    ...
    private static boolean zza(zzakl com_google_android_gms_internal_zzakl) {
        if (!(com_google_android_gms_internal_zzakl.zzbIu instanceof Number)) {
            return false;
        }
        Number number = (Number) com_google_android_gms_internal_zzakl.zzbIu;
    ...
    public boolean equals(Object obj) {
        ...
        zzakl com_google_android_gms_internal_zzakl = (zzakl) obj;
        if (this.zzbIu == null) {
            return com_google_android_gms_internal_zzakl.zzbIu == null;
        } else {
            if (zza(this) && zza(com_google_android_gms_internal_zzakl)) {
                return zzVz().longValue() == com_google_android_gms_internal_zzakl.zzVz().longValue();
            } else {
                if (!(this.zzbIu instanceof Number) || !(com_google_android_gms_internal_zzakl.zzbIu instanceof Number)) {
                    return this.zzbIu.equals(com_google_android_gms_internal_zzakl.zzbIu);
                }
                double doubleValue = zzVz().doubleValue();
                double doubleValue2 = com_google_android_gms_internal_zzakl.zzVz().doubleValue();
