...
public class LogEventParcelable extends AbstractSafeParcelable {
    ...
    public byte[] zzajM;
    public int[] zzajN;
    public final zzd zzajO;
    public final zzb zzajP;
    public final zzb zzajQ;
    ...
    public LogEventParcelable(PlayLoggerContext playLoggerContext, zzd com_google_android_gms_internal_zzamo_zzd, zzb com_google_android_gms_clearcut_zzb_zzb, zzb com_google_android_gms_clearcut_zzb_zzb2, int[] iArr) {
        this.versionCode = 1;
        this.zzajL = playLoggerContext;
        this.zzajO = com_google_android_gms_internal_zzamo_zzd;
        this.zzajP = com_google_android_gms_clearcut_zzb_zzb;
        this.zzajQ = com_google_android_gms_clearcut_zzb_zzb2;
        this.zzajN = iArr;
    }
