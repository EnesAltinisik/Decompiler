...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder addCallToAction(String str, Uri uri, String str2) {
            zzaa.zza(this.zzblu, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            boolean z = (uri == null || TextUtils.isEmpty(uri.toString())) ? false : true;
            zzaa.zzb(z, (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(str2)) {
                zzaa.zza(PlusShare.zzfX(str2), (Object) "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            boolean z = true;
            boolean z2 = this.zzblv != null && this.zzblv.size() > 1;
            ...
            zzaa.zza(z3, (Object) "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            zzaa.zza(z3, (Object) "The content URL is required for interactive posts.");
            ...
            zzaa.zza(z, (Object) "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                zzaa.zza(PlusShare.zzfX(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), (Object) "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
                ...
                if (this.zzblv == null || this.zzblv.isEmpty()) {
                    ...
                    this.mIntent.putExtra("android.intent.extra.STREAM", (Parcelable) this.zzblv.get(0));
                }
                this.zzblv = null;
            }
            if (z2 && !equals) {
        ...
        public Builder setContentDeepLinkId(String str, String str2, String str3, Uri uri) {
            zzaa.zzb(this.zzblu, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            zzaa.zzb(!TextUtils.isEmpty(str), (Object) "The deepLinkId parameter is required.");
    ...
    protected static boolean zzfX(String str) {
        if (TextUtils.isEmpty(str)) {
