...
public final class zzy {
    ...
    public static zza<Integer> zzXI = zza.zza("analytics.max_stored_hits", 2000, 20000);
    public static zza<Integer> zzXJ = zza.zzd("analytics.max_stored_hits_per_app", 2000);
    public static zza<Integer> zzXK = zza.zzd("analytics.max_stored_properties_per_app", 100);
    public static zza<Long> zzXL = zza.zza("analytics.local_dispatch_millis", 1800000, 120000);
    public static zza<Long> zzXM = zza.zza("analytics.initial_local_dispatch_millis", 5000, 5000);
    public static zza<Long> zzXN = zza.zzb("analytics.min_local_dispatch_millis", 120000);
    ...
    public static final class zza<V> {
        ...
        private zza(zzpg<V> com_google_android_gms_internal_zzpg_V, V v) {
            zzaa.zzz(com_google_android_gms_internal_zzpg_V);
            this.zzYv = com_google_android_gms_internal_zzpg_V;
            this.zzYu = v;
        }
