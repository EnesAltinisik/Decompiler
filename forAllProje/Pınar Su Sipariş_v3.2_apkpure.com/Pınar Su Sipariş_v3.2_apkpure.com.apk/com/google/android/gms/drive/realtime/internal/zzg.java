...
public interface zzg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzg {
        ...
        public static zzg zzbp(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(parcel.readInt() != 0 ? (DataHolder) DataHolder.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (ParcelableEventList) ParcelableEventList.CREATOR.createFromParcel(parcel) : null);
