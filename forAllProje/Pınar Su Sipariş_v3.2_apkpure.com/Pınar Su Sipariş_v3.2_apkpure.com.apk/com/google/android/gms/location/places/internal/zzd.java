...
public class zzd implements GeoDataApi {
    ...
    public PendingResult<PlacePhotoMetadataResult> getPlacePhotos(GoogleApiClient googleApiClient, final String str) {
        return googleApiClient.zzc(new zzf.zzb<zze>(this, Places.GEO_DATA_API, googleApiClient) {
            final /* synthetic */ zzd b;

            protected void a(zze com_google_android_gms_location_places_internal_zze) throws RemoteException {
                com_google_android_gms_location_places_internal_zze.zza(new zzf((zzf.zzb) this), str);
            }
