...
public final class zzg {
    ...
    public zzg(Account account, Set<Scope> set, Map<Api<?>, zza> map, int i, View view, String str, String str2, zztw com_google_android_gms_internal_zztw) {
        Map map2;
        this.zzZB = account;
        ...
        this.zzaaN = str;
        this.zzalh = str2;
        this.zzarq = com_google_android_gms_internal_zztw;
