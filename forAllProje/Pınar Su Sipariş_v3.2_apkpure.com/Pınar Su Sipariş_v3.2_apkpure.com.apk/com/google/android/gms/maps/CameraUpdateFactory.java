...
public final class CameraUpdateFactory {
    ...
    public static CameraUpdate newCameraPosition(CameraPosition cameraPosition) {
        try {
            return new CameraUpdate(zzDr().newCameraPosition(cameraPosition));
    ...
    public static CameraUpdate newLatLng(LatLng latLng) {
        try {
            return new CameraUpdate(zzDr().newLatLng(latLng));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static CameraUpdate newLatLngBounds(LatLngBounds latLngBounds, int i, int i2, int i3) {
        try {
            return new CameraUpdate(zzDr().newLatLngBoundsWithSize(latLngBounds, i, i2, i3));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static CameraUpdate scrollBy(float f, float f2) {
        try {
            return new CameraUpdate(zzDr().scrollBy(f, f2));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static CameraUpdate zoomBy(float f) {
        try {
            return new CameraUpdate(zzDr().zoomBy(f));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static CameraUpdate zoomBy(float f, Point point) {
        try {
            return new CameraUpdate(zzDr().zoomByWithFocus(f, point.x, point.y));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static CameraUpdate zoomIn() {
        try {
            return new CameraUpdate(zzDr().zoomIn());
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static CameraUpdate zoomOut() {
        try {
            return new CameraUpdate(zzDr().zoomOut());
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static CameraUpdate zoomTo(float f) {
        try {
            return new CameraUpdate(zzDr().zoomTo(f));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
