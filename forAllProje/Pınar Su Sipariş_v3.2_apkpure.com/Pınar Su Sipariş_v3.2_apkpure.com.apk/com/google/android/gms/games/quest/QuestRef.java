...
public final class QuestRef extends zzc implements Quest {
    ...
    public Uri getBannerImageUri() {
        return zzcZ("quest_banner_image_uri");
    }
    ...
    public Uri getIconImageUri() {
        return zzcZ("quest_icon_image_uri");
    }
    ...
    public boolean isEndingSoon() {
        return zzBw() <= System.currentTimeMillis() + 1800000;
    }
    ...
    public List<Milestone> zzBv() {
        ...
        for (int i = 0; i < this.zzaKH; i++) {
            arrayList.add(new MilestoneRef(this.zzamz, this.zzapa + i));
        }
        return arrayList;
    }
