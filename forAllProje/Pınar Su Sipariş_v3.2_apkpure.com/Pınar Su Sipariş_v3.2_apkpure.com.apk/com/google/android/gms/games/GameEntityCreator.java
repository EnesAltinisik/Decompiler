...
public class GameEntityCreator implements Creator<GameEntity> {
    static void zza(GameEntity gameEntity, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 10, gameEntity.zzyJ());
        zzb.zza(parcel, 11, gameEntity.zzyL());
        zzb.zza(parcel, 12, gameEntity.zzyM(), false);
        zzb.zzc(parcel, 13, gameEntity.zzyN());
        ...
        zzb.zza(parcel, 22, gameEntity.zzyK());
