...
public class QuestEntityCreator implements Creator<QuestEntity> {
    static void zza(QuestEntity questEntity, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 13, questEntity.zzBw());
        ...
        zzb.zzc(parcel, 17, questEntity.zzBv(), false);
        zzb.zzJ(parcel, zzar);
    }
    ...
    public QuestEntity zzeB(Parcel parcel) {
        ...
        while (parcel.dataPosition() < zzaq) {
            ...
            switch (zza.zzcj(zzap)) {
                ...
                case 16:
                    ...
                    break;
                case 17:
                    arrayList = zza.zzc(parcel, zzap, MilestoneEntity.CREATOR);
                    break;
                case 1000:
