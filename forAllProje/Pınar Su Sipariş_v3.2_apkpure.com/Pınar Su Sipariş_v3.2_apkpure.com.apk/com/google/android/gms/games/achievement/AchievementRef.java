...
public final class AchievementRef extends zzc implements Achievement {
    ...
    public Player getPlayer() {
        return new PlayerRef(this.zzamz, this.zzapa);
    }

    public Uri getRevealedImageUri() {
        return zzcZ("revealed_icon_image_uri");
    }
    ...
    public Uri getUnlockedImageUri() {
        return zzcZ("unlocked_icon_image_uri");
    }
    ...
    public long getXpValue() {
        return (!zzcY("instance_xp_value") || zzda("instance_xp_value")) ? getLong("definition_xp_value") : getLong("instance_xp_value");
    }
