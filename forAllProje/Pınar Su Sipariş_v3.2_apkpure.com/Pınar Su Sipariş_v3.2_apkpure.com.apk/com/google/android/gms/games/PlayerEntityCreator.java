...
public class PlayerEntityCreator implements Creator<PlayerEntity> {
    static void zza(PlayerEntity playerEntity, Parcel parcel, int i) {
        ...
        zzb.zzc(parcel, 6, playerEntity.zzyS());
        ...
        zzb.zza(parcel, 15, playerEntity.zzyU(), i, false);
        zzb.zza(parcel, 16, playerEntity.getLevelInfo(), i, false);
        zzb.zza(parcel, 18, playerEntity.zzyT());
        zzb.zza(parcel, 19, playerEntity.zzyR());
        zzb.zza(parcel, 20, playerEntity.zzyQ(), false);
        ...
        zzb.zzc(parcel, 26, playerEntity.zzyV());
        zzb.zza(parcel, 27, playerEntity.zzyW());
        ...
        while (parcel.dataPosition() < zzaq) {
            ...
            switch (zza.zzcj(zzap)) {
                ...
                case 14:
                    ...
                    break;
                case 15:
                    mostRecentGameInfoEntity = (MostRecentGameInfoEntity) zza.zza(parcel, zzap, (Creator) MostRecentGameInfoEntity.CREATOR);
                    break;
                case 16:
                    playerLevelInfo = (PlayerLevelInfo) zza.zza(parcel, zzap, PlayerLevelInfo.CREATOR);
                    break;
                case 18:
                ...
                case 23:
                    ...
                    break;
                case 24:
                    uri4 = (Uri) zza.zza(parcel, zzap, Uri.CREATOR);
                    break;
                case 25:
    ...
    public PlayerEntity[] zzgt(int i) {
