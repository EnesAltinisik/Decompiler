...
public final class AppContentTupleEntity extends AbstractSafeParcelable implements AppContentTuple {
    ...
    static int zza(AppContentTuple appContentTuple) {
        return zzz.hashCode(appContentTuple.getName(), appContentTuple.getValue());
    }
    ...
    static boolean zza(AppContentTuple appContentTuple, Object obj) {
        ...
        return zzz.equal(appContentTuple2.getName(), appContentTuple.getName()) && zzz.equal(appContentTuple2.getValue(), appContentTuple.getValue());
    }

    static String zzb(AppContentTuple appContentTuple) {
        return zzz.zzy(appContentTuple).zzg("Name", appContentTuple.getName()).zzg("Value", appContentTuple.getValue()).toString();
    }
