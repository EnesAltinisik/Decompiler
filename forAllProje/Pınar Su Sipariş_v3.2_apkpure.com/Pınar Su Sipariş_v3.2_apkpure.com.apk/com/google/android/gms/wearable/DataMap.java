...
public class DataMap {
    ...
    public static DataMap fromByteArray(byte[] bArr) {
        try {
            return zzacj.zza(new zza(zzack.zzF(bArr), new ArrayList()));
        } catch (Throwable e) {
    ...
    public boolean containsKey(String str) {
        return this.zzbBI.containsKey(str);
    }
    ...
    public <T> T get(String str) {
        return this.zzbBI.get(str);
    }

    public Asset getAsset(String str) {
        Object obj = this.zzbBI.get(str);
        if (obj == null) {
            return null;
        }
        try {
    ...
    public void putAll(DataMap dataMap) {
        for (String str : dataMap.keySet()) {
            this.zzbBI.put(str, dataMap.get(str));
        }
    }

    public void putAsset(String str, Asset asset) {
        this.zzbBI.put(str, asset);
    }

    public void putBoolean(String str, boolean z) {
        this.zzbBI.put(str, Boolean.valueOf(z));
    }

    public void putByte(String str, byte b) {
        this.zzbBI.put(str, Byte.valueOf(b));
    }

    public void putByteArray(String str, byte[] bArr) {
        this.zzbBI.put(str, bArr);
    }

    public void putDataMap(String str, DataMap dataMap) {
        this.zzbBI.put(str, dataMap);
    }

    public void putDataMapArrayList(String str, ArrayList<DataMap> arrayList) {
        this.zzbBI.put(str, arrayList);
    }

    public void putDouble(String str, double d) {
        this.zzbBI.put(str, Double.valueOf(d));
    }

    public void putFloat(String str, float f) {
        this.zzbBI.put(str, Float.valueOf(f));
    }

    public void putFloatArray(String str, float[] fArr) {
        this.zzbBI.put(str, fArr);
    }

    public void putInt(String str, int i) {
        this.zzbBI.put(str, Integer.valueOf(i));
    }
    ...
    public void putLong(String str, long j) {
        this.zzbBI.put(str, Long.valueOf(j));
    }

    public void putLongArray(String str, long[] jArr) {
        this.zzbBI.put(str, jArr);
    }

    public void putString(String str, String str2) {
        this.zzbBI.put(str, str2);
    }

    public void putStringArray(String str, String[] strArr) {
        this.zzbBI.put(str, strArr);
    }
    ...
    public Bundle toBundle() {
        ...
        for (String str : this.zzbBI.keySet()) {
            zzb(bundle, str, this.zzbBI.get(str));
        }
        return bundle;
    }

    public byte[] toByteArray() {
        return zzamj.toByteArray(zzacj.zza(this).zzbEe);
    }
