...
public class f extends e {
    ...
    private static class b extends d {
        ...
        float b = 0.0f;
        int c = 0;
        float d = TextTrackStyle.DEFAULT_FONT_SCALE;
        int e;
        float f = TextTrackStyle.DEFAULT_FONT_SCALE;
        float g = 0.0f;
        float h = TextTrackStyle.DEFAULT_FONT_SCALE;
        float i = 0.0f;
        Cap j = Cap.BUTT;
        Join k = Join.MITER;
        float l = 4.0f;
    ...
    private static class c {
        ...
        private float f = TextTrackStyle.DEFAULT_FONT_SCALE;
    ...
    private static class e {
        ...
        int e;
        String f;
        final android.support.v4.h.a<String, Object> g;
        ...
        private void a(c cVar, d dVar, Canvas canvas, int i, int i2, ColorFilter colorFilter) {
            ...
            if (f != 0.0f) {
                ...
                Paint paint;
                b bVar = (b) dVar;
                if (!(bVar.g == 0.0f && bVar.h == TextTrackStyle.DEFAULT_FONT_SCALE)) {
                    float f3 = (bVar.g + bVar.i) % TextTrackStyle.DEFAULT_FONT_SCALE;
                    float f4 = (bVar.h + bVar.i) % TextTrackStyle.DEFAULT_FONT_SCALE;
                    if (this.n == null) {
        ...
        private float a(Matrix matrix) {
            float[] fArr = new float[]{0.0f, TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE, 0.0f};
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.k.width() > 0 && this.k.height() > 0) {
            ...
            if (!(abs3 == 0.0f && abs4 == 0.0f)) {
                abs2 = TextTrackStyle.DEFAULT_FONT_SCALE;
                abs = TextTrackStyle.DEFAULT_FONT_SCALE;
            }
            ...
            if (min > 0 && height > 0) {
                ...
                if (a()) {
                    ...
                    canvas.scale(-1.0f, TextTrackStyle.DEFAULT_FONT_SCALE);
                }
                this.k.offsetTo(0, 0);
                this.c.b(min, height);
                if (!this.g) {
    ...
    public static f a(Resources resources, int i, Theme theme) {
        if (VERSION.SDK_INT >= 23) {
            f fVar = new f();
            fVar.a = android.support.v4.b.a.a.a(resources, i, theme);
