...
public class ViewPager extends ViewGroup {
        ...
        ah.a((View) this, new ab(this) {
            ...
            public bg onApplyWindowInsets(View view, bg bgVar) {
                ...
                for (int i = 0; i < childCount; i++) {
                    bg b = ah.b(this.a.getChildAt(i), a);
    ...
    public void setAdapter(ac acVar) {
        ...
        if (this.ad != null && acVar2 != acVar) {
            this.ad.a(acVar2, acVar);
        }
    }
    ...
    void a(int i, int i2, int i3) {
        ...
        int i7 = currX / 2;
        float a = (((float) i7) * a(Math.min(TextTrackStyle.DEFAULT_FONT_SCALE, (((float) Math.abs(i5)) * TextTrackStyle.DEFAULT_FONT_SCALE) / ((float) currX)))) + ((float) i7);
        int abs = Math.abs(i3);
        if (abs > 0) {
            currX = Math.round(1000.0f * Math.abs(a / ((float) abs))) * 4;
        } else {
            currX = (int) (((((float) Math.abs(i5)) / ((((float) currX) * this.h.getPageWidth(this.i)) + ((float) this.p))) + TextTrackStyle.DEFAULT_FONT_SCALE) * 100.0f);
        }
    ...
    private void a(b bVar, int i, b bVar2) {
        ...
        this.u = bVar.b == count + -1 ? (bVar.e + bVar.d) - TextTrackStyle.DEFAULT_FONT_SCALE : Float.MAX_VALUE;
        for (i3 = i - 1; i3 >= 0; i3--) {
        ...
        for (i3 = i + 1; i3 < size; i3++) {
            ...
            if (bVar3.b == count - 1) {
                this.u = (bVar3.d + f2) - TextTrackStyle.DEFAULT_FONT_SCALE;
            }
            bVar3.e = f2;
            f3 = f2 + (bVar3.d + f);
            i2++;
    ...
    private b j() {
        ...
        while (i2 < this.e.size()) {
            ...
            if (obj != null || bVar3.b == i + 1) {
                ...
                bVar3.e = (f2 + f3) + f;
                bVar3.b = i + 1;
                bVar3.d = this.h.getPageWidth(bVar3.b);
                bVar4 = bVar3;
                i3 = i2 - 1;
                bVar2 = bVar4;
            }
    ...
    public void draw(Canvas canvas) {
        ...
        if (a == 0 || (a == 1 && this.h != null && this.h.getCount() > 1)) {
            ...
            if (!this.S.a()) {
                ...
                canvas.rotate(90.0f);
                canvas.translate((float) (-getPaddingTop()), (-(this.u + TextTrackStyle.DEFAULT_FONT_SCALE)) * ((float) height));
