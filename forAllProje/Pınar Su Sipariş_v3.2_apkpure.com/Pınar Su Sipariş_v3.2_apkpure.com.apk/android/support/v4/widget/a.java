...
public abstract class a implements OnTouchListener {
    ...
    private static class a {
        ...
        private float a(long j) {
            ...
            if (this.i < 0 || j < this.i) {
                return a.b(((float) (j - this.e)) / ((float) this.a), 0.0f, (float) TextTrackStyle.DEFAULT_FONT_SCALE) * 0.5f;
            }
            long j2 = j - this.i;
            return (a.b(((float) j2) / ((float) this.k), 0.0f, (float) TextTrackStyle.DEFAULT_FONT_SCALE) * this.j) + (TextTrackStyle.DEFAULT_FONT_SCALE - this.j);
        }
    ...
    public a(View view) {
        ...
        d(0.2f, 0.2f);
        c((float) TextTrackStyle.DEFAULT_FONT_SCALE, (float) TextTrackStyle.DEFAULT_FONT_SCALE);
        b(r);
        c(500);
        d(500);
    }
    ...
    private float a(float f, float f2, float f3, float f4) {
        ...
        return b(f5, -1.0f, (float) TextTrackStyle.DEFAULT_FONT_SCALE);
    }
    ...
    private float f(float f, float f2) {
        ...
        switch (this.g) {
            ...
            case 1:
                ...
                if (f >= 0.0f) {
                    return TextTrackStyle.DEFAULT_FONT_SCALE - (f / f2);
                }
                return (this.o && this.g == 1) ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f;
            case 2:
                if (f < 0.0f) {
                    return f / (-f2);
                }
