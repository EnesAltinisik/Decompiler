...
public class ad {
    ...
    public static ad a(ViewGroup viewGroup, float f, a aVar) {
        ad a = a(viewGroup, aVar);
        a.b = (int) (((float) a.b) * (TextTrackStyle.DEFAULT_FONT_SCALE / f));
        return a;
    }
    ...
    private int a(int i, int i2, int i3) {
        ...
        int i4 = width / 2;
        float b = (b(Math.min(TextTrackStyle.DEFAULT_FONT_SCALE, ((float) Math.abs(i)) / ((float) width))) * ((float) i4)) + ((float) i4);
        i4 = Math.abs(i2);
        if (i4 > 0) {
    ...
    private void c(MotionEvent motionEvent) {
        ...
        for (int i = 0; i < c; i++) {
            int b = t.b(motionEvent, i);
            float c2 = t.c(motionEvent, i);
            float d = t.d(motionEvent, i);
            this.f[b] = c2;
            this.g[b] = d;
        }
    }
            ...
            case 2:
                if (this.a != 1) {
                    ...
                    while (i < i2) {
                        a = t.b(motionEvent, i);
                        if (g(a)) {
                            float c = t.c(motionEvent, i);
                            float d2 = t.d(motionEvent, i);
                            float f = c - this.d[a];
                    ...
                    i = t.a(motionEvent, this.c);
                    x = t.c(motionEvent, i);
                    i2 = (int) (x - this.f[this.c]);
                    i = (int) (t.d(motionEvent, i) - this.g[this.c]);
            ...
            case 6:
                ...
                if (this.a == 1 && a == this.c) {
                    ...
                    while (i < b) {
                        ...
                        if (b2 != this.c) {
                            if (d((int) t.c(motionEvent, i), (int) t.d(motionEvent, i)) == this.s && b(this.s, b2)) {
                                i = this.c;
                                if (i == -1) {
                                    g();
                                }
