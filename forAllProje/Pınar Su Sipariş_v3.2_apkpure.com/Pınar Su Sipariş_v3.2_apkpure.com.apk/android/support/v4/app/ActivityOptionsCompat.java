...
public class ActivityOptionsCompat {
    ...
    public static ActivityOptionsCompat makeSceneTransitionAnimation(Activity activity, h<View, String>... hVarArr) {
        String[] strArr = null;
        if (VERSION.SDK_INT < 21) {
            return new ActivityOptionsCompat();
        }
        ...
        if (hVarArr != null) {
            ...
            for (int i = 0; i < hVarArr.length; i++) {
                viewArr2[i] = (View) hVarArr[i].a;
                strArr2[i] = (String) hVarArr[i].b;
            }
            strArr = strArr2;
            viewArr = viewArr2;
        } else {
