...
final class FragmentManagerImpl extends FragmentManager implements n {
    ...
    static class AnimateOnHWLayerIfNeededListener implements AnimationListener {
            ...
            if (this.mView != null) {
                ...
                if (this.mShouldRunOnHWLayer) {
                    this.mView.post(new Runnable() {
                        public void run() {
                            ah.a(AnimateOnHWLayerIfNeededListener.this.mView, 2, null);
                        }
                    });
                }
            }
        ...
        public void onAnimationEnd(Animation animation) {
            if (this.mView != null && this.mShouldRunOnHWLayer) {
                this.mView.post(new Runnable() {
                    public void run() {
                        ah.a(AnimateOnHWLayerIfNeededListener.this.mView, 0, null);
                    }
                });
            }
            if (this.mOrignalListener != null) {
    ...
    static boolean shouldRunOnHWLayer(View view, Animation animation) {
        return VERSION.SDK_INT >= 19 && ah.g(view) == 0 && ah.x(view) && modifiesAlpha(animation);
    }

    private void throwException(RuntimeException runtimeException) {
        Log.e(TAG, runtimeException.getMessage());
        Log.e(TAG, "Activity state:");
        PrintWriter printWriter = new PrintWriter(new d(TAG));
        if (this.mHost != null) {
            try {
    ...
    public String toString() {
        ...
        if (this.mParent != null) {
            c.a(this.mParent, stringBuilder);
        } else {
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    for (i2 = 0; i2 < fragmentManagerState.mBackStack.length; i2++) {
                        ...
                        if (DEBUG) {
                            ...
                            instantiate2.dump("  ", new PrintWriter(new d(TAG)), false);
                        }
