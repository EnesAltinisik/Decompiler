...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    private j<String, LoaderManager> mAllLoaderManagers;
    ...
    j<String, LoaderManager> retainLoaderNonConfig() {
        int i;
        int i2 = 0;
        if (this.mAllLoaderManagers != null) {
            int size = this.mAllLoaderManagers.size();
    ...
    void restoreLoaderNonConfig(j<String, LoaderManager> jVar) {
