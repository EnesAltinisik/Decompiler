...
public class ActionBarDrawerToggle implements f {
    ...
    private class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            int i2 = ah.h(this.this$0.mActivity.getWindow().getDecorView()) == 1 ? 1 : 0;
            if (i2 != 0) {
                i = -1;
            }
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z, int i, int i2, int i3) {
        ...
        this.mDrawerImage = b.getDrawable(activity, i);
    ...
    public void syncState() {
        ...
        if (this.mDrawerIndicatorEnabled) {
            setActionBarUpIndicator(this.mSlider, this.mDrawerLayout.g(8388611) ? this.mCloseDrawerContentDescRes : this.mOpenDrawerContentDescRes);
        }
    }
    ...
    public void setHomeAsUpIndicator(int i) {
        ...
        if (i != 0) {
            drawable = b.getDrawable(this.mActivity, i);
        }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        this.mDrawerImage = b.getDrawable(this.mActivity, this.mDrawerImageResource);
        syncState();
    }
