...
public final class NavUtils {
    ...
    static class NavUtilsImplBase implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            try {
                return NavUtils.getParentActivityName(activity, componentName) == null ? j.a(componentName) : new Intent().setComponent(componentName);
    ...
    public static Intent getParentActivityIntent(Context context, Class<?> cls) throws NameNotFoundException {
        ...
        return getParentActivityName(context, componentName) == null ? j.a(componentName) : new Intent().setComponent(componentName);
    }
    ...
    public static Intent getParentActivityIntent(Context context, ComponentName componentName) throws NameNotFoundException {
        ...
        return getParentActivityName(context, componentName2) == null ? j.a(componentName2) : new Intent().setComponent(componentName2);
    }
