...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    public class TransitionState {
        ...
        public a<String, String> nameOverrides = new a();
    ...
    int commitInternal(boolean z) {
        ...
        if (FragmentManagerImpl.DEBUG) {
            ...
            dump("  ", null, new PrintWriter(new d(TAG)), null);
        }
    ...
    private static Object captureExitingViews(Object obj, Fragment fragment, ArrayList<View> arrayList, a<String, View> aVar, View view) {
        if (obj != null) {
            return FragmentTransitionCompat21.captureExitingViews(obj, fragment.getView(), arrayList, aVar, view);
        }
        return obj;
    }

    private a<String, View> remapSharedElements(TransitionState transitionState, Fragment fragment, boolean z) {
        a aVar = new a();
        if (this.mSharedElementSourceNames != null) {
            FragmentTransitionCompat21.findNamedViews(aVar, fragment.getView());
            if (z) {
                aVar.a(this.mSharedElementTargetNames);
            } else {
    ...
    private void callSharedElementEnd(TransitionState transitionState, Fragment fragment, Fragment fragment2, boolean z, a<String, View> aVar) {
        SharedElementCallback sharedElementCallback = z ? fragment2.mEnterTransitionCallback : fragment.mEnterTransitionCallback;
        if (sharedElementCallback != null) {
    ...
    private void setEpicenterIn(a<String, View> aVar, TransitionState transitionState) {
    ...
    private a<String, View> mapSharedElementsIn(TransitionState transitionState, boolean z, Fragment fragment) {
    ...
    private static a<String, View> remapNames(ArrayList<String> arrayList, ArrayList<String> arrayList2, a<String, View> aVar) {
        if (aVar.isEmpty()) {
            return aVar;
        }
    ...
    private a<String, View> mapEnteringSharedElements(TransitionState transitionState, Fragment fragment, boolean z) {
        a<String, View> aVar = new a();
    ...
    private static void setNameOverride(a<String, String> aVar, String str, String str2) {
    ...
    private void setBackNameOverrides(TransitionState transitionState, a<String, View> aVar, boolean z) {
    ...
    private void setNameOverrides(TransitionState transitionState, a<String, View> aVar, boolean z) {
        int size = aVar.size();
        for (int i = 0; i < size; i++) {
