...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    static final class NonConfigurationInstances {
        ...
        j<String, LoaderManager> loaders;
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i3 != 0) {
            ...
            if (findFragmentByWho == null) {
                ...
                findFragmentByWho.onActivityResult(GameRequest.TYPE_ALL & i, i2, intent);
                return;
            }
        }
    ...
    public final void setSupportMediaController(c cVar) {
        this.mMediaController = cVar;
        if (VERSION.SDK_INT >= 21) {
            ActivityCompat21.setMediaController(this, cVar.e());
        }
    }

    public final c getSupportMediaController() {
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        j retainLoaderNonConfig = this.mFragments.retainLoaderNonConfig();
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        if (i2 != 0) {
            ...
            if (findFragmentByWho == null) {
                ...
                findFragmentByWho.onRequestPermissionsResult(i & GameRequest.TYPE_ALL, strArr, iArr);
            }
        }
    }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i, Bundle bundle) {
        ...
        if (i == -1) {
            ...
            ActivityCompat.startActivityForResult(this, intent, ((allocateRequestIndex(fragment) + 1) << 16) + (GameRequest.TYPE_ALL & i), bundle);
            this.mStartedActivityFromFragment = false;
        }
    }
    ...
    private void requestPermissionsFromFragment(Fragment fragment, String[] strArr, int i) {
        if (i == -1) {
            ...
            try {
                ...
                ActivityCompat.requestPermissions(this, strArr, ((allocateRequestIndex(fragment) + 1) << 16) + (GameRequest.TYPE_ALL & i));
            } finally {
