...
public class b extends Drawable {
    ...
    public b(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(null, k.DrawerArrowToggle, a.drawerArrowStyle, j.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(obtainStyledAttributes.getColor(k.DrawerArrowToggle_color, 0));
        setBarThickness(obtainStyledAttributes.getDimension(k.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(obtainStyledAttributes.getBoolean(k.DrawerArrowToggle_spinBars, true));
        setGapSize((float) Math.round(obtainStyledAttributes.getDimension(k.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = obtainStyledAttributes.getDimensionPixelSize(k.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = (float) Math.round(obtainStyledAttributes.getDimension(k.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(obtainStyledAttributes.getDimension(k.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = obtainStyledAttributes.getDimension(k.DrawerArrowToggle_arrowShaftLength, 0.0f);
