...
public class ListMenuItemView extends LinearLayout implements a {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.g = obtainStyledAttributes.getDrawable(k.MenuView_android_itemBackground);
        this.h = obtainStyledAttributes.getResourceId(k.MenuView_android_itemTextAppearance, -1);
        this.j = obtainStyledAttributes.getBoolean(k.MenuView_preserveIconSpacing, false);
        this.i = context;
