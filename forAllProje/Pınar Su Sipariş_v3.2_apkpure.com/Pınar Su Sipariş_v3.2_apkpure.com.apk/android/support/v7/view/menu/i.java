...
public class i extends c<android.support.v4.e.a.b> implements MenuItem {
    private Method c;
    ...
    i(Context context, android.support.v4.e.a.b bVar) {
        super(context, bVar);
    }
    ...
    public ActionProvider getActionProvider() {
        android.support.v4.view.d a = ((android.support.v4.e.a.b) this.b).a();
        if (a instanceof a) {
            return ((a) a).a;
        }
        return null;
