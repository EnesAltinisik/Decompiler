...
public class g extends MenuInflater {
    ...
    private class b {
        ...
        public void b(AttributeSet attributeSet) {
            ...
            this.k = (obtainStyledAttributes.getInt(k.MenuItem_android_menuCategory, this.d) & -65536) | (obtainStyledAttributes.getInt(k.MenuItem_android_orderInCategory, this.e) & GameRequest.TYPE_ALL);
            ...
            if (z && this.v == 0 && this.w == null) {
                this.z = (d) a(this.x, g.b, this.a.d);
            } else {
                if (z) {
