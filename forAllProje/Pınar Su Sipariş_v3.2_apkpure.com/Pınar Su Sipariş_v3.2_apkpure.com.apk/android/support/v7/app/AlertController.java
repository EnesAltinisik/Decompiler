...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, k.AlertDialog, a.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(k.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(k.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(k.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(k.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(k.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(k.AlertDialog_listItemLayout, 0);
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        return this.mScrollView != null && this.mScrollView.a(keyEvent);
    }
    ...
    private void setupView() {
        boolean z;
        boolean z2;
        View findViewById = this.mWindow.findViewById(f.parentPanel);
        ...
        if (!(z2 || resolvePanel2 == null)) {
            findViewById3 = resolvePanel2.findViewById(f.textSpacerNoButtons);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        ...
        if ((!TextUtils.isEmpty(this.mTitle) ? 1 : 0) != 0) {
            this.mTitleView = (TextView) this.mWindow.findViewById(f.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(f.scrollView);
    ...
    private static void manageScrollIndicators(View view, View view2, View view3) {
        int i = 0;
        if (view2 != null) {
            view2.setVisibility(ah.b(view, -1) ? 0 : 4);
        }
        if (view3 != null) {
            if (!ah.b(view, 1)) {
                i = 4;
