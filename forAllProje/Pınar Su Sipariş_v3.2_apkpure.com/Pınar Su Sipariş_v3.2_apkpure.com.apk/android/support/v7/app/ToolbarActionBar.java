...
class ToolbarActionBar extends ActionBar {
    ...
    private final c mMenuClicker = new c() {
    ...
    private final class ActionMenuPresenterCallback implements a {
    ...
    private final class MenuBuilderCallback implements f.a {
    ...
    private final class PanelMenuPresenterCallback implements a {
        private PanelMenuPresenterCallback() {
        }

        public void onCloseMenu(f fVar, boolean z) {
            if (ToolbarActionBar.this.mWindowCallback != null) {
                ToolbarActionBar.this.mWindowCallback.onPanelClosed(0, fVar);
            }
        }

        public boolean onOpenSubMenu(f fVar) {
            if (fVar == null && ToolbarActionBar.this.mWindowCallback != null) {
                ToolbarActionBar.this.mWindowCallback.onMenuOpened(0, fVar);
            }
            return true;
        }
    }

    private class ToolbarCallbackWrapper extends i {
        ...
        public View onCreatePanelView(int i) {
            switch (i) {
                case 0:
                    Menu z = ToolbarActionBar.this.mDecorToolbar.z();
                    if (onPreparePanel(i, null, z) && onMenuOpened(i, z)) {
                        return ToolbarActionBar.this.getListMenuView(z);
                    }
            }
...
*/
    ...
    public ToolbarActionBar(Toolbar toolbar, CharSequence charSequence, Callback callback) {
        this.mDecorToolbar = new ba(toolbar, false);
    ...
    public void setElevation(float f) {
        ah.d(this.mDecorToolbar.a(), f);
    }

    public float getElevation() {
        return ah.s(this.mDecorToolbar.a());
    }
    ...
    public void setDisplayOptions(int i, int i2) {
        this.mDecorToolbar.c((this.mDecorToolbar.r() & (i2 ^ -1)) | (i & i2));
    }
    ...
    public boolean invalidateOptionsMenu() {
        ...
        ah.a(this.mDecorToolbar.a(), this.mMenuInvalidator);
        return true;
    }
    ...
    private View getListMenuView(Menu menu) {
        ...
        return (View) this.mListMenuPresenter.a(this.mDecorToolbar.a());
    }

    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof f)) {
            f fVar = (f) menu;
            Context b = this.mDecorToolbar.b();
            ...
            this.mListMenuPresenter = new e(contextThemeWrapper, h.abc_list_menu_item_layout);
            this.mListMenuPresenter.a(new PanelMenuPresenterCallback());
            fVar.a(this.mListMenuPresenter);
        }
    }

    private Menu getMenu() {
        if (!this.mMenuCallbackSet) {
            this.mDecorToolbar.a(new ActionMenuPresenterCallback(), new MenuBuilderCallback());
