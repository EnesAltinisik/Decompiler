...
public class ActionMenuView extends ai implements android.support.v7.view.menu.f.b, m {
    private f a;
    private Context b;
    private int c;
    private boolean d;
    private ActionMenuPresenter e;
    private android.support.v7.view.menu.l.a f;
    ...
    private class d implements android.support.v7.view.menu.f.a {
        final /* synthetic */ ActionMenuView a;
        ...
        public void onMenuModeChange(f fVar) {
            if (this.a.g != null) {
                this.a.g.onMenuModeChange(fVar);
            }
        }
    }
    ...
    static int a(View view, int i, int i2, int i3, int i4) {
        ...
        if (i2 <= 0 || (z && i2 < 2)) {
            ...
            view.measure(MeasureSpec.makeMeasureSpec(i * i2, zzamj.UNSET_ENUM_VALUE), makeMeasureSpec);
