...
class d extends DataSetObservable {
        ...
        public Void a(Object... objArr) {
            ...
            try {
                ...
                try {
                    ...
                    Log.e(d.a, "Error writing historical recrod file: " + this.a.h, e2);
                    this.a.l = true;
                    if (openFileOutput != null) {
                        try {
                            openFileOutput.close();
                    ...
                    Log.e(d.a, "Error writing historical recrod file: " + this.a.h, e22);
                    this.a.l = true;
                    if (openFileOutput != null) {
                        try {
                            openFileOutput.close();
                    ...
                    Log.e(d.a, "Error writing historical recrod file: " + this.a.h, e222);
                    this.a.l = true;
                    if (openFileOutput != null) {
                        try {
                            openFileOutput.close();
                ...
                Log.e(d.a, "Error writing historical recrod file: " + str, e2222);
            }
            return null;
        }
    }
    ...
    public Intent b(int i) {
        synchronized (this.d) {
            ...
            a(new c(componentName, System.currentTimeMillis(), (float) TextTrackStyle.DEFAULT_FONT_SCALE));
            return intent;
        }
    }
    ...
    private void d() {
        if (!this.m) {
            ...
            if (!TextUtils.isEmpty(this.h)) {
                android.support.v4.f.a.a(new e(), new ArrayList(this.f), this.h);
            }
        }
    }
