...
class at extends v implements OnClickListener {
    private final SearchManager j = ((SearchManager) this.d.getSystemService(Event.SEARCH));
    ...
    private Drawable a(String str) {
        ...
        try {
            ...
            b = b.getDrawable(this.m, parseInt);
            a(str2, b);
            return b;
