...
public class ActionBarContextView extends a {
    ...
    public /* bridge */ /* synthetic */ az a(int i, long j) {
        return super.a(i, j);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (MeasureSpec.getMode(i) != 1073741824) {
            ...
            int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i5, zzamj.UNSET_ENUM_VALUE);
            if (this.i != null) {
            ...
            if (this.j != null) {
                ...
                makeMeasureSpec = layoutParams.width != -2 ? 1073741824 : zzamj.UNSET_ENUM_VALUE;
