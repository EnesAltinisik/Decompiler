...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void a(n nVar, r rVar, View view, android.support.v4.view.a.c cVar) {
        ...
        if (layoutParams instanceof b) {
            ...
            if (this.i == 0) {
                ...
                cVar.c(l.a(a2, b, a, 1, z, false));
                return;
            }
            int a3 = bVar.a();
            int b2 = bVar.b();
            boolean z2 = this.b > 1 && bVar.b() == this.b;
            cVar.c(l.a(a, 1, a3, b2, z2, false));
            return;
        }
        super.a(view, cVar);
    }
    ...
    void a(n nVar, r rVar, c cVar, b bVar) {
        ...
        while (i7 < i3) {
            ...
            int a4 = h.a(this.c[bVar2.e + bVar2.f] - this.c[bVar2.e], i, 0, this.i == 0 ? bVar2.height : bVar2.width, false);
            int a5 = h.a(this.j.f(), this.j.h(), 0, this.i == 1 ? bVar2.height : bVar2.width, true);
            if (this.i == 1) {
                a(view2, a4, a5, bVar2.height == -1, false);
            } else {
                a(view2, a5, a4, bVar2.width == -1, false);
            }
            i6 = this.j.c(view2);
            if (i6 <= c) {
                i6 = c;
            }
            float d = (TextTrackStyle.DEFAULT_FONT_SCALE * ((float) this.j.d(view2))) / ((float) bVar2.f);
            if (d <= f) {
                d = f;
            }
            i7++;
        ...
        if (obj != null) {
            ...
            while (i8 < i3) {
                ...
                a2 = h.a(this.c[bVar2.e + bVar2.f] - this.c[bVar2.e], 1073741824, 0, this.i == 0 ? bVar2.height : bVar2.width, false);
                a3 = h.a(this.j.f(), this.j.h(), 0, this.i == 1 ? bVar2.height : bVar2.width, true);
                if (this.i == 1) {
                    a(view, a2, a3, false, true);
                } else {
                    a(view, a3, a2, false, true);
                }
                i5 = this.j.c(view);
                if (i5 <= c) {
                    i5 = c;
        ...
        for (i6 = 0; i6 < i3; i6++) {
            ...
            if (this.j.c(view) != c) {
                ...
                a2 = h.a(this.c[bVar2.e + bVar2.f] - this.c[bVar2.e], 1073741824, 0, this.i == 0 ? bVar2.height : bVar2.width, false);
                if (this.i == 1) {
                    a(view, a2, a3, true, true);
                } else {
                    a(view, a3, a2, true, true);
                }
            }
        }
        bVar.a = c;
        ...
        while (i10 < i3) {
            ...
            if (this.i != 1) {
                ...
                i4 = y() + this.c[bVar2.e + bVar2.f];
                i11 = i4;
                i12 = i4 - this.j.d(view);
            } else {
                a2 = this.c[bVar2.e] + y();
                i11 = this.j.d(view) + a2;
                i12 = a2;
            }
            a(view, i12 + bVar2.leftMargin, c + bVar2.topMargin, i11 - bVar2.rightMargin, i6 - bVar2.bottomMargin);
            if (bVar2.c() || bVar2.d()) {
                bVar.c = true;
            }
