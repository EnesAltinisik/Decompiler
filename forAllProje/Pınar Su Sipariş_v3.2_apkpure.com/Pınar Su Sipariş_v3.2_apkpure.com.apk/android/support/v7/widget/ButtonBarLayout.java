...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.a = obtainStyledAttributes.getBoolean(k.ButtonBarLayout_allowStacking, false);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (a() || MeasureSpec.getMode(i) != 1073741824) {
            ...
            i3 = MeasureSpec.makeMeasureSpec(size, zzamj.UNSET_ENUM_VALUE);
            z = true;
        }
        ...
        if (this.a && !a()) {
            ...
            } else if ((ah.j(this) & -16777216) == 16777216) {
                z2 = true;
            }
            if (z2) {
                setStacked(true);
