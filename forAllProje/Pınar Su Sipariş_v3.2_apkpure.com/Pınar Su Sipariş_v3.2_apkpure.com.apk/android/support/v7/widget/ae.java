...
public class ae extends as {
    ...
    private void t(final u uVar) {
        final az r = ah.r(uVar.a);
        this.k.add(uVar);
        r.a(f()).a(0.0f).a(new c(this) {
    ...
    private void u(final u uVar) {
        final az r = ah.r(uVar.a);
        this.i.add(uVar);
        r.a((float) TextTrackStyle.DEFAULT_FONT_SCALE).a(e()).a(new c(this) {
            final /* synthetic */ ae c;
    ...
    public boolean a(u uVar, int i, int i2, int i3, int i4) {
        View view = uVar.a;
        int n = (int) (((float) i) + ah.n(uVar.a));
        int o = (int) (((float) i2) + ah.o(uVar.a));
        v(uVar);
        int i5 = i3 - n;
        int i6 = i4 - o;
        if (i5 == 0 && i6 == 0) {
        ...
        this.d.add(new b(uVar, n, o, i3, i4));
        return true;
    }
    ...
    private void a(final a aVar) {
        ...
        if (view != null) {
            a = ah.r(view);
            this.l.add(aVar.b);
            a.b(0.0f).c(0.0f).a(g()).a((float) TextTrackStyle.DEFAULT_FONT_SCALE).a(new c(this) {
    ...
    private boolean a(a aVar, u uVar) {
        ...
        ah.c(uVar.a, (float) TextTrackStyle.DEFAULT_FONT_SCALE);
        ah.a(uVar.a, 0.0f);
        ah.b(uVar.a, 0.0f);
        a(uVar, z);
        return true;
        ...
        if (b()) {
            ...
            for (size2 = this.f.size() - 1; size2 >= 0; size2--) {
                ...
                for (size3 = arrayList.size() - 1; size3 >= 0; size3--) {
                    ...
                    ah.c(uVar2.a, (float) TextTrackStyle.DEFAULT_FONT_SCALE);
                    j(uVar2);
                    arrayList.remove(size3);
                    if (arrayList.isEmpty()) {
