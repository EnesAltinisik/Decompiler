...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        if (this.h == null && MeasureSpec.getMode(i2) == zzamj.UNSET_ENUM_VALUE && this.j >= 0) {
            i2 = MeasureSpec.makeMeasureSpec(Math.min(this.j, MeasureSpec.getSize(i2)), zzamj.UNSET_ENUM_VALUE);
        }
        ...
        if (this.h != null) {
            ...
            if (this.g != null && this.g.getVisibility() != 8 && mode != 1073741824) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(b + b(this.g), mode == zzamj.UNSET_ENUM_VALUE ? MeasureSpec.getSize(i2) : Strategy.TTL_SECONDS_INFINITE));
            }
        }
    }
