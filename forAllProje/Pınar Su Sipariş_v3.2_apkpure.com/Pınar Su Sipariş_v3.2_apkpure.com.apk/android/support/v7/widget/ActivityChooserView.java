...
public class ActivityChooserView extends ViewGroup {
    ...
    private class a extends BaseAdapter {
        ...
        public void a(d dVar) {
            ...
            if (dVar != null && this.a.isShown()) {
                dVar.registerObserver(this.a.i);
            }
    ...
    private class b implements OnClickListener, OnLongClickListener, OnItemClickListener, OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
            switch (((a) adapterView.getAdapter()).getItemViewType(i)) {
                ...
                case 1:
                    this.a.a((int) Strategy.TTL_SECONDS_INFINITE);
                    return;
                default:
                    throw new IllegalArgumentException();
            }
    ...
    private void a(int i) {
        ...
        if (i == Strategy.TTL_SECONDS_INFINITE || c <= r3 + i) {
            this.b.a(false);
            this.b.a(i);
        } else {
            this.b.a(true);
        ...
        if (!listPopupWindow.k()) {
            ...
            listPopupWindow.m().setContentDescription(getContext().getString(i.abc_activitychooserview_choose_application));
        }
    }
