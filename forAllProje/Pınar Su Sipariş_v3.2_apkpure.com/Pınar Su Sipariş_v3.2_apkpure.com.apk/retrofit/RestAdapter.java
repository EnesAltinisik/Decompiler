        ...
        if (this.logLevel.ordinal() >= LogLevel.HEADERS.ordinal()) {
            ...
            if (body != null) {
                ...
                if (this.logLevel.ordinal() >= LogLevel.FULL.ordinal()) {
                    ...
                    this.log.log(new String(((TypedByteArray) body).getBytes(), MimeUtil.parseCharset(body.mimeType(), Constants.ENCODING)));
                    str2 = str3;
                } else {
        ...
        if (this.logLevel.ordinal() >= LogLevel.HEADERS.ordinal()) {
            ...
            if (body != null) {
                ...
                if (this.logLevel.ordinal() >= LogLevel.FULL.ordinal()) {
                    ...
                    this.log.log(new String(bytes, MimeUtil.parseCharset(body.mimeType(), Constants.ENCODING)));
                }
            }
            long j3 = j2;
