...
.field private h:Landroid/support/v4/b/ab;
...
.method constructor <init>(Landroid/support/v4/b/m;)V
    ...
    iget-object v0, p1, Landroid/support/v4/b/m;->c:Landroid/os/Handler;
...
# virtual methods
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/b/ab;
    .locals 2

    iget-object v0, p0, Landroid/support/v4/b/p;->f:Landroid/support/v4/i/k;
    ...
    iput-object v0, p0, Landroid/support/v4/b/p;->f:Landroid/support/v4/i/k;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/b/ab;-><init>(Ljava/lang/String;Landroid/support/v4/b/p;Z)V

    iget-object v1, p0, Landroid/support/v4/b/p;->f:Landroid/support/v4/i/k;
    ...
    :cond_2
    invoke-virtual {v0, p0}, Landroid/support/v4/b/ab;->a(Landroid/support/v4/b/p;)V
...
.method a(Landroid/support/v4/i/k;)V
    ...
    iput-object p1, p0, Landroid/support/v4/b/p;->f:Landroid/support/v4/i/k;
...
.method a(Ljava/lang/String;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/b/ab;->f:Z
...
.method a(Z)V
    ...
    iget-object v0, p0, Landroid/support/v4/b/p;->h:Landroid/support/v4/b/ab;
...
.method k()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/b/p;->a(Ljava/lang/String;ZZ)Landroid/support/v4/b/ab;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/b/p;->h:Landroid/support/v4/b/ab;
    ...
    iget-boolean v0, v0, Landroid/support/v4/b/ab;->e:Z
...
.method m()V
    ...
    new-array v3, v2, [Landroid/support/v4/b/ab;
    ...
    invoke-virtual {v1}, Landroid/support/v4/b/ab;->e()V

    invoke-virtual {v1}, Landroid/support/v4/b/ab;->g()V
...
.method n()Landroid/support/v4/i/k;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    new-array v4, v3, [Landroid/support/v4/b/ab;
    ...
    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/b/p;->j()Z
    ...
    iget-boolean v6, v5, Landroid/support/v4/b/ab;->f:Z

    if-nez v6, :cond_2

    if-eqz v2, :cond_2

    iget-boolean v6, v5, Landroid/support/v4/b/ab;->e:Z

    if-nez v6, :cond_1

    invoke-virtual {v5}, Landroid/support/v4/b/ab;->b()V

    :cond_1
    invoke-virtual {v5}, Landroid/support/v4/b/ab;->d()V
    ...
    :cond_3
    invoke-virtual {v5}, Landroid/support/v4/b/ab;->h()V

    iget-object v6, p0, Landroid/support/v4/b/p;->f:Landroid/support/v4/i/k;

    iget-object v5, v5, Landroid/support/v4/b/ab;->d:Ljava/lang/String;
