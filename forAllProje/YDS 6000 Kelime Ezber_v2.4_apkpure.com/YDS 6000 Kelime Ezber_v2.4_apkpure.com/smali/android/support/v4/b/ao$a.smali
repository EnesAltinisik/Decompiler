.class public Landroid/support/v4/b/ao$a;
.super Ljava/lang/Object;

# interfaces
.implements Landroid/support/v4/b/af;
.implements Landroid/support/v4/b/ag;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/support/v4/b/ao;
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v4, p0, Landroid/support/v4/b/ao$a;->c:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/b/ao$a;->a:Landroid/app/Notification$Builder;

    new-instance v4, Landroid/os/Bundle;

    invoke-direct {v4}, Landroid/os/Bundle;-><init>()V

    iput-object v4, p0, Landroid/support/v4/b/ao$a;->b:Landroid/os/Bundle;

    if-eqz p18, :cond_0

    iget-object v4, p0, Landroid/support/v4/b/ao$a;->b:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/b/ao$a;->d:Landroid/widget/RemoteViews;

    move-object/from16 v0, p23

    iput-object v0, p0, Landroid/support/v4/b/ao$a;->e:Landroid/widget/RemoteViews;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Landroid/support/v4/b/ao$a;->a:Landroid/app/Notification$Builder;

    return-object v0
.end method

.method public a(Landroid/support/v4/b/al$a;)V
    .locals 2

    iget-object v0, p0, Landroid/support/v4/b/ao$a;->c:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/b/ao$a;->a:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/b/ao;->a(Landroid/app/Notification$Builder;Landroid/support/v4/b/al$a;)Landroid/os/Bundle;
...
.method public b()Landroid/app/Notification;
    ...
    invoke-static {v1}, Landroid/support/v4/b/ao;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v2

    new-instance v3, Landroid/os/Bundle;

    iget-object v0, p0, Landroid/support/v4/b/ao$a;->b:Landroid/os/Bundle;
    ...
    invoke-static {v0}, Landroid/support/v4/b/ao;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/b/ao$a;->d:Landroid/widget/RemoteViews;
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/b/ao$a;->e:Landroid/widget/RemoteViews;
