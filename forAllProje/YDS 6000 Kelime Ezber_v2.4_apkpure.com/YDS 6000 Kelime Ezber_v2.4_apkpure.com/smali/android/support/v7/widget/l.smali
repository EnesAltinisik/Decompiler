...
.field private k:Landroid/support/v4/i/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/i/f;->a(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/i/f;->b(J)V
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/l$c;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/l;->k:Landroid/support/v4/i/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->k:Landroid/support/v4/i/a;
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, v3}, Landroid/support/v4/i/f;->b(JLjava/lang/Object;)V
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroid/support/v4/i/a;->isEmpty()Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/l;->k:Landroid/support/v4/i/a;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/l;->k:Landroid/support/v4/i/a;

    invoke-virtual {v7, v0}, Landroid/support/v4/i/a;->get(Ljava/lang/Object;)Ljava/lang/Object;
