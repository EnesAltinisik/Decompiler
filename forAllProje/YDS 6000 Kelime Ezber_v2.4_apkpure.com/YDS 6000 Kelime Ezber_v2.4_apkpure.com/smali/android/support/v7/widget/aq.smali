...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/aq;->a:Landroid/view/animation/LinearInterpolator;

    new-instance v0, Landroid/view/animation/DecelerateInterpolator;

    invoke-direct {v0}, Landroid/view/animation/DecelerateInterpolator;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/aq;->b:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/aq;->a(Landroid/util/DisplayMetrics;)F

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/aq;->f:F
...
.method protected a(I)I
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/aq;->b(I)I
...
.method public a(Landroid/view/View;I)I
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/aq;->e()Landroid/support/v7/widget/RecyclerView$h;
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/aq;->a(IIIII)I
...
.method protected a(IILandroid/support/v7/widget/RecyclerView$t;Landroid/support/v7/widget/RecyclerView$s$a;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/aq;->j()I

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0}, Landroid/support/v7/widget/aq;->f()V
    ...
    invoke-direct {p0, v0, p1}, Landroid/support/v7/widget/aq;->a(II)I
    ...
    invoke-direct {p0, v0, p2}, Landroid/support/v7/widget/aq;->a(II)I
    ...
    invoke-virtual {p0, p4}, Landroid/support/v7/widget/aq;->a(Landroid/support/v7/widget/RecyclerView$s$a;)V
...
.method protected a(Landroid/support/v7/widget/RecyclerView$s$a;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/aq;->i()I

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/aq;->c(I)Landroid/graphics/PointF;
    ...
    :cond_1
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/aq;->a(Landroid/graphics/PointF;)V

    iput-object v0, p0, Landroid/support/v7/widget/aq;->c:Landroid/graphics/PointF;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/aq;->b(I)I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/aq;->a:Landroid/view/animation/LinearInterpolator;
...
.method protected a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$t;Landroid/support/v7/widget/RecyclerView$s$a;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/aq;->c()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/aq;->b(Landroid/view/View;I)I

    move-result v0

    invoke-virtual {p0}, Landroid/support/v7/widget/aq;->d()I

    move-result v1

    invoke-virtual {p0, p1, v1}, Landroid/support/v7/widget/aq;->a(Landroid/view/View;I)I
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/aq;->a(I)I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/aq;->b:Landroid/view/animation/DecelerateInterpolator;
...
.method protected b(I)I
    ...
    iget v1, p0, Landroid/support/v7/widget/aq;->f:F
...
.method protected c()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/aq;->c:Landroid/graphics/PointF;
