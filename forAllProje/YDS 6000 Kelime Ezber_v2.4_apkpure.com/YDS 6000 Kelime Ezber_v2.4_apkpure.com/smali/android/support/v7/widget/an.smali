...
.method private a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$w;
    ...
    invoke-virtual {v1, p2, v3, p3, p4}, Landroid/support/v7/widget/RecyclerView$o;->a(IZJ)Landroid/support/v7/widget/RecyclerView$w;
    ...
    :cond_2
    invoke-virtual {v1, v0, v3}, Landroid/support/v7/widget/RecyclerView$o;->a(Landroid/support/v7/widget/RecyclerView$w;Z)V
...
.method private a()V
    ...
    iget-object v4, v0, Landroid/support/v7/widget/RecyclerView;->z:Landroid/support/v7/widget/an$a;
    ...
    iget-object v8, v0, Landroid/support/v7/widget/RecyclerView;->z:Landroid/support/v7/widget/an$a;
...
.method private a(Landroid/support/v7/widget/RecyclerView;J)V
    ...
    :cond_2
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->z:Landroid/support/v7/widget/an$a;
    ...
    invoke-direct {p0, p1, v2, p2, p3}, Landroid/support/v7/widget/an;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$w;
    :try_end_0
...
.method private a(Landroid/support/v7/widget/an$b;J)V
    ...
    invoke-direct {p0, v2, v3, v0, v1}, Landroid/support/v7/widget/an;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$w;
...
.method a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->z:Landroid/support/v7/widget/an$a;
...
.method public run()V
    ...
    iput-wide v4, p0, Landroid/support/v7/widget/an;->c:J
