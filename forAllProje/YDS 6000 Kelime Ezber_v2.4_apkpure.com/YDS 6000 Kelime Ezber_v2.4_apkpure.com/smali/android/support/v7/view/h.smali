...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->f:Landroid/support/v4/view/bd;
...
.method public a(Landroid/support/v4/view/ay;Landroid/support/v4/view/ay;)Landroid/support/v7/view/h;
    .locals 2
    ...
    invoke-virtual {p1}, Landroid/support/v4/view/ay;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/view/ay;->b(J)Landroid/support/v4/view/ay;
...
.method public a(Landroid/support/v4/view/bc;)Landroid/support/v7/view/h;
    ...
    iput-object p1, p0, Landroid/support/v7/view/h;->b:Landroid/support/v4/view/bc;
...
.method public a()V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ay;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/ay;

    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/h;->b:Landroid/support/v4/view/bc;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/view/h;->f:Landroid/support/v4/view/bd;
