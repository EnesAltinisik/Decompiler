...
.method public a(Landroid/content/pm/PackageManager;I)Z
    ...
    invoke-virtual {v1, p2}, Lcom/google/android/gms/b/as;->a(I)[Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v4}, Lcom/google/android/gms/common/n;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
...
.method public a(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-static {v1}, Lcom/google/android/gms/common/m;->d(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-virtual {p0, p2, v2}, Lcom/google/android/gms/common/n;->b(Landroid/content/pm/PackageInfo;Z)Z
    ...
    :cond_2
    invoke-virtual {p0, p2, v0}, Lcom/google/android/gms/common/n;->b(Landroid/content/pm/PackageInfo;Z)Z
...
.method public a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p2, v1}, Lcom/google/android/gms/b/as;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lcom/google/android/gms/common/n;->a(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
...
.method b(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-direct {v1, v0}, Lcom/google/android/gms/common/l$b;-><init>([B)V

    iget-object v0, p1, Landroid/content/pm/PackageInfo;->packageName:Ljava/lang/String;

    if-eqz p2, :cond_1

    invoke-static {v0, v1}, Lcom/google/android/gms/common/l;->b(Ljava/lang/String;Lcom/google/android/gms/common/l$a;)Z
    ...
    :cond_1
    invoke-static {v0, v1}, Lcom/google/android/gms/common/l;->a(Ljava/lang/String;Lcom/google/android/gms/common/l$a;)Z
