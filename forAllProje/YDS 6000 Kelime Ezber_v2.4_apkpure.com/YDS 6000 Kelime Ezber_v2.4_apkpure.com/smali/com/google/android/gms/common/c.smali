...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, p2, v0, p4}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/r;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/q;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method a(Landroid/content/Context;ILcom/google/android/gms/common/internal/r;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/q;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/q;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/q;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/b/r$a;)Lcom/google/android/gms/b/r;
    .locals 2
    ...
    invoke-direct {v0, p2}, Lcom/google/android/gms/b/r;-><init>(Lcom/google/android/gms/b/r$a;)V

    invoke-virtual {p1, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v0, p1}, Lcom/google/android/gms/b/r;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/b/r$a;->a()V
...
.method a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    :try_start_0
    instance-of v0, p1, Landroid/support/v4/b/m;
    :try_end_0
    ...
    invoke-virtual {p1}, Landroid/support/v4/b/m;->e()Landroid/support/v4/b/q;
    ...
    invoke-virtual {v1, v0, p3}, Lcom/google/android/gms/common/g;->a(Landroid/support/v4/b/q;Ljava/lang/String;)V
...
.method a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/q;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/q;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    new-instance v3, Landroid/support/v4/b/ah$d;

    invoke-direct {v3, p1}, Landroid/support/v4/b/ah$d;-><init>(Landroid/content/Context;)V

    const v4, 0x108008a

    invoke-virtual {v3, v4}, Landroid/support/v4/b/ah$d;->a(I)Landroid/support/v4/b/ah$d;
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/b/ah$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/b/ah$d;
    ...
    invoke-virtual {v2, v4, v5}, Landroid/support/v4/b/ah$d;->a(J)Landroid/support/v4/b/ah$d;

    move-result-object v2

    invoke-virtual {v2, v6}, Landroid/support/v4/b/ah$d;->a(Z)Landroid/support/v4/b/ah$d;

    move-result-object v2

    invoke-virtual {v2, p4}, Landroid/support/v4/b/ah$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/b/ah$d;

    move-result-object v2

    invoke-virtual {v2, v0}, Landroid/support/v4/b/ah$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/b/ah$d;

    move-result-object v0

    invoke-virtual {v0, v1}, Landroid/support/v4/b/ah$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/b/ah$d;

    move-result-object v0

    invoke-virtual {v0, v6}, Landroid/support/v4/b/ah$d;->b(Z)Landroid/support/v4/b/ah$d;

    move-result-object v0

    new-instance v2, Landroid/support/v4/b/ah$c;

    invoke-direct {v2}, Landroid/support/v4/b/ah$c;-><init>()V

    invoke-virtual {v2, v1}, Landroid/support/v4/b/ah$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/b/ah$c;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v4/b/ah$d;->a(Landroid/support/v4/b/ah$q;)Landroid/support/v4/b/ah$d;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/v4/b/ah$d;->a()Landroid/app/Notification;
...
.method public a(Landroid/app/Activity;Lcom/google/android/gms/b/w;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 2
    ...
    invoke-static {p2, v0, p4}, Lcom/google/android/gms/common/internal/r;->a(Lcom/google/android/gms/b/w;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/r;

    move-result-object v0

    invoke-virtual {p0, p1, p3, v0, p5}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/r;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
