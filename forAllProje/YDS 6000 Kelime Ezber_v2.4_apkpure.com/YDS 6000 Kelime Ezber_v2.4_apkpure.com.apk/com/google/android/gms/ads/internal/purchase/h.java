...
public class h {
    ...
    public class a extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
            zy.d("Database updated from version " + i + " to version " + i2);
    ...
    public SQLiteDatabase a() {
        try {
            ...
            zy.e("Error opening writable conversion tracking database");
            return null;
        }
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        zy.e(valueOf.length() == 0 ? new String(str) : str.concat(valueOf));
                        if (query != null) {
                            query.close();
                        }
                        return linkedList;
