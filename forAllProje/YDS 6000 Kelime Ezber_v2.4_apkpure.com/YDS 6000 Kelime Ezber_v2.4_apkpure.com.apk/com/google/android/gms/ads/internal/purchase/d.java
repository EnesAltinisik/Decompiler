...
import com.google.android.gms.b.uu.a;
...
public class d extends a {
    ...
    Map<String, String> b() {
        ...
        try {
            ...
            zy.c("Error to retrieve app version", e);
        }
    ...
    void c() {
        try {
            ...
            zy.e("Google Conversion Tracking SDK 1.2.0 or above is required to report a conversion.");
        } catch (NoSuchMethodException e2) {
            zy.e("Google Conversion Tracking SDK 1.2.0 or above is required to report a conversion.");
        } catch (Throwable e3) {
            zy.c("Fail to report a conversion.", e3);
        }
    }
