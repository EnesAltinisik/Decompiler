...
public class uf extends uk {
    ...
    public uf(aaq com_google_android_gms_b_aaq, ul ulVar) {
        super(com_google_android_gms_b_aaq, "resize");
        this.k = com_google_android_gms_b_aaq;
        this.l = com_google_android_gms_b_aaq.f();
        this.p = ulVar;
    }
    ...
    public void a(int i, int i2, boolean z) {
        synchronized (this.j) {
            ...
            if (this.q != null && z) {
                int[] d = d();
                if (d != null) {
                    this.q.update(oc.a().a(this.l, d[0]), oc.a().a(this.l, d[1]), this.q.getWidth(), this.q.getHeight());
                    b(d[0], d[1]);
                } else {
                    a(true);
                }
    ...
    L_0x006e:
        ...
        goto L_0x0010;
    L_0x0075:
        r1 = com.google.android.gms.b.oc.a();	 Catch:{ all -> 0x0020 }
    ...
    L_0x0116:
        ...
        r9 = com.google.android.gms.b.oc.a();	 Catch:{ all -> 0x0020 }
    ...
    L_0x0163:
        ...
        r3 = new com.google.android.gms.b.uf$1;	 Catch:{ all -> 0x0020 }
        ...
        r3 = 0;
        r4 = com.google.android.gms.b.oc.a();	 Catch:{ RuntimeException -> 0x0265 }
        r5 = r12.l;	 Catch:{ RuntimeException -> 0x0265 }
        r7 = 0;
        r7 = r8[r7];	 Catch:{ RuntimeException -> 0x0265 }
        r4 = r4.a(r5, r7);	 Catch:{ RuntimeException -> 0x0265 }
        r5 = com.google.android.gms.b.oc.a();	 Catch:{ RuntimeException -> 0x0265 }
        ...
        r1 = r12.k;	 Catch:{ all -> 0x0020 }
        r2 = new com.google.android.gms.b.nx;	 Catch:{ all -> 0x0020 }
    ...
    L_0x02a8:
        ...
        goto L_0x027a;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.b.uf.a(java.util.Map):void");
    }
    ...
    boolean c() {
        ...
        if (this.i < 50 || this.i > i) {
            zy.e("Width is too small or too large.");
            return false;
        } else if (this.f < 50 || this.f > i2) {
            zy.e("Height is too small or too large.");
            return false;
        } else if (this.f == i2 && this.i == i) {
            zy.e("Cannot resize to a full-screen ad.");
            return false;
        } else {
            if (this.c) {
                int i3;
