...
public abstract class acf extends v implements OnCancelListener {
    protected boolean b;
    protected boolean c;
    protected final c d;
    ...
    private class a implements Runnable {
        ...
        private a(acf com_google_android_gms_b_acf) {
            this.a = com_google_android_gms_b_acf;
        }
        ...
        public void run() {
            ...
            if (this.a.e.a()) {
                this.a.a.startActivityForResult(GoogleApiActivity.b(this.a.e(), this.a.e.d(), this.a.f, false), 1);
            } else if (this.a.d.a(this.a.e.c())) {
                this.a.d.a(this.a.e(), this.a.a, this.a.e.c(), 2, this.a);
            } else if (this.a.e.c() == 18) {
                final Dialog a = this.a.d.a(this.a.e(), this.a);
                this.a.d.a(this.a.e().getApplicationContext(), new com.google.android.gms.b.r.a(this) {
                    final /* synthetic */ a b;
    ...
    L_0x0047:
        ...
        goto L_0x001c;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.b.acf.a(int, int, android.content.Intent):void");
    }
