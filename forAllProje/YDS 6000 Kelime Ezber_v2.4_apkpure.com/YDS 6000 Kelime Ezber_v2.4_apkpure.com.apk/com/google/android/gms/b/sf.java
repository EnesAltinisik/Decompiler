...
@vz
public abstract class sf implements f {
    protected Context a;
    protected String b;
    protected WeakReference<aaq> c;

    public sf(aaq com_google_android_gms_b_aaq) {
        this.a = com_google_android_gms_b_aaq.getContext();
        this.b = v.e().a(this.a, com_google_android_gms_b_aaq.o().b);
        this.c = new WeakReference(com_google_android_gms_b_aaq);
    }

    private void a(String str, Map<String, String> map) {
        aaq com_google_android_gms_b_aaq = (aaq) this.c.get();
        if (com_google_android_gms_b_aaq != null) {
            com_google_android_gms_b_aaq.a(str, (Map) map);
        }
    }
    ...
    public void a(String str, String str2, String str3, String str4) {
        ...
        zx.a.post(new Runnable(this) {
            ...
            public void run() {
                ...
                hashMap.put("type", this.e.c(str7));
