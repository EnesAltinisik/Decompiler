...
public final class lg {
    ...
    private lg(ByteBuffer byteBuffer) {
        this.a = byteBuffer;
        this.a.order(ByteOrder.LITTLE_ENDIAN);
    }

    private lg(byte[] bArr, int i, int i2) {
    ...
    public static lg a(byte[] bArr) {
        return a(bArr, 0, bArr.length);
    }

    public static lg a(byte[] bArr, int i, int i2) {
        return new lg(bArr, i, i2);
    }
    ...
    public static int b(int i, ln lnVar) {
        return (d(i) * 2) + c(lnVar);
    }
