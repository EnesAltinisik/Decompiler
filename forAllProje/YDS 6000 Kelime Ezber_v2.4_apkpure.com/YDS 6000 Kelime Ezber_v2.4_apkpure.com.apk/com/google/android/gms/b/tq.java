...
public interface tq extends IInterface {

    public static abstract class a extends Binder implements tq {

        private static class a implements tq {
            private IBinder a;
        ...
        public static tq a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof tq)) ? new a(iBinder) : (tq) queryLocalInterface;
        }
