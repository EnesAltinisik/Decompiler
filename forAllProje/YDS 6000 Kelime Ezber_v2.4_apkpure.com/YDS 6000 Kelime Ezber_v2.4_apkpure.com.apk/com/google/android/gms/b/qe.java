...
public interface qe extends IInterface {
    ...
    public static abstract class a extends Binder implements qe {
        ...
        private static class a implements qe {
            ...
            public void a(qd qdVar) {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(qdVar != null ? qdVar.asBinder() : null);
        ...
        public static qe a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.customrenderedad.client.IOnCustomRenderedAdLoadedListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof qe)) ? new a(iBinder) : (qe) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(com.google.android.gms.b.qd.a.a(parcel.readStrongBinder()));
