...
public class abj implements en {
    ...
    static class a {
        ...
        public a(String str, com.google.android.gms.b.en.a aVar) {
            this.b = str;
        ...
        public static a a(InputStream inputStream) {
            ...
            aVar.b = abj.c(inputStream);
            aVar.c = abj.c(inputStream);
            if (aVar.c.equals("")) {
                aVar.c = null;
            }
            aVar.d = abj.b(inputStream);
            aVar.e = abj.b(inputStream);
            aVar.f = abj.b(inputStream);
            aVar.g = abj.b(inputStream);
            aVar.h = abj.d(inputStream);
            return aVar;
        }

        public com.google.android.gms.b.en.a a(byte[] bArr) {
            com.google.android.gms.b.en.a aVar = new com.google.android.gms.b.en.a();
            aVar.a = bArr;
            aVar.b = this.c;
            aVar.c = this.d;
            aVar.d = this.e;
    ...
    public abj(File file) {
        this(file, 5242880);
    }

    public abj(File file, int i) {
    ...
    private void a(int i) {
        if (this.b + ((long) i) >= ((long) this.d)) {
            int i2;
            if (abg.b) {
                abg.a("Pruning old cache entries.", new Object[0]);
            }
            long j = this.b;
            ...
            while (it.hasNext()) {
                ...
                if (c(aVar.b).delete()) {
                    ...
                    abg.b("Could not delete cache entry for key=%s, filename=%s", aVar.b, d(aVar.b));
                }
                it.remove();
                i2 = i3 + 1;
            ...
            i2 = i3;
            if (abg.b) {
                abg.a("pruned %d files, %d bytes, %d ms", Integer.valueOf(i2), Long.valueOf(this.b - j), Long.valueOf(SystemClock.elapsedRealtime() - elapsedRealtime));
            }
        }
    }
    ...
    public synchronized com.google.android.gms.b.en.a a(String str) {
        com.google.android.gms.b.en.a aVar;
        IOException e;
        Throwable th;
        a aVar2 = (a) this.a.get(str);
        if (aVar2 == null) {
            ...
            try {
                ...
                try {
                    ...
                    e = e3;
                    try {
                        abg.b("%s: %s", c.getAbsolutePath(), e.toString());
                        b(str);
                        if (bVar != null) {
                            try {
                                bVar.close();
    ...
    public synchronized void a() {
        ...
        if (this.c.exists()) {
            ...
            abg.c("Unable to create cache dir %s", this.c.getAbsolutePath());
        }
        return;
    ...
    public synchronized void a(String str, com.google.android.gms.b.en.a aVar) {
        a(aVar.a.length);
        File c = c(str);
        try {
            ...
            if (aVar2.a(fileOutputStream)) {
                ...
                fileOutputStream.close();
                abg.b("Failed to write header for %s", c.getAbsolutePath());
                throw new IOException();
            }
        } catch (IOException e) {
            if (!c.delete()) {
                abg.b("Could not clean up file %s", c.getAbsolutePath());
            }
        }
    }
    ...
    public synchronized void b(String str) {
        ...
        e(str);
        if (!delete) {
            abg.b("Could not delete cache entry for key=%s, filename=%s", str, d(str));
        }
    }
