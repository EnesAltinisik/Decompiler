...
public interface xp extends IInterface {
    ...
    public static abstract class a extends Binder implements xp {

        private static class a implements xp {
            private IBinder a;
        ...
        public static xp a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof xp)) ? new a(iBinder) : (xp) queryLocalInterface;
        }
