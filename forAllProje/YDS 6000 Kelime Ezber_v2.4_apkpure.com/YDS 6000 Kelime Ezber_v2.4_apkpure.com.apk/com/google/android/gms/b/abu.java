...
public class abu {
    ...
    private static long c(byte[] bArr) {
        ...
        length = (length - 1) & -64;
        while (true) {
            a2 = Long.rotateRight(((a2 + rotateRight) + jArr[0]) + a(bArr, i + 16), 37) * -8261664234251669945L;
            a = a2 ^ jArr2[1];
            rotateRight = (Long.rotateRight((jArr[1] + rotateRight) + a(bArr, i + 48), 42) * -8261664234251669945L) ^ jArr[0];
            a3 = Long.rotateRight(a4 ^ jArr2[0], 33);
            a(bArr, i, jArr[1] * -8261664234251669945L, jArr2[0] + a, jArr);
            a(bArr, i + 32, a3 + jArr2[1], rotateRight, jArr2);
            i += 64;
            int i2 = length - 64;
            if (i2 == 0) {
