...
import com.google.android.gms.b.fo.a.a;
...
public class fm<K, V> extends fo<K, V> {
    private final K[] a;
    private final V[] b;
    private final Comparator<K> c;

    public fm(Comparator<K> comparator) {
        this.a = new Object[0];
        this.b = new Object[0];
        this.c = comparator;
    }

    private fm(Comparator<K> comparator, K[] kArr, V[] vArr) {
        this.a = kArr;
        this.b = vArr;
        this.c = comparator;
    }

    public static <A, B, C> fm<A, C> a(List<A> list, Map<B, C> map, a<A, B> aVar, Comparator<A> comparator) {
        ...
        return new fm(comparator, objArr, objArr2);
    }

    public static <K, V> fm<K, V> a(Map<K, V> map, Comparator<K> comparator) {
        return a(new ArrayList(map.keySet()), map, fo.a.a(), comparator);
    }
    ...
    public fo<K, V> a(K k, V v) {
        ...
        if (f != -1) {
            ...
            return new fm(this.c, b(this.a, f, k), b(this.b, f, v));
            ...
            hashMap.put(k, v);
            return fw.a(hashMap, this.c);
        } else {
            f = e(k);
            return new fm(this.c, a(this.a, f, k), a(this.b, f, v));
        }
    }
    ...
    public fo<K, V> c(K k) {
        ...
        return new fm(this.c, a(this.a, f), a(this.b, f));
    }
