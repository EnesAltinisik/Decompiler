...
public class abh implements ov {
    protected static final boolean a = abg.b;
    private static int d = 3000;
    private static int e = 4096;
    protected final abm b;
    protected final abi c;

    public abh(abm com_google_android_gms_b_abm) {
        this(com_google_android_gms_b_abm, new abi(e));
    }

    public abh(abm com_google_android_gms_b_abm, abi com_google_android_gms_b_abi) {
        this.b = com_google_android_gms_b_abm;
        this.c = com_google_android_gms_b_abi;
    }
    ...
    private void a(long j, tv<?> tvVar, byte[] bArr, StatusLine statusLine) {
        if (a || j > ((long) d)) {
            ...
            objArr[4] = Integer.valueOf(tvVar.o().b());
            abg.b(str, objArr);
        }
    }

    private static void a(String str, tv<?> tvVar, abb com_google_android_gms_b_abb) {
        xy o = tvVar.o();
        int n = tvVar.n();
        try {
            o.a(com_google_android_gms_b_abb);
            tvVar.b(String.format("%s-retry [timeout=%s]", new Object[]{str, Integer.valueOf(n)}));
        } catch (abb e) {
            tvVar.b(String.format("%s-timeout-giveup [timeout=%s]", new Object[]{str, Integer.valueOf(n)}));
            throw e;
        }
    }
    ...
    private byte[] a(HttpEntity httpEntity) {
        ...
        try {
            ...
            try {
                ...
                abg.a("Error occured when calling consumingContent", new Object[0]);
            }
            this.c.a(bArr);
            bVar.close();
        }
    ...
    public com.google.android.gms.b.rt a(com.google.android.gms.b.tv<?> r19) {
        /*
        r18 = this;
    ...
    L_0x003c:
        r3 = new com.google.android.gms.b.rt;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x013b }
    ...
    L_0x004c:
        ...
        r7 = new com.google.android.gms.b.rt;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x013b }
    ...
    L_0x0090:
        r2 = move-exception;
        r2 = "socket";
        r3 = new com.google.android.gms.b.aaa;
        r3.<init>();
        r0 = r19;
        a(r2, r0, r3);
        goto L_0x0004;
    L_0x009f:
        ...
        goto L_0x0075;
    L_0x00a3:
        r3 = new com.google.android.gms.b.rt;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x013f }
        r7 = 0;
    ...
    L_0x00e6:
        ...
        r8 = r19.c();
        r3[r7] = r8;
        com.google.android.gms.b.abg.c(r2, r3);
        if (r5 == 0) goto L_0x0134;
    L_0x0106:
        r3 = new com.google.android.gms.b.rt;
        r7 = 0;
    ...
    L_0x011a:
        ...
        goto L_0x0004;
    L_0x0128:
        r3 = new com.google.android.gms.b.su;
        r3.<init>(r2);
        throw r3;
    L_0x012e:
        r2 = new com.google.android.gms.b.yz;
        r2.<init>(r3);
        throw r2;
    L_0x0134:
        r2 = new com.google.android.gms.b.qv;
        r3 = 0;
        r2.<init>(r3);
        throw r2;
    L_0x013b:
    ...
    L_0x013f:
        ...
        goto L_0x00e4;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.b.abh.a(com.google.android.gms.b.tv):com.google.android.gms.b.rt");
    }
}
