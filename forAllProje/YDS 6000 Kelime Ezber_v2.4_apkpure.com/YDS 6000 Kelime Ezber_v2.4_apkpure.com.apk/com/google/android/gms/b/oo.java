...
public interface oo extends IInterface {
    ...
    public static abstract class a extends Binder implements oo {
        ...
        public static oo a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof oo)) ? new a(iBinder) : (oo) queryLocalInterface;
        }
