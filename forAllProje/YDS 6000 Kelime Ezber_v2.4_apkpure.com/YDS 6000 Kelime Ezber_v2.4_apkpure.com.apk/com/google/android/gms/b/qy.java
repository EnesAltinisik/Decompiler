...
public interface qy extends IInterface {
    ...
    public static abstract class a extends Binder implements qy {

        private static class a implements qy {
            private IBinder a;
        ...
        public static qy a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof qy)) ? new a(iBinder) : (qy) queryLocalInterface;
        }
