...
public class nb {
    ...
    static String a(String[] strArr, int i, int i2) {
        if (strArr.length < i + i2) {
            zy.c("Unable to construct shingle");
            return "";
        }
    ...
    public static void a(String[] strArr, int i, int i2, PriorityQueue<a> priorityQueue) {
        ...
        while (i4 < (strArr.length - i2) + 1) {
            long a2 = a(mz.a(strArr[i4 - 1]), mz.a(strArr[(i4 + i2) - 1]), b, a, 16785407);
    ...
    private static long b(String[] strArr, int i, int i2) {
        long a = (((long) mz.a(strArr[i])) + 2147483647L) % 1073807359;
        for (int i3 = i + 1; i3 < i + i2; i3++) {
            a = (((a * 16785407) % 1073807359) + ((((long) mz.a(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return a;
    }
}
