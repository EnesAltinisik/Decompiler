...
public interface rh extends IInterface {
    ...
    public static abstract class a extends Binder implements rh {

        private static class a implements rh {
            private IBinder a;
        ...
        public static rh a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof rh)) ? new a(iBinder) : (rh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(com.google.android.gms.b.rd.a.a(parcel.readStrongBinder()));
