...
public class hm {
    ...
    public static void a(gx gxVar, Object obj) {
        new hm(gxVar).a(obj);
    }
    ...
    private void b() {
        if (this.b > 768) {
            ...
            throw new c(new StringBuilder(String.valueOf(valueOf).length() + 13).append(valueOf).append(this.b).append(").").toString());
            ...
            throw new c(valueOf3.length() != 0 ? valueOf2.concat(valueOf3) : new String(valueOf2));
        }
    }
