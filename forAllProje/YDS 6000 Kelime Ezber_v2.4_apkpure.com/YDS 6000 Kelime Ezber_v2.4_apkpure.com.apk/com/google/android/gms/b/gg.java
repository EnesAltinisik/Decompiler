...
public class gg implements com.google.android.gms.b.fz.a, gf {
    static final /* synthetic */ boolean a = (!gg.class.desiredAssertionStatus());
    private static long b = 0;
    private ScheduledFuture<?> A = null;
    private long B;
    private boolean C;
    private final com.google.android.gms.b.gf.a c;
    private final gd d;
    private String e;
    ...
    private static class c {
        ...
        public String toString() {
            String valueOf = String.valueOf(gc.a(this.a));
    ...
    private static class d {
        ...
        private d(String str, List<String> list, Object obj, gi giVar) {
            this.a = str;
            this.b = list;
            this.c = obj;
            this.d = giVar;
    ...
    private static class e {
        ...
        private e(gi giVar, c cVar, Long l, ge geVar) {
            this.a = giVar;
            this.b = cVar;
            this.c = geVar;
            this.d = l;
    ...
    private static class f {
        ...
        private f(String str, Map<String, Object> map, gi giVar) {
            this.a = str;
            this.b = map;
            this.c = giVar;
        }
    ...
    public gg(gb gbVar, gd gdVar, com.google.android.gms.b.gf.a aVar) {
        this.c = aVar;
        this.s = gbVar;
        this.u = gbVar.c();
        this.t = gbVar.b();
        ...
        this.w = new com.google.android.gms.b.gk.a(this.u, gbVar.a(), "ConnectionRetryHelper").a(1000).a(1.3d).b(30000).b(0.7d).a();
        long j = b;
        b = 1 + j;
        this.v = new jb(gbVar.a(), "PersistentConnection", "pc_" + j);
        this.x = null;
        q();
    }
    ...
    private e a(c cVar) {
        if (this.v.a()) {
            ...
            jbVar.a(new StringBuilder(String.valueOf(valueOf).length() + 15).append("removing query ").append(valueOf).toString(), new Object[0]);
        }
        ...
        if (this.v.a()) {
            ...
            jbVar.a(new StringBuilder(String.valueOf(valueOf).length() + 64).append("Trying to remove listener for QuerySpec ").append(valueOf).append(" but no listener exists.").toString(), new Object[0]);
        }
        return null;
    }
    ...
    private Collection<e> a(List<String> list) {
        if (this.v.a()) {
            ...
            jbVar.a(new StringBuilder(String.valueOf(valueOf).length() + 29).append("removing all listens at path ").append(valueOf).toString(), new Object[0]);
        }
    ...
    private void a(String str, List<String> list, Object obj, final gi giVar) {
        Map hashMap = new HashMap();
        hashMap.put("p", gc.a((List) list));
        hashMap.put("d", obj);
    ...
    private void a(String str, List<String> list, Object obj, String str2, gi giVar) {
        Map a = a((List) list, obj, str2);
        long j = this.k;
        this.k = 1 + j;
        this.o.put(Long.valueOf(j), new f(str, a, giVar));
        if (g()) {
            b(j);
        }
    ...
    private void a(String str, Map<String, Object> map) {
        if (this.v.a()) {
            ...
            jbVar.a(new StringBuilder((String.valueOf(str).length() + 22) + String.valueOf(valueOf).length()).append("handleServerMessage: ").append(str).append(" ").append(valueOf).toString(), new Object[0]);
        }
        String str2;
        jb jbVar2;
        String str3;
        if (str.equals("d") || str.equals("m")) {
            ...
            Long a = gc.a(map.get("t"));
            if (!equals || !(obj instanceof Map) || ((Map) obj).size() != 0) {
                this.c.a(gc.a(str2), obj, equals, a);
            } else if (this.v.a()) {
                jbVar2 = this.v;
                str3 = "ignoring empty merge for path ";
                str2 = String.valueOf(str2);
                jbVar2.a(str2.length() != 0 ? str3.concat(str2) : new String(str3), new Object[0]);
            }
        } else if (str.equals("rm")) {
            str2 = (String) map.get("p");
            List a2 = gc.a(str2);
            Object obj2 = map.get("d");
            Long a3 = gc.a(map.get("t"));
            List<Map> list = (List) obj2;
            List arrayList = new ArrayList();
            for (Map map2 : list) {
                str3 = (String) map2.get("s");
                String str4 = (String) map2.get("e");
                arrayList.add(new gh(str3 != null ? gc.a(str3) : null, str4 != null ? gc.a(str4) : null, map2.get("m")));
            }
    ...
    private void a(List<String> list, c cVar) {
        if (list.contains("no_index")) {
            ...
            jb jbVar = this.v;
            String valueOf2 = String.valueOf(gc.a(cVar.a));
            jbVar.a(new StringBuilder((String.valueOf(valueOf).length() + 118) + String.valueOf(valueOf2).length()).append("Using an unspecified index. Consider adding '").append(valueOf).append("' at ").append(valueOf2).append(" to your security and Firebase Database rules for better performance").toString());
        }
    }

    private void a(final boolean z) {
        gc.a(f(), "Must be connected to send auth, but was: %s", this.j);
        gc.a(this.q != null, "Auth token must be set to authenticate!", new Object[0]);
    ...
    private void h() {
        if (e()) {
            gc.a(this.j == b.Disconnected, "Not in disconnected state: %s", this.j);
            ...
            this.w.a(new Runnable(this) {
                ...
                public void run() {
                    ...
                    gc.a(this.b.j == b.Disconnected, "Not in disconnected state: %s", this.b.j);
                    this.b.j = b.GettingToken;
                    this.b.y = 1 + this.b.y;
                    final long d = this.b.y;
                    this.b.t.a(z, new com.google.android.gms.b.ga.a(this) {
                        ...
                        public void a(String str) {
                            if (d != this.b.b.y) {
                                ...
                                gc.a(this.b.b.j == b.Disconnected, "Expected connection state disconnected, but was %s", this.b.b.j);
    ...
    private void l() {
        gc.a(f(), "Must be connected to send unauth.", new Object[0]);
        gc.a(this.q == null, "Auth token must not be set.", new Object[0]);
    ...
    private void m() {
        ...
        gc.a(this.j == b.Connecting, "Wanted to restore auth, but was in wrong state: %s", this.j);
        if (this.q == null) {
            if (this.v.a()) {
    ...
    private void n() {
        gc.a(this.j == b.Connected, "Should be connected if we're restoring state, but we are: %s", this.j);
        if (this.v.a()) {
        ...
        for (e eVar : this.p.values()) {
            if (this.v.a()) {
                ...
                jbVar.a(new StringBuilder(String.valueOf(valueOf).length() + 17).append("Restoring listen ").append(valueOf).toString(), new Object[0]);
            }
            b(eVar);
        }
        if (this.v.a()) {
    ...
    private void o() {
        ...
        if (ki.a()) {
            ...
            str = "sdk.android.";
            valueOf = String.valueOf(this.s.e().replace('.', '-'));
    ...
    public void a(com.google.android.gms.b.fz.b bVar) {
        if (this.v.a()) {
            jb jbVar = this.v;
        ...
        if (e()) {
            ...
            if (bVar == com.google.android.gms.b.fz.b.SERVER_RESET || r0) {
                this.w.a();
            }
            h();
        }
    ...
    public void a(List<String> list, gi giVar) {
        if (g()) {
            a("oc", (List) list, null, giVar);
        } else {
            this.n.add(new d("oc", list, null, giVar));
        }
        q();
    }

    public void a(List<String> list, Object obj, gi giVar) {
        a("p", (List) list, obj, null, giVar);
    }

    public void a(List<String> list, Object obj, String str, gi giVar) {
        a("p", (List) list, obj, str, giVar);
    }
    ...
    public void a(List<String> list, Map<String, Object> map) {
        ...
        if (this.v.a()) {
            jb jbVar = this.v;
            String valueOf = String.valueOf(cVar);
            jbVar.a(new StringBuilder(String.valueOf(valueOf).length() + 15).append("unlistening on ").append(valueOf).toString(), new Object[0]);
        }
        e a = a(cVar);
        if (a != null && f()) {
            a(a);
    ...
    public void a(List<String> list, Map<String, Object> map, ge geVar, Long l, gi giVar) {
        c cVar = new c(list, map);
        if (this.v.a()) {
            jb jbVar = this.v;
            String valueOf = String.valueOf(cVar);
            jbVar.a(new StringBuilder(String.valueOf(valueOf).length() + 13).append("Listening on ").append(valueOf).toString(), new Object[0]);
        }
        gc.a(!this.p.containsKey(cVar), "listen() called twice for same QuerySpec.", new Object[0]);
        if (this.v.a()) {
            jbVar = this.v;
            valueOf = String.valueOf(cVar);
            jbVar.a(new StringBuilder(String.valueOf(valueOf).length() + 21).append("Adding listen query: ").append(valueOf).toString(), new Object[0]);
        }
        e eVar = new e(giVar, cVar, l, geVar);
    ...
    public void a(List<String> list, Map<String, Object> map, gi giVar) {
        a("m", (List) list, (Object) map, null, giVar);
    }
    ...
    public void a(Map<String, Object> map) {
        if (map.containsKey("r")) {
            ...
            if (map.containsKey("a")) {
                ...
                jb jbVar = this.v;
                String valueOf = String.valueOf(map);
                jbVar.a(new StringBuilder(String.valueOf(valueOf).length() + 26).append("Ignoring unknown message: ").append(valueOf).toString(), new Object[0]);
            }
        }
    }
    ...
    public void b(String str) {
        if (this.v.a()) {
            ...
            String valueOf = String.valueOf(str);
            jbVar.a(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2), new Object[0]);
        }
        d("server_kill");
    }
    ...
    public void b(List<String> list, Object obj, gi giVar) {
        this.C = true;
        if (g()) {
            a("o", (List) list, obj, giVar);
        } else {
            this.n.add(new d("o", list, obj, giVar));
        }
        q();
    }
    ...
    public void b(List<String> list, Map<String, Object> map, gi giVar) {
        this.C = true;
        if (g()) {
            a("om", (List) list, (Object) map, giVar);
        } else {
            this.n.add(new d("om", list, map, giVar));
        }
        q();
    }
    ...
    public void g(String str) {
        gc.a(this.j == b.GettingToken, "Trying to open network connection while in the wrong state: %s", this.j);
        if (str == null) {
            this.c.a(false);
        }
        this.q = str;
        this.j = b.Connecting;
        this.i = new fz(this.s, this.d, this.e, this, this.x);
        this.i.a();
    }
}
