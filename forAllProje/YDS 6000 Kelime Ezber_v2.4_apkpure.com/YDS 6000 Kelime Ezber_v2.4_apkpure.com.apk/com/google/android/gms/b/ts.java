...
public interface ts extends IInterface {
    ...
    public static abstract class a extends Binder implements ts {

        private static class a implements ts {
            private IBinder a;
        ...
        public static ts a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ts)) ? new a(iBinder) : (ts) queryLocalInterface;
        }
