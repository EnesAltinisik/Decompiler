...
public final class te {
    ...
    public te(String str) {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            td tdVar = new td(jSONArray.getJSONObject(i2));
            arrayList.add(tdVar);
            if (i < 0 && a(tdVar)) {
                i = i2;
            }
        ...
        if (optJSONObject != null) {
            ...
            yj a = yj.a(optJSONObject.optJSONArray("rewards"));
            if (a == null) {
                this.j = null;
                this.k = 0;
            } else {
    ...
    public te(List<td> list, long j, List<String> list2, List<String> list3, List<String> list4, List<String> list5, boolean z, String str, long j2, int i, int i2, String str2, int i3, int i4, long j3, boolean z2) {
        this.a = list;
        this.b = j;
        this.c = list2;
        this.d = list3;
