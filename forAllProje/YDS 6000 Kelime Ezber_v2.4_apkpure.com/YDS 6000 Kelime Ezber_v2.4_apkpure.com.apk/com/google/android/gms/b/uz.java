...
public interface uz extends IInterface {
    ...
    public static abstract class a extends Binder implements uz {
        ...
        public static uz a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof uz)) ? new a(iBinder) : (uz) queryLocalInterface;
        }
