...
public interface qu extends IInterface {
    ...
    public static abstract class a extends Binder implements qu {

        private static class a implements qu {
            private IBinder a;
        ...
        public static qu a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.formats.client.INativeAdImage");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof qu)) ? new a(iBinder) : (qu) queryLocalInterface;
        }
