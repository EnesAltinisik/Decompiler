...
public interface abv extends IInterface {
    ...
    public static abstract class a extends Binder implements abv {

        private static class a implements abv {
            private IBinder a;
        ...
        public static abv a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof abv)) ? new a(iBinder) : (abv) queryLocalInterface;
        }
