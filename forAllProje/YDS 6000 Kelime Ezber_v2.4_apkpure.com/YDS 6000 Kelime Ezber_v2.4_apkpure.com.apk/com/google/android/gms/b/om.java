...
public interface om extends IInterface {
    ...
    public static abstract class a extends Binder implements om {

        private static class a implements om {
            private IBinder a;
        ...
        public static om a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof om)) ? new a(iBinder) : (om) queryLocalInterface;
        }
