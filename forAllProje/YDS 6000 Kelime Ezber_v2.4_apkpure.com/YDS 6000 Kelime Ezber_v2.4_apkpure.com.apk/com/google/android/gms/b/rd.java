...
public interface rd extends IInterface {
    ...
    public static abstract class a extends Binder implements rd {
        ...
        private static class a implements rd {
            private IBinder a;
        ...
        public static rd a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof rd)) ? new a(iBinder) : (rd) queryLocalInterface;
        }
