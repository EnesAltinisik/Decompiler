...
public abstract class a<T> {
    ...
    public static class a extends a<Boolean> {
        ...
        public static Boolean a(SharedPreferences sharedPreferences, String str, Boolean bool) {
            return (Boolean) bi.a(new AnonymousClass1(sharedPreferences, str, bool));
        }
    }
    ...
    public static class b extends a<Integer> {
        ...
        public static Integer a(SharedPreferences sharedPreferences, String str, Integer num) {
            return (Integer) bi.a(new AnonymousClass1(sharedPreferences, str, num));
        }
    }
    ...
    public static class c extends a<Long> {
        ...
        public static Long a(SharedPreferences sharedPreferences, String str, Long l) {
            return (Long) bi.a(new AnonymousClass1(sharedPreferences, str, l));
        }
    }
    ...
    public static class d extends a<String> {
        ...
        public static String a(SharedPreferences sharedPreferences, String str, String str2) {
            return (String) bi.a(new AnonymousClass1(sharedPreferences, str, str2));
        }
    }
}
