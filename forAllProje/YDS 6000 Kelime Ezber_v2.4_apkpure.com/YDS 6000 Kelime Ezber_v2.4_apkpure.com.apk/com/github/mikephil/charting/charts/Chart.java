...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    public boolean saveToGallery(String str, String str2, String str3, CompressFormat compressFormat, int i) {
        ...
        try {
            ...
            return getContext().getContentResolver().insert(Media.EXTERNAL_CONTENT_URI, contentValues) != null;
        } catch (IOException e) {
            e.printStackTrace();
            return false;
        }
    ...
    public boolean saveToPath(String str, String str2) {
        ...
        try {
            OutputStream fileOutputStream = new FileOutputStream(Environment.getExternalStorageDirectory().getPath() + str2 + "/" + str + ".png");
    ...
    protected void setupDefaultFormatter(float f, float f2) {
        float max = (this.mData == null || this.mData.getEntryCount() < 2) ? Math.max(Math.abs(f), Math.abs(f2)) : Math.abs(f2 - f);
