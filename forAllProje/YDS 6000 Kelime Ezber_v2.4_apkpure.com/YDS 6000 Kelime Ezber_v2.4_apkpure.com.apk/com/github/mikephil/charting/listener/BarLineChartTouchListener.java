        ...
        if (motionEvent.getPointerCount() >= 2) {
            ...
            if (spacing > this.mMinScalePointerDistance) {
                ...
                if (this.mTouchMode == 4) {
                    ...
                    boolean canZoomOutMoreX = obj != null ? viewPortHandler.canZoomOutMoreX() : viewPortHandler.canZoomInMoreX();
                    boolean canZoomOutMoreY = obj != null ? viewPortHandler.canZoomOutMoreY() : viewPortHandler.canZoomInMoreY();
                    float f = ((BarLineChartBase) this.mChart).isScaleXEnabled() ? spacing : 1.0f;
                    ...
                    if (obj != null ? viewPortHandler.canZoomOutMoreX() : viewPortHandler.canZoomInMoreX()) {
                        this.mMatrix.set(this.mSavedMatrix);
                    ...
                    if (((spacing > 1.0f ? 1 : (spacing == 1.0f ? 0 : -1)) < 0 ? 1 : null) != null ? viewPortHandler.canZoomOutMoreY() : viewPortHandler.canZoomInMoreY()) {
                        this.mMatrix.set(this.mSavedMatrix);
