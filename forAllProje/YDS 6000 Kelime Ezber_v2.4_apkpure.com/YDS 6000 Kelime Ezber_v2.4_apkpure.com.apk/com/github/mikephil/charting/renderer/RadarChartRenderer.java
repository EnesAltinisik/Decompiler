            ...
            if (iRadarDataSet != null && iRadarDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(radarEntry, iRadarDataSet)) {
                    ...
                    if (!(!iRadarDataSet.isDrawHighlightCircleEnabled() || Float.isNaN(instance.x) || Float.isNaN(instance.y))) {
                        ...
                        drawHighlightCircle(canvas, instance, iRadarDataSet.getHighlightCircleInnerRadius(), iRadarDataSet.getHighlightCircleOuterRadius(), iRadarDataSet.getHighlightCircleFillColor(), iRadarDataSet.getHighlightCircleStrokeAlpha() < 255 ? ColorTemplate.colorWithAlpha(highlightCircleStrokeColor, iRadarDataSet.getHighlightCircleStrokeAlpha()) : highlightCircleStrokeColor, iRadarDataSet.getHighlightCircleStrokeWidth());
                    }
                }
            }
        }
