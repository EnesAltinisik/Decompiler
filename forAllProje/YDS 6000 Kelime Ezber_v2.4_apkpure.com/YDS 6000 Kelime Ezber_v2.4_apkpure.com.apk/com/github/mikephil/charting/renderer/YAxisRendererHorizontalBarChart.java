...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            convertDpToPixel = axisDependency == AxisDependency.LEFT ? labelPosition == YAxisLabelPosition.OUTSIDE_CHART ? this.mViewPortHandler.contentTop() - convertDpToPixel : this.mViewPortHandler.contentTop() - convertDpToPixel : labelPosition == YAxisLabelPosition.OUTSIDE_CHART ? convertDpToPixel + (calcTextHeight + this.mViewPortHandler.contentBottom()) : convertDpToPixel + (calcTextHeight + this.mViewPortHandler.contentBottom());
