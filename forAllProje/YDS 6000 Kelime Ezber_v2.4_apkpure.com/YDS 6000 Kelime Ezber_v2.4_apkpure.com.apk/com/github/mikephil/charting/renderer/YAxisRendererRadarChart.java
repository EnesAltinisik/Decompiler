...
public class YAxisRendererRadarChart extends YAxisRenderer {
    ...
    protected void computeAxisValues(float f, float f2) {
        ...
        if (this.mAxis.isForceLabelsEnabled()) {
            ...
            roundToNextSignificant2 = roundToNextSignificant == 0.0d ? 0.0d : Math.ceil(((double) f) / roundToNextSignificant) * roundToNextSignificant;
            if (isCenterAxisLabelsEnabled) {
                roundToNextSignificant2 -= roundToNextSignificant;
            }
            double nextUp = roundToNextSignificant == 0.0d ? 0.0d : Utils.nextUp(Math.floor(((double) f2) / roundToNextSignificant) * roundToNextSignificant);
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            int i2 = 0;
            while (i2 < i && (i2 != i - 1 || this.mYAxis.isDrawTopYLabelEntryEnabled())) {
