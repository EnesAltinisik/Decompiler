...
public class PieChartRenderer extends DataRenderer {
    ...
    protected float calculateMinimumRadiusForSpacedSlice(MPPointF mPPointF, float f, float f2, float f3, float f4, float f5, float f6) {
        float f7 = (f6 / 2.0f) + f5;
        float cos = mPPointF.x + (((float) Math.cos((double) ((f5 + f6) * Utils.FDEG2RAD))) * f);
        float sin = mPPointF.y + (((float) Math.sin((double) ((f5 + f6) * Utils.FDEG2RAD))) * f);
        float cos2 = mPPointF.x + (((float) Math.cos((double) (Utils.FDEG2RAD * f7))) * f);
        f7 = (((float) Math.sin((double) (f7 * Utils.FDEG2RAD))) * f) + mPPointF.y;
        return (float) (((double) (f - ((float) ((Math.sqrt(Math.pow((double) (cos - f3), 2.0d) + Math.pow((double) (sin - f4), 2.0d)) / 2.0d) * Math.tan(((180.0d - ((double) f2)) / 2.0d) * Utils.DEG2RAD))))) - Math.sqrt(Math.pow((double) (f7 - ((sin + f4) / 2.0f)), 2.0d) + Math.pow((double) (cos2 - ((cos + f3) / 2.0f)), 2.0d)));
    }
    ...
    protected void drawDataSet(Canvas canvas, IPieDataSet iPieDataSet) {
        ...
        int i2 = 0;
        while (i2 < entryCount) {
            int i3 = Math.abs(((PieEntry) iPieDataSet.getEntryForIndex(i2)).getY()) > Utils.FLOAT_EPSILON ? i + 1 : i;
            i2++;
            i = i3;
        }
        ...
        while (i4 < entryCount) {
            ...
            if (Math.abs(iPieDataSet.getEntryForIndex(i4).getY()) > Utils.FLOAT_EPSILON && !this.mChart.needsHighlight(i4)) {
                ...
                float f3 = i == 1 ? 0.0f : sliceSpace / (Utils.FDEG2RAD * radius);
                float f4 = rotationAngle + (((f3 / 2.0f) + f) * phaseY);
                float f5 = (f2 - f3) * phaseY;
                if (f5 < 0.0f) {
                    f5 = 0.0f;
                }
                this.mPathBuffer.reset();
                float cos = (((float) Math.cos((double) (Utils.FDEG2RAD * f4))) * radius) + centerCircleBox.x;
                float sin = (((float) Math.sin((double) (Utils.FDEG2RAD * f4))) * radius) + centerCircleBox.y;
                if (f5 < 360.0f || f5 % 360.0f > Utils.FLOAT_EPSILON) {
                    this.mPathBuffer.moveTo(cos, sin);
                    this.mPathBuffer.arcTo(circleBox, f4, f5);
                } else {
                ...
                if (obj != null && (holeRadius > 0.0f || obj2 != null)) {
                    if (obj2 != null) {
                        calculateMinimumRadiusForSpacedSlice = calculateMinimumRadiusForSpacedSlice(centerCircleBox, radius, f2 * phaseY, cos, sin, f4, f5);
                        if (calculateMinimumRadiusForSpacedSlice < 0.0f) {
                            calculateMinimumRadiusForSpacedSlice = -calculateMinimumRadiusForSpacedSlice;
                        }
                        f3 = Math.max(holeRadius, calculateMinimumRadiusForSpacedSlice);
                    } else {
                        f3 = holeRadius;
                    }
                    calculateMinimumRadiusForSpacedSlice = (i == 1 || f3 == 0.0f) ? 0.0f : sliceSpace / (Utils.FDEG2RAD * f3);
                    cos = (((calculateMinimumRadiusForSpacedSlice / 2.0f) + f) * phaseY) + rotationAngle;
                    calculateMinimumRadiusForSpacedSlice = (f2 - calculateMinimumRadiusForSpacedSlice) * phaseY;
                    if (calculateMinimumRadiusForSpacedSlice < 0.0f) {
                        calculateMinimumRadiusForSpacedSlice = 0.0f;
                    }
                    cos += calculateMinimumRadiusForSpacedSlice;
                    if (f5 < 360.0f || f5 % 360.0f > Utils.FLOAT_EPSILON) {
                        this.mPathBuffer.lineTo(centerCircleBox.x + (((float) Math.cos((double) (Utils.FDEG2RAD * cos))) * f3), (f3 * ((float) Math.sin((double) (Utils.FDEG2RAD * cos)))) + centerCircleBox.y);
                        this.mPathBuffer.arcTo(this.mInnerRectBuffer, cos, -calculateMinimumRadiusForSpacedSlice);
                    } else {
                        this.mPathBuffer.addCircle(centerCircleBox.x, centerCircleBox.y, f3, Direction.CCW);
                    }
                } else if (f5 % 360.0f > Utils.FLOAT_EPSILON) {
                    if (obj2 != null) {
                        float f6 = f4 + (f5 / 2.0f);
                        calculateMinimumRadiusForSpacedSlice = calculateMinimumRadiusForSpacedSlice(centerCircleBox, radius, f2 * phaseY, cos, sin, f4, f5);
                        this.mPathBuffer.lineTo(centerCircleBox.x + (((float) Math.cos((double) (Utils.FDEG2RAD * f6))) * calculateMinimumRadiusForSpacedSlice), (calculateMinimumRadiusForSpacedSlice * ((float) Math.sin((double) (Utils.FDEG2RAD * f6)))) + centerCircleBox.y);
                    } else {
        ...
        for (int i = 0; i < highlightArr.length; i++) {
            ...
            if (x < drawAngles.length) {
                ...
                if (dataSetByIndex != null && dataSetByIndex.isHighlightEnabled()) {
                    ...
                    int i3 = 0;
                    while (i3 < entryCount) {
                        int i4 = Math.abs(((PieEntry) dataSetByIndex.getEntryForIndex(i3)).getY()) > Utils.FLOAT_EPSILON ? i2 + 1 : i2;
                        i3++;
                        i2 = i4;
                    }
                    float f = x == 0 ? 0.0f : absoluteAngles[x - 1] * phaseX;
                    ...
                    float f4 = i2 == 1 ? 0.0f : sliceSpace / (Utils.FDEG2RAD * radius);
                    selectionShift = i2 == 1 ? 0.0f : sliceSpace / (Utils.FDEG2RAD * f3);
                    ...
                    if (f6 < 360.0f || f6 % 360.0f > Utils.FLOAT_EPSILON) {
                        this.mPathBuffer.moveTo(centerCircleBox.x + (((float) Math.cos((double) (Utils.FDEG2RAD * f4))) * f3), (f3 * ((float) Math.sin((double) (Utils.FDEG2RAD * f4)))) + centerCircleBox.y);
                    ...
                    selectionShift = 0.0f;
                    if (obj2 != null) {
                        selectionShift = calculateMinimumRadiusForSpacedSlice(centerCircleBox, radius, f2 * phaseY, (((float) Math.cos((double) (Utils.FDEG2RAD * f5))) * radius) + centerCircleBox.x, (((float) Math.sin((double) (Utils.FDEG2RAD * f5))) * radius) + centerCircleBox.y, f5, f6);
                    }
                    this.mInnerRectBuffer.set(centerCircleBox.x - holeRadius, centerCircleBox.y - holeRadius, centerCircleBox.x + holeRadius, centerCircleBox.y + holeRadius);
                    if (obj != null && (holeRadius > 0.0f || obj2 != null)) {
                        if (obj2 != null) {
                        ...
                        selectionShift = (i2 == 1 || f4 == 0.0f) ? 0.0f : sliceSpace / (Utils.FDEG2RAD * f4);
                        ...
                        f7 += selectionShift;
                        if (f6 < 360.0f || f6 % 360.0f > Utils.FLOAT_EPSILON) {
                            this.mPathBuffer.lineTo(centerCircleBox.x + (((float) Math.cos((double) (Utils.FDEG2RAD * f7))) * f4), (f4 * ((float) Math.sin((double) (Utils.FDEG2RAD * f7)))) + centerCircleBox.y);
                        ...
                        if (obj2 != null) {
                            f4 = (f6 / 2.0f) + f5;
                            this.mPathBuffer.lineTo(centerCircleBox.x + (((float) Math.cos((double) (Utils.FDEG2RAD * f4))) * selectionShift), (selectionShift * ((float) Math.sin((double) (f4 * Utils.FDEG2RAD)))) + centerCircleBox.y);
                        } else {
                            this.mPathBuffer.lineTo(centerCircleBox.x, centerCircleBox.y);
                        }
                    }
        ...
        for (int i2 = 0; i2 < dataSets.size(); i2++) {
            ...
            if (isDrawValuesEnabled || isDrawEntryLabelsEnabled) {
                ...
                for (int i4 = 0; i4 < entryCount; i4++) {
                    ...
                    float f3 = rotationAngle + (((i3 == 0 ? 0.0f : absoluteAngles[i3 - 1] * phaseX) + ((drawAngles[i3] - ((sliceSpace / (Utils.FDEG2RAD * f2)) / 2.0f)) / 2.0f)) * phaseY);
                    float y = this.mChart.isUsePercentValuesEnabled() ? (entry.getY() / yValueSum) * 100.0f : entry.getY();
                    float cos = (float) Math.cos((double) (Utils.FDEG2RAD * f3));
                    float sin = (float) Math.sin((double) (Utils.FDEG2RAD * f3));
                    Object obj = (isDrawEntryLabelsEnabled && xValuePosition == ValuePosition.OUTSIDE_SLICE) ? 1 : null;
                    Object obj2 = (isDrawValuesEnabled && yValuePosition == ValuePosition.OUTSIDE_SLICE) ? 1 : null;
                    Object obj3 = (isDrawEntryLabelsEnabled && xValuePosition == ValuePosition.INSIDE_SLICE) ? 1 : null;
                    Object obj4 = (isDrawValuesEnabled && yValuePosition == ValuePosition.INSIDE_SLICE) ? 1 : null;
                    if (!(obj == null && obj2 == null)) {
                        ...
                        f = this.mChart.isDrawHoleEnabled() ? (f * (radius - (radius * holeRadius))) + (radius * holeRadius) : f * radius;
                        float abs = iPieDataSet.isValueLineVariableLength() ? (valueLinePart2Length * f2) * ((float) Math.abs(Math.sin((double) (Utils.FDEG2RAD * f3)))) : valueLinePart2Length * f2;
    ...
    protected float getSliceSpace(IPieDataSet iPieDataSet) {
        return !iPieDataSet.isAutomaticallyDisableSliceSpacingEnabled() ? iPieDataSet.getSliceSpace() : iPieDataSet.getSliceSpace() / this.mViewPortHandler.getSmallestContentExtension() > (iPieDataSet.getYMin() / ((PieData) this.mChart.getData()).getYValueSum()) * 2.0f ? 0.0f : iPieDataSet.getSliceSpace();
    }
