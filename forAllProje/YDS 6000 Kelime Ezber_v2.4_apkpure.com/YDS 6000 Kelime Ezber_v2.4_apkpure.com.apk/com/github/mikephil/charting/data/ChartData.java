...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
    ...
    public float getYMax(AxisDependency axisDependency) {
        return axisDependency == AxisDependency.LEFT ? this.mLeftAxisMax == -3.4028235E38f ? this.mRightAxisMax : this.mLeftAxisMax : this.mRightAxisMax == -3.4028235E38f ? this.mLeftAxisMax : this.mRightAxisMax;
    }
    ...
    public float getYMin(AxisDependency axisDependency) {
        return axisDependency == AxisDependency.LEFT ? this.mLeftAxisMin == Float.MAX_VALUE ? this.mRightAxisMin : this.mLeftAxisMin : this.mRightAxisMin == Float.MAX_VALUE ? this.mLeftAxisMin : this.mRightAxisMin;
    }
    ...
    public boolean removeEntry(float f, int i) {
        ...
        return entryForXValue == null ? false : removeEntry(entryForXValue, i);
    }
