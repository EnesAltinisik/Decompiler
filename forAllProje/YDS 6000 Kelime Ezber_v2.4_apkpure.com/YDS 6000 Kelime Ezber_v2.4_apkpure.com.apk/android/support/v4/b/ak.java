...
class ak {
    ...
    public static void a(ag agVar, CharSequence charSequence, CharSequence charSequence2, List<CharSequence> list, List<Long> list2, List<CharSequence> list3, List<String> list4, List<Uri> list5) {
        ...
        conversationTitle.setBuilder(agVar.a());
    }
}
