...
public class m extends j {
    ...
    public void a(l lVar, Intent intent, int i, Bundle bundle) {
        ...
        if (i == -1) {
            ...
            h.a(i);
            a.a(this, intent, ((b(lVar) + 1) << 16) + (65535 & i), bundle);
            this.b = false;
        }
    }
    ...
    public boolean onCreatePanelMenu(int i, Menu menu) {
        ...
        return VERSION.SDK_INT >= 11 ? super.onCreatePanelMenu(i, menu) | this.d.a(menu, getMenuInflater()) : true;
    }
