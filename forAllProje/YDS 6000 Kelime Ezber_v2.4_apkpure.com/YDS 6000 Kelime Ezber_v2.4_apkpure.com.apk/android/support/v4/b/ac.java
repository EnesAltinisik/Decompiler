...
public final class ac {
    ...
    static class b implements a {
        ...
        public Intent a(Activity activity) {
            String b = ac.b(activity);
            if (b == null) {
                return null;
            }
            ComponentName componentName = new ComponentName(activity, b);
            try {
                return ac.b((Context) activity, componentName) == null ? g.a(componentName) : new Intent().setComponent(componentName);
    ...
    static class c extends b {
        ...
        public Intent a(Activity activity) {
            Intent a = ad.a(activity);
            return a == null ? b(activity) : a;
        }

        public String a(Context context, ActivityInfo activityInfo) {
            String a = ad.a(activityInfo);
    ...
    public static Intent a(Context context, ComponentName componentName) {
        ...
        return b(context, componentName2) == null ? g.a(componentName2) : new Intent().setComponent(componentName2);
    }
