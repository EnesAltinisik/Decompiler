...
public class SearchView extends ap implements android.support.v7.view.c {
    ...
    public static class SearchAutoComplete extends g {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            int a = android.support.v4.c.a.a.a(getResources());
    ...
    static class e extends android.support.v4.view.a {
        public static final Creator<e> CREATOR = android.support.v4.g.d.a(new android.support.v4.g.e<e>() {
    ...
    private void p() {
        ...
        if (this.h.getSuggestAuthority() != null) {
            this.g = new bf(getContext(), this, this.h, this.Q);
