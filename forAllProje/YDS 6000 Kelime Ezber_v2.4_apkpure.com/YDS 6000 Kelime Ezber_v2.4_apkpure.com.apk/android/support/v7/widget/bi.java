...
public class bi extends ContextWrapper {
    ...
    private static ArrayList<WeakReference<bi>> b;
    ...
    private bi(Context context) {
        ...
        this.c = new bk(this, context.getResources());
        this.d = null;
    }
    ...
    public static Context a(Context context) {
        ...
        synchronized (a) {
            ...
            if (b == null) {
                ...
                while (size >= 0) {
                    weakReference = (WeakReference) b.get(size);
                    context2 = weakReference != null ? (bi) weakReference.get() : null;
    ...
    private static boolean b(Context context) {
        return ((context instanceof bi) || (context.getResources() instanceof bk) || (context.getResources() instanceof bn)) ? false : VERSION.SDK_INT < 21 || bn.a();
    }
