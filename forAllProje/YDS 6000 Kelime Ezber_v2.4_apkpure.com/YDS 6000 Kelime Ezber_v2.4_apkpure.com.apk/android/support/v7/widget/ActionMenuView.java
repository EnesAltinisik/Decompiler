...
public class ActionMenuView extends ap implements android.support.v7.view.menu.h.b, p {
    ...
    private class b implements android.support.v7.view.menu.o.a {
    ...
    public static class c extends android.support.v7.widget.ap.a {
        @ExportedProperty
        public boolean a;
        @ExportedProperty
        public int b;
    ...
    private void c(int i, int i2) {
        ...
        while (i10 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                cVar.leftMargin = 0;
                cVar.rightMargin = 0;
                boolean z2 = z && ((ActionMenuItemView) childAt).a();
                cVar.e = z2;
    ...
    public /* synthetic */ android.support.v7.widget.ap.a b(AttributeSet attributeSet) {
        return a(attributeSet);
    }

    protected /* synthetic */ android.support.v7.widget.ap.a b(LayoutParams layoutParams) {
    ...
    public Menu getMenu() {
        if (this.c == null) {
            ...
            this.g.c(true);
            this.g.a(this.h != null ? this.h : new b(this));
    ...
    protected /* synthetic */ android.support.v7.widget.ap.a j() {
        return b();
    }
