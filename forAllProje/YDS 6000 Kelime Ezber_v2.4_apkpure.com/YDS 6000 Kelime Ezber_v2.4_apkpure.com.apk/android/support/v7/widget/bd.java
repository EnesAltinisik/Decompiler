...
public class bd extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class c extends ap implements OnLongClickListener {
        final /* synthetic */ bd a;
        ...
        public c(bd bdVar, Context context, android.support.v7.app.a.c cVar, boolean z) {
            this.a = bdVar;
            super(context, null, R.attr.actionBarTabStyle);
            this.c = cVar;
            bl a = bl.a(context, null, this.b, R.attr.actionBarTabStyle, 0);
            if (a.g(0)) {
        ...
        public void a() {
            ...
            if (a != null) {
                if (this.e == null) {
                    ...
                    LayoutParams aVar = new android.support.v7.widget.ap.a(-2, -2);
                    aVar.h = 16;
            ...
            if (z) {
                if (this.d == null) {
                    pVar = new z(getContext(), null, R.attr.actionBarTabTextStyle);
                    pVar.setEllipsize(TruncateAt.END);
                    aVar = new android.support.v7.widget.ap.a(-2, -2);
                    aVar.h = 16;
                    pVar.setLayoutParams(aVar);
                    addView(pVar);
                    this.d = pVar;
    ...
    private Spinner d() {
        Spinner wVar = new w(getContext(), null, R.attr.actionDropDownStyle);
        wVar.setLayoutParams(new android.support.v7.widget.ap.a(-2, -1));
