...
class d extends android.support.v7.view.menu.b implements android.support.v4.view.e.a {
    private b A;
    d g;
    e h;
    a i;
    ...
    private class d extends p implements android.support.v7.widget.ActionMenuView.a {
        ...
        public d(final d dVar, Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new am(this, this) {
                final /* synthetic */ d b;
        ...
        protected boolean setFrame(int i, int i2, int i3, int i4) {
            ...
            if (!(drawable == null || background == null)) {
                ...
                android.support.v4.d.a.a.a(background, width - max, height - max, width + max, height + max);
            }
            return frame;
        }
    }
    ...
    private class f implements android.support.v7.view.menu.o.a {
        ...
        public void a(h hVar, boolean z) {
            ...
            android.support.v7.view.menu.o.a d = this.a.d();
            if (d != null) {
                d.a(hVar, z);
            }
        }
    ...
    public void a(boolean z) {
        ...
        if (this.c != null) {
            ...
            int size = k.size();
            for (i = 0; i < size; i++) {
                android.support.v4.view.e a = ((j) k.get(i)).a();
                if (a != null) {
                    a.a((android.support.v4.view.e.a) this);
                }
            }
        }
        ...
        if (i3 != 0) {
            ...
            viewGroup = (ViewGroup) this.g.getParent();
            if (viewGroup != this.f) {
                if (viewGroup != null) {
