...
class r extends PopupWindow {
    ...
    private void a(Context context, AttributeSet attributeSet, int i, int i2) {
        bl a = bl.a(context, attributeSet, R.styleable.PopupWindow, i, i2);
        ...
        if (i2 != 0 && i3 < 11 && a.g(R.styleable.PopupWindow_android_popupAnimationStyle)) {
            setAnimationStyle(a.g(R.styleable.PopupWindow_android_popupAnimationStyle, -1));
        }
        a.a();
