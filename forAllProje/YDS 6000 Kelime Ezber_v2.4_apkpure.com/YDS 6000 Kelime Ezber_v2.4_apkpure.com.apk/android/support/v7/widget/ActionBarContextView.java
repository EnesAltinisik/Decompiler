...
public class ActionBarContextView extends a {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        bl a = bl.a(context, attributeSet, R.styleable.ActionMode, i, 0);
        ah.a((View) this, a.a(R.styleable.ActionMode_background));
    ...
    public /* bridge */ /* synthetic */ ay a(int i, long j) {
        return super.a(i, j);
    }
    ...
    public void a(final b bVar) {
        ...
        this.i.findViewById(R.id.action_mode_close_button).setOnClickListener(new OnClickListener(this) {
