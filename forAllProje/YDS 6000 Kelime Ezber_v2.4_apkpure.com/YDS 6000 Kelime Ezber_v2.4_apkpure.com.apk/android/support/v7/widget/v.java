...
class v extends s {
    ...
    void a(AttributeSet attributeSet, int i) {
        ...
        bl a = bl.a(this.a.getContext(), attributeSet, R.styleable.AppCompatSeekBar, i, 0);
        ...
        if (a.g(R.styleable.AppCompatSeekBar_tickMarkTintMode)) {
            this.d = aj.a(a.a(R.styleable.AppCompatSeekBar_tickMarkTintMode, -1), this.d);
            this.f = true;
        }
