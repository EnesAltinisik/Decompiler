...
class bf extends u implements OnClickListener {
    ...
    public bf(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, ConstantState> weakHashMap) {
    ...
    private Drawable a(String str) {
        ...
        try {
            ...
            b = android.support.v4.c.a.a(this.m, parseInt);
            a(str2, b);
            return b;
