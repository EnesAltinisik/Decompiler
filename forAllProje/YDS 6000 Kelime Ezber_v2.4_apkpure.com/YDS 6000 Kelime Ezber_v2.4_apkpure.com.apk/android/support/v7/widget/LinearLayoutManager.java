...
public class LinearLayoutManager extends h implements android.support.v7.widget.RecyclerView.s.b {
    private c a;
    private boolean b;
    private boolean c;
    private boolean d;
    ...
    private int i(t tVar) {
        ...
        return bc.a(tVar, awVar, a, b(z, true), this, this.e, this.k);
    }
    ...
    private int j(t tVar) {
        ...
        return bc.a(tVar, awVar, a, b(z, true), this, this.e);
    }
    ...
    private int k(t tVar) {
        ...
        return bc.b(tVar, awVar, a, b(z, true), this, this.e);
    }
    ...
    public View a(View view, int i, o oVar, t tVar) {
        ...
        h();
        View g = f == -1 ? g(oVar, tVar) : f(oVar, tVar);
        if (g == null) {
            return null;
        }
        h();
        a(f, (int) (0.33333334f * ((float) this.j.f())), false, tVar);
        this.a.g = Integer.MIN_VALUE;
        this.a.a = false;
    ...
    public void a(int i, android.support.v7.widget.RecyclerView.h.a aVar) {
        int i2;
        boolean z;
        if (this.n == null || !this.n.a()) {
            J();
    ...
    void a(t tVar, c cVar, android.support.v7.widget.RecyclerView.h.a aVar) {
        int i = cVar.d;
        if (i >= 0 && i < tVar.e()) {
            aVar.b(i, cVar.g);
        }
