...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        ah.a((View) this, VERSION.SDK_INT >= 21 ? new c(this) : new b(this));
    ...
    public void setTabContainer(bd bdVar) {
        if (this.g != null) {
            removeView(this.g);
        }
        this.g = bdVar;
        if (bdVar != null) {
            addView(bdVar);
            ViewGroup.LayoutParams layoutParams = bdVar.getLayoutParams();
            layoutParams.width = -1;
            layoutParams.height = -2;
            bdVar.setAllowCollapse(false);
        }
    }
