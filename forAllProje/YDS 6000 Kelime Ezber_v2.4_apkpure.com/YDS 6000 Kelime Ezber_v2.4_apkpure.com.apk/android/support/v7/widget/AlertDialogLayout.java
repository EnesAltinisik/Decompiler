...
public class AlertDialogLayout extends ap {
    ...
    private boolean c(int i, int i2) {
        ...
        if (view3 == null || i7 <= 0) {
            ...
            measuredHeight = ah.a(a, ah.k(view3));
            i5 = i8;
        }
        a = 0;
        ...
        setMeasuredDimension(ah.a(a + (getPaddingLeft() + getPaddingRight()), i, measuredHeight), ah.a(i5, i2, 0));
        if (mode2 != 1073741824) {
            d(childCount, i2);
        }
        return true;
