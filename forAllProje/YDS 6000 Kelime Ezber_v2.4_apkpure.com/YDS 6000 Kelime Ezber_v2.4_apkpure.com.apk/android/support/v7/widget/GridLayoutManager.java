...
public class GridLayoutManager extends LinearLayoutManager {
        ...
        while (i != i2) {
            ...
            if (d2 >= 0 && d2 < i3) {
                if (b(oVar, tVar, d2) != 0) {
                    view3 = view;
                    i5 = view2;
                } else if (((i) i5.getLayoutParams()).d()) {
                    if (view2 == null) {
                        view3 = view;
                    }
    ...
    public View a(View view, int i, o oVar, t tVar) {
        ...
        while (i8 != i5) {
            ...
            View view3;
            if (i9.isFocusable()) {
                bVar = (b) i9.getLayoutParams();
                int i10 = bVar.a;
                int i11 = bVar.a + bVar.b;
                if (i10 == i2 && i11 == i3) {
                    return i9;
                }
                Object obj2 = null;
                ...
                if (obj2 != null) {
                    i7 = bVar.a;
                    u = Math.min(i11, i3) - Math.max(i10, i2);
                    view3 = i9;
                } else {
                    u = i7;
                    i7 = i6;
    ...
    public void a(o oVar, t tVar, View view, android.support.v4.view.a.c cVar) {
        ...
        if (layoutParams instanceof b) {
            ...
            int a = a(oVar, tVar, bVar.f());
            if (this.i == 0) {
                int a2 = bVar.a();
                int b = bVar.b();
                boolean z = this.b > 1 && bVar.b() == this.b;
                cVar.c(n.a(a2, b, a, 1, z, false));
                return;
            }
            int a3 = bVar.a();
            int b2 = bVar.b();
            boolean z2 = this.b > 1 && bVar.b() == this.b;
            cVar.c(n.a(a, 1, a3, b2, z2, false));
            return;
        }
        super.a(view, cVar);
    }
