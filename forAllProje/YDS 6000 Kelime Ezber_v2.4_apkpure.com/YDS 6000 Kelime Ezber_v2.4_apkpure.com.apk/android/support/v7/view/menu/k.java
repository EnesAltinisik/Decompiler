...
@TargetApi(14)
public class k extends c<android.support.v4.e.a.b> implements MenuItem {
    private Method c;
    ...
    private class c extends d<OnActionExpandListener> implements q.e {
        final /* synthetic */ k a;
    ...
    k(Context context, android.support.v4.e.a.b bVar) {
        super(context, bVar);
    }
    ...
    public void a(boolean z) {
        try {
            if (this.c == null) {
                this.c = ((android.support.v4.e.a.b) this.b).getClass().getDeclaredMethod("setExclusiveCheckable", new Class[]{Boolean.TYPE});
            }
    ...
    public ActionProvider getActionProvider() {
        e a = ((android.support.v4.e.a.b) this.b).a();
    ...
    public MenuItem setAlphabeticShortcut(char c) {
        ((android.support.v4.e.a.b) this.b).setAlphabeticShortcut(c);
        return this;
    }
    ...
    public MenuItem setNumericShortcut(char c) {
        ((android.support.v4.e.a.b) this.b).setNumericShortcut(c);
        return this;
    }

    public MenuItem setOnActionExpandListener(OnActionExpandListener onActionExpandListener) {
        ((android.support.v4.e.a.b) this.b).a(onActionExpandListener != null ? new c(this, onActionExpandListener) : null);
        return this;
    }

    public MenuItem setOnMenuItemClickListener(OnMenuItemClickListener onMenuItemClickListener) {
        ((android.support.v4.e.a.b) this.b).setOnMenuItemClickListener(onMenuItemClickListener != null ? new d(this, onMenuItemClickListener) : null);
        return this;
    }

    public MenuItem setShortcut(char c, char c2) {
        ((android.support.v4.e.a.b) this.b).setShortcut(c, c2);
        return this;
    }
