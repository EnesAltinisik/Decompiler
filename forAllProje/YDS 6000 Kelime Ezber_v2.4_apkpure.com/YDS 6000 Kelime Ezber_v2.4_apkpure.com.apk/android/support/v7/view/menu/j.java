...
public final class j implements b {
    ...
    public boolean b() {
        if ((this.o != null && this.o.onMenuItemClick(this)) || this.a.a(this.a.p(), (MenuItem) this)) {
            return true;
        }
        if (this.n != null) {
            this.n.run();
    ...
    public boolean collapseActionView() {
        return (this.q & 8) == 0 ? false : this.r == null ? true : (this.t == null || this.t.b(this)) ? this.a.d(this) : false;
    }
    ...
    public boolean expandActionView() {
        return !n() ? false : (this.t == null || this.t.a(this)) ? this.a.c(this) : false;
    }
