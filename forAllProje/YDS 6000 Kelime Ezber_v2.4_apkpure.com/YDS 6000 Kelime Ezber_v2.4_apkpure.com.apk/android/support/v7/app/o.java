...
class o {
    ...
    private static final Map<String, Constructor<? extends View>> d = new android.support.v4.i.a();
    ...
    private void a(View view, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT < 15 || ah.H(view)) {
    ...
    public final View a(View view, String str, Context context, AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        switch (obj) {
            case null:
                view2 = new z(context2, attributeSet);
                break;
            case 1:
                view2 = new p(context2, attributeSet);
                break;
            case 2:
                view2 = new i(context2, attributeSet);
                break;
            case 3:
                view2 = new m(context2, attributeSet);
                break;
            case 4:
            ...
            case 7:
                ...
                break;
            case 8:
                view2 = new j(context2, attributeSet);
                break;
            case 9:
