...
class x {
    ...
    static x a(Context context) {
        if (a == null) {
            ...
            a = new x(applicationContext, (LocationManager) applicationContext.getSystemService("location"));
        }
        return a;
    }
    ...
    private Location b() {
        ...
        Location a = j.a(this.b, "android.permission.ACCESS_COARSE_LOCATION") == 0 ? a("network") : null;
        if (j.a(this.b, "android.permission.ACCESS_FINE_LOCATION") == 0) {
            location = a("gps");
        }
