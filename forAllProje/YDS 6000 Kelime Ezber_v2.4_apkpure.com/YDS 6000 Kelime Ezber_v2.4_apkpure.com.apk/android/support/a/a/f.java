...
public class f extends e {
    ...
    private static class d {
        ...
        public android.support.a.a.c.b[] getPathData() {
            return this.m;
        }
        ...
        public void setPathData(android.support.a.a.c.b[] bVarArr) {
    ...
    private static class b extends d {
        ...
        public void a(Resources resources, AttributeSet attributeSet, Theme theme, XmlPullParser xmlPullParser) {
            TypedArray a = e.a(resources, theme, attributeSet, a.c);
            a(a, xmlPullParser);
            a.recycle();
        }
    ...
    private static class c {
        ...
        public void a(Resources resources, AttributeSet attributeSet, Theme theme, XmlPullParser xmlPullParser) {
            TypedArray a = e.a(resources, theme, attributeSet, a.b);
            a(a, xmlPullParser);
            a.recycle();
        }
        ...
        private void a(c cVar, d dVar, Canvas canvas, int i, int i2, ColorFilter colorFilter) {
            ...
            if (f != 0.0f) {
                ...
                if (bVar.c != 0) {
                    ...
                    paint = this.n;
                    paint.setColor(f.a(bVar.c, bVar.f));
                ...
                if (bVar.a != 0) {
                    ...
                    paint.setColor(f.a(bVar.a, bVar.d));
                    paint.setColorFilter(colorFilter);
    ...
    public static f a(Resources resources, int i, Theme theme) {
        if (VERSION.SDK_INT >= 24) {
            f fVar = new f();
            fVar.b = android.support.v4.c.a.d.a(resources, i, theme);
            fVar.h = new g(fVar.b.getConstantState());
            return fVar;
        }
        try {
            int next;
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        ...
        f fVar = this.c;
        fVar.b = new e();
        TypedArray a = e.a(resources, theme, attributeSet, a.a);
        a(a, xmlPullParser);
        a.recycle();
