...
public class NavigationMenuItemView extends a implements a {
    ...
    private void d() {
        if (c()) {
            ...
            if (this.h != null) {
                ap.a aVar = (ap.a) this.h.getLayoutParams();
                aVar.width = -1;
        ...
        if (this.h != null) {
            aVar = (ap.a) this.h.getLayoutParams();
            aVar.width = -2;
            this.h.setLayoutParams(aVar);
        }
    }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            if (this.k) {
                ...
                drawable = android.support.v4.d.a.a.f(drawable).mutate();
                android.support.v4.d.a.a.a(drawable, this.j);
            }
            drawable.setBounds(0, 0, this.e, this.e);
        } else if (this.f) {
            if (this.l == null) {
                this.l = d.a(getResources(), R.drawable.navigation_empty_icon, getContext().getTheme());
                if (this.l != null) {
        ...
        x.a(this.g, drawable, null, null, null);
    }
