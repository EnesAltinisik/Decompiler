...
class m extends a {
    ...
    public m(Context context, Drawable drawable, float f, float f2, float f3) {
        super(drawable);
        this.l = android.support.v4.c.a.c(context, R.color.design_fab_shadow_start_color);
        this.m = android.support.v4.c.a.c(context, R.color.design_fab_shadow_mid_color);
        this.n = android.support.v4.c.a.c(context, R.color.design_fab_shadow_end_color);
        this.b = new Paint(5);
