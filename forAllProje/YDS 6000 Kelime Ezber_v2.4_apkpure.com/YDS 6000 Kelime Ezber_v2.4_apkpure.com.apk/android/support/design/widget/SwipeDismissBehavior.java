...
public class SwipeDismissBehavior<V extends View> extends android.support.design.widget.CoordinatorLayout.a<V> {
    ...
    private boolean i;
    private final android.support.v4.widget.ae.a j = new android.support.v4.widget.ae.a(this) {
        ...
        public void a(View view, int i, int i2, int i3, int i4) {
            ...
            if (((float) i) <= width) {
                ...
                ah.c(view, SwipeDismissBehavior.a(0.0f, 1.0f - SwipeDismissBehavior.b(width, width2, (float) i), 1.0f));
            }
        }
    ...
    private void a(ViewGroup viewGroup) {
        if (this.b == null) {
            this.b = this.i ? ae.a(viewGroup, this.h, this.j) : ae.a(viewGroup, this.j);
        }
    }
