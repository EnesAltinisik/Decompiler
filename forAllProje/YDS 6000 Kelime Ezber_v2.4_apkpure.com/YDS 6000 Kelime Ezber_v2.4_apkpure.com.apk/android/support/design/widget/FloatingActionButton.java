...
public class FloatingActionButton extends ab {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.a<FloatingActionButton> {
        ...
        private void a(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton) {
            ...
            if (rect != null && rect.centerX() > 0 && rect.centerY() > 0) {
                ...
                if (i != 0) {
                    ah.d((View) floatingActionButton, i);
                }
                if (i2 != 0) {
                    ah.e((View) floatingActionButton, i2);
                }
            }
        }
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.e = z.a(obtainStyledAttributes.getInt(R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
    ...
    private a a(final a aVar) {
        return aVar == null ? null : new a(this) {
    ...
    private h a() {
        ...
        return i >= 21 ? new i(this, new b(this), z.a) : i >= 14 ? new g(this, new b(this), z.a) : new f(this, new b(this), z.a);
    }
