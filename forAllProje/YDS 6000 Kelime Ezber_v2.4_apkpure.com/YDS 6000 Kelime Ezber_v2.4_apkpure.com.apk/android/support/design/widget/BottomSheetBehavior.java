...
public class BottomSheetBehavior<V extends View> extends android.support.design.widget.CoordinatorLayout.a<V> {
    ...
    private int u;
    private final android.support.v4.widget.ae.a v = new android.support.v4.widget.ae.a(this) {
        ...
        public int a(View view, int i, int i2) {
            return l.a(i, this.a.a, this.a.c ? this.a.f : this.a.b);
        }
        ...
        public void a(View view, float f, float f2) {
            ...
            if (this.a.e.a(view.getLeft(), i)) {
                this.a.b(2);
                ah.a(view, new c(this.a, view, i2));
                return;
            }
            this.a.b(i2);
        }
    ...
    public boolean a(CoordinatorLayout coordinatorLayout, V v, int i) {
        int max;
        if (ah.x(coordinatorLayout) && !ah.x(v)) {
            ah.a((View) v, true);
        }
        int top = v.getTop();
        ...
        if (this.d == 3) {
            ...
            ah.d((View) v, top - v.getTop());
        }
        if (this.e == null) {
            this.e = ae.a((ViewGroup) coordinatorLayout, this.v);
        }
    ...
    public boolean a(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        if (v.isShown()) {
            ...
            view = (View) this.h.get();
            if (a != 2 || view == null || this.p || this.d == 1 || coordinatorLayout.a(view, (int) motionEvent.getX(), (int) motionEvent.getY()) || Math.abs(((float) this.u) - motionEvent.getY()) <= ((float) this.e.d())) {
                z = false;
            }
            return z;
        }
    ...
    public boolean b(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        this.t.addMovement(motionEvent);
        if (a == 2 && !this.p && Math.abs(((float) this.u) - motionEvent.getY()) > ((float) this.e.d())) {
