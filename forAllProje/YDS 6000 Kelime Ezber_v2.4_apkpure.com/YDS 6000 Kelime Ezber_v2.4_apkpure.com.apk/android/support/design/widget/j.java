...
abstract class j<V extends View> extends x<V> {
    v a;
    private Runnable b;
    private boolean c;
    private int d = -1;
    ...
    private class a implements Runnable {
        ...
        a(j jVar, CoordinatorLayout coordinatorLayout, V v) {
            this.a = jVar;
    ...
    final boolean a(CoordinatorLayout coordinatorLayout, V v, int i, int i2, float f) {
        ...
        if (this.a == null) {
            this.a = v.a(v.getContext());
        }
        this.a.a(0, b(), 0, Math.round(f), 0, 0, i, i2);
        if (this.a.g()) {
        ...
        switch (t.a(motionEvent)) {
            ...
            case 1:
                if (this.g != null) {
                    ...
                    a(coordinatorLayout, (View) v, -a(v), 0, af.b(this.g, this.d));
                    break;
                }
                break;
            case 2:
