...
abstract class k extends x<View> {
    ...
    protected void b(CoordinatorLayout coordinatorLayout, View view, int i) {
        ...
        if (b != null) {
            ...
            if (!(lastWindowInsets == null || !ah.x(coordinatorLayout) || ah.x(view))) {
                rect.left += lastWindowInsets.a();
                rect.right -= lastWindowInsets.c();
            }
            Rect rect2 = this.b;
            f.a(c(dVar.c), view.getMeasuredWidth(), view.getMeasuredHeight(), rect, rect2, i);
            int c = c(b);
    ...
    final int c(View view) {
        return this.d == 0 ? 0 : l.a((int) (a(view) * ((float) this.d)), 0, this.d);
    }
